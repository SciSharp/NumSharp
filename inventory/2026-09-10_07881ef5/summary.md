...
Headline API availability: **87.3%** (489 of 560 default-scope APIs). Including partial mappings, **87.7%** are addressed.
...
| [`np.ldexp`](https://numpy.org/doc/stable/reference/generated/numpy.ldexp.html) | np | missing | Math |
