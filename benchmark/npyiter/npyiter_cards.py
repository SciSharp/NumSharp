...
# NpyIter benchmark (npyiter_results.tsv), for embedding in the README + the
...
from npyiter_sheet import (load_tsv, geomean, CATEGORIES, TIERS, TIER_LABEL,
...
def card_operations(SP):
    ...
    fig.text(0.035, 0.935, "NpyIter vs NumPy — operations", fontsize=10.5,
...
def card_dividends(SP):
    ...
    fig = plt.figure(figsize=(4, 3), dpi=100)
    fig.text(0.035, 0.935, "NpyIter — IL-generation dividends", fontsize=10.5,
             fontweight="bold", color=INK)
