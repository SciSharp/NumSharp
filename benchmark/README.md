...
cell, appends the subsystem sheets, mirrors the headline artifacts to this folder, and writes the
committable `history/<date>_<sha>/` snapshot (+ repoints `history/latest`).
