...
using NumSharp.Benchmark.Sandbox.Infrastructure;
using NumSharp.Benchmark.Sandbox.Isolated;
using NumSharp.Benchmark.Sandbox.Integration;

namespace NumSharp.Benchmark.Sandbox;
...
");
    ...
    private class Options
    {
        ...
        {
            "all" => Sandbox.Infrastructure.Dtypes.All,
            _ => Sandbox.Infrastructure.Dtypes.Common
        };
