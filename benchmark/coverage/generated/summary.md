...
Headline benchmark coverage: **96.6%** (455 covered of 471 benchmarkable APIs; 19 reviewed exclusions).
...
| Route | APIs | Meaning |
|---|---:|---|
| managed | 451 | NumSharp.Core managed code only. |
