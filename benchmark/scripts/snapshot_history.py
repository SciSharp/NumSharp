...
SUBSYSTEM_FILES = [
    ...
    BENCH / "openblas" / "openblas_results.md",
    BENCH / "openblas" / "openblas_results.tsv",
    BENCH / "openblas" / "openblas_results.managed.json",
    BENCH / "openblas" / "openblas_results.openblas.json",
]
...
def build_manifest(snap_name, run_ts, head, subject, dirty, dirty_files, env,
    ...
    L = [f"# Benchmark snapshot — {date} · {head}", "",
         "Official NumSharp-vs-NumPy comparison with Managed C# / OpenBLAS profiles and complementary subsystems, "
