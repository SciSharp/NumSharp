...
namespace NumSharp
{
    ...
    {
        private static unsafe NDArray retrieve_indices(NDArray src, NDArray[] indices, NDArray @out, bool extraDim)
        {
#if _REGEN
            #region Compute
		    switch (src.typecode)
		    {
			    ...
			    case NPTypeCode.#1: return retrieve_indices<#2>(src.MakeGeneric<#2>(), indices, @out, extraDim);
			    %
			    default:
		    ...
		    switch (src.typecode)
		    {
			    case NPTypeCode.Boolean: return retrieve_indices<bool>(src.MakeGeneric<bool>(), indices, @out, extraDim);
			    case NPTypeCode.Byte: return retrieve_indices<byte>(src.MakeGeneric<byte>(), indices, @out, extraDim);
			    case NPTypeCode.Int16: return retrieve_indices<short>(src.MakeGeneric<short>(), indices, @out, extraDim);
			    case NPTypeCode.UInt16: return retrieve_indices<ushort>(src.MakeGeneric<ushort>(), indices, @out, extraDim);
			    case NPTypeCode.Int32: return retrieve_indices<int>(src.MakeGeneric<int>(), indices, @out, extraDim);
			    case NPTypeCode.UInt32: return retrieve_indices<uint>(src.MakeGeneric<uint>(), indices, @out, extraDim);
			    case NPTypeCode.Int64: return retrieve_indices<long>(src.MakeGeneric<long>(), indices, @out, extraDim);
			    case NPTypeCode.UInt64: return retrieve_indices<ulong>(src.MakeGeneric<ulong>(), indices, @out, extraDim);
			    case NPTypeCode.Char: return retrieve_indices<char>(src.MakeGeneric<char>(), indices, @out, extraDim);
			    case NPTypeCode.Double: return retrieve_indices<double>(src.MakeGeneric<double>(), indices, @out, extraDim);
			    case NPTypeCode.Single: return retrieve_indices<float>(src.MakeGeneric<float>(), indices, @out, extraDim);
			    case NPTypeCode.Decimal: return retrieve_indices<decimal>(src.MakeGeneric<decimal>(), indices, @out, extraDim);
			    default:
				    throw new NotSupportedException();
		    }
            #endregion
        ...
        private static unsafe void set_indices(NDArray src, NDArray[] indices, NDArray values)
        {
#if _REGEN
            #region Compute
		    switch (src.typecode)
		    {
			    %foreach supported_dtypes,supported_dtypes_lowercase%
			    case NPTypeCode.#1: set_indices<#2>(src.MakeGeneric<#2>(), indices, values); break;
			    %
			    default:
				    throw new NotSupportedException();
		    }
		    ...
		    switch (src.typecode)
		    {
			    case NPTypeCode.Boolean: set_indices<bool>(src.MakeGeneric<bool>(), indices, values); break;
			    case NPTypeCode.Byte: set_indices<byte>(src.MakeGeneric<byte>(), indices, values); break;
			    case NPTypeCode.Int16: set_indices<short>(src.MakeGeneric<short>(), indices, values); break;
			    case NPTypeCode.UInt16: set_indices<ushort>(src.MakeGeneric<ushort>(), indices, values); break;
			    case NPTypeCode.Int32: set_indices<int>(src.MakeGeneric<int>(), indices, values); break;
			    case NPTypeCode.UInt32: set_indices<uint>(src.MakeGeneric<uint>(), indices, values); break;
			    case NPTypeCode.Int64: set_indices<long>(src.MakeGeneric<long>(), indices, values); break;
			    case NPTypeCode.UInt64: set_indices<ulong>(src.MakeGeneric<ulong>(), indices, values); break;
			    case NPTypeCode.Char: set_indices<char>(src.MakeGeneric<char>(), indices, values); break;
			    case NPTypeCode.Double: set_indices<double>(src.MakeGeneric<double>(), indices, values); break;
			    case NPTypeCode.Single: set_indices<float>(src.MakeGeneric<float>(), indices, values); break;
			    case NPTypeCode.Decimal: set_indices<decimal>(src.MakeGeneric<decimal>(), indices, values); break;
			    default:
				    throw new NotSupportedException();
		    }
            #endregion
        ...
        private static unsafe NDArray<T> retrieve_indices<T>(NDArray<T> source, NDArray[] indices, NDArray @out, bool extraDim) where T : unmanaged
        {
            if (source == null)
            ...
            {
                var ret = retriever_indices_nd_nonlinear(source, indices, ndsCount, retShape: retShape, subShape: subShape, @out);
                return ret;
            }
            ...
            else
            {
                ...
                var ret = retriever_indices_nd(source, computedOffsets, indices, ndsCount, retShape: retShape, subShape: subShape, @out);
        ...
        private static unsafe void set_indices<T>(NDArray<T> source, NDArray[] indices, NDArray values) where T : unmanaged
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            ...
            //TODO:     return set_indices_nd_nonlinear(source, indices, ndsCount, retShape: retShape, subShape: subShape, values.AsOrMakeGeneric<T>());
            ...
            {
                //non linear is handled before calculating computedOffsets
                set_indices_nd(source, computedOffsets, indices, ndsCount, retShape: retShape, subShape: subShape, values.AsOrMakeGeneric<T>());
            }
            //return default;
        }
        ...
        /// <returns></returns>
        private static unsafe void set_indices_nd<T>(NDArray<T> dst, NDArray<int> dstOffsets, NDArray[] dstIndices, int ndsCount, int[] retShape, int[] subShape, NDArray<T> values) where T : unmanaged
        {
        ...
        /// <returns></returns>
        [SuppressMessage("ReSharper", "SuggestVarOrType_Elsewhere")]
        private static unsafe void set_indices_nd_nonlinear<T>(NDArray<T> source, NDArray[] indices, int ndsCount, int[] retShape, int[] subShape, NDArray<T> values) where T : unmanaged
        {
            return;
//            //facts:
//            //indices are always offsetted to 
