        ...
        public unsafe NDArray<bool> EqualsInt16(in NDArray lhs, in NDArray rhs)
        {
            ...
            switch (rhs.GetTypeCode)
            {
                ...
                case NPTypeCode.#1:
                {
                    ...
                    do
                    {
                        *(ret_address + retShape.GetIndexInShape(current)) = (*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) #(op) (short) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                    } while (incr.Next() != null);
                ...
                case NPTypeCode.Byte:
                {
                    ...
                    do
                    {
                        *(ret_address + retShape.GetIndexInShape(current)) = (*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) == (short) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                    } while (incr.Next() != null);
