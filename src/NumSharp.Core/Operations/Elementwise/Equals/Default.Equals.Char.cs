        ...
        public unsafe NDArray<bool> EqualsChar(in NDArray lhs, in NDArray rhs)
        {
            ...
            switch (rhs.GetTypeCode)
            {
                ...
                case NPTypeCode.#1:
                {
                    ...
                    do
                    {
                        *(ret_address + retShape.GetOffset(current)) = (*(lhs_address + BroadcastedLeftShape.GetOffset(current)) #(op) (char) *(rhs_address + BroadcastedRightShape.GetOffset(current)));
                    } while (incr.Next() != null);
                ...
                case NPTypeCode.Byte:
                {
                    ...
                    do
                    {
                        *(ret_address + retShape.GetOffset(current)) = (*(lhs_address + BroadcastedLeftShape.GetOffset(current)) == (char) *(rhs_address + BroadcastedRightShape.GetOffset(current)));
                    } while (incr.Next() != null);
