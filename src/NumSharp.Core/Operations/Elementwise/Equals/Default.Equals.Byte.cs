        ...
        public unsafe NDArray<bool> EqualsByte(in NDArray lhs, in NDArray rhs)
        {
            ...
            switch (rhs.GetTypeCode)
            {
                ...
                case NPTypeCode.#1:
                {
                    ...
                    do
                    {
                        *(ret_address + retShape.GetOffset(current)) = (*(lhs_address + BroadcastedLeftShape.GetOffset(current)) #(op) (byte) *(rhs_address + BroadcastedRightShape.GetOffset(current)));
                    } while (incr.Next() != null);
                ...
                case NPTypeCode.Byte:
                {
                    ...
                    do
                    {
                        *(ret_address + retShape.GetOffset(current)) = (*(lhs_address + BroadcastedLeftShape.GetOffset(current)) == (byte) *(rhs_address + BroadcastedRightShape.GetOffset(current)));
                    } while (incr.Next() != null);
