...
namespace NumSharp
{
    public partial class np
    {
        ...
        public static NDArray floor_divide(in NDArray x1, in NDArray x2)
        ...
        /// <returns>y = floor(x1/x2). This is a scalar if both x1 and x2 are scalars.</returns>
        public static NDArray floor_divide(in NDArray x1, in NDArray x2, Type dtype)
        ...
        /// <returns>y = floor(x1/x2). This is a scalar if both x1 and x2 are scalars.</returns>
        public static NDArray floor_divide(in NDArray x1, in NDArray x2, NPTypeCode typeCode)
        ...
        public static NDArray floor_divide(in NDArray x1, in ValueType x2)
            => x1.TensorEngine.FloorDivide(x1, x2);
        ...
        /// <param name="dtype">The dtype of the returned NDArray.</param>
        /// <returns>y = floor(x1/x2).</returns>
        public static NDArray floor_divide(in NDArray x1, in ValueType x2, Type dtype)
            => x1.TensorEngine.FloorDivide(x1, x2, dtype);
        ...
        /// <param name="typeCode">The dtype of the returned NDArray.</param>
        /// <returns>y = floor(x1/x2).</returns>
        public static NDArray floor_divide(in NDArray x1, in ValueType x2, NPTypeCode typeCode)
            => x1.TensorEngine.FloorDivide(x1, x2, typeCode);
    }
}
