...
namespace NumSharp.Utilities.Maths
{
    ...
    internal class Operator
    {
        ...
        [MethodImpl(Inline)] public static bool Subtract(bool lhs, bool rhs) => ((lhs ? 1 : 0) - (rhs ? 1 : 0)) != 0;
        [MethodImpl(Inline)] public static bool Multiply(bool lhs, bool rhs) => lhs && rhs;
        [MethodImpl(Inline)] public static bool Mod(bool lhs, bool rhs) => ((lhs ? 1 : 0) % (rhs ? 1 : 0)) != 0;
        [MethodImpl(Inline)] public static bool Divide(bool lhs, bool rhs) => lhs && rhs;

        //boolean gen
        [MethodImpl(Inline)] public static int AddBoolean(bool lhs, bool rhs) => (lhs || rhs) ? 1 : 0;
        [MethodImpl(Inline)] public static int SubtractBoolean(bool lhs, bool rhs) => (((lhs ? 1 : 0) - (rhs ? 1 : 0)) != 0)  ? 1 : 0;
        [MethodImpl(Inline)] public static int MultiplyBoolean(bool lhs, bool rhs) => (lhs && rhs) ? 1 : 0;
        [MethodImpl(Inline)] public static int ModBoolean(bool lhs, bool rhs) => (((lhs ? 1 : 0) % (rhs ? 1 : 0)) != 0) ? 1 : 0;
        ...
        [MethodImpl(Inline)] public static short Add(bool lhs, short rhs) => (short) ((lhs ? 1 : 0) + rhs);
        [MethodImpl(Inline)] public static ushort Add(bool lhs, ushort rhs) => (ushort) ((lhs ? 1 : 0) + rhs);
        [MethodImpl(Inline)] public static int Add(bool lhs, int rhs) => (lhs ? 1 : 0) + rhs;
        [MethodImpl(Inline)] public static uint Add(bool lhs, uint rhs) => (lhs ? 1u : 0u) + rhs;
        [MethodImpl(Inline)] public static long Add(bool lhs, long rhs) => (lhs ? 1L : 0L) + rhs;
        [MethodImpl(Inline)] public static ulong Add(bool lhs, ulong rhs) => (lhs ? 1UL : 0UL) + rhs;
        [MethodImpl(Inline)] public static char Add(bool lhs, char rhs) => (char) ((lhs ? 1 : 0) + rhs);
        [MethodImpl(Inline)] public static double Add(bool lhs, double rhs) => (lhs ? 1d : 0d) + rhs;
        [MethodImpl(Inline)] public static float Add(bool lhs, float rhs) => (lhs ? 1f : 0f) + rhs;
        [MethodImpl(Inline)] public static decimal Add(bool lhs, decimal rhs) => (lhs ? 1m : 0m) + rhs;
        [MethodImpl(Inline)] public static byte Subtract(bool lhs, byte rhs) => (byte) ((lhs ? 1 : 0) - rhs);
        [MethodImpl(Inline)] public static short Subtract(bool lhs, short rhs) => (short) ((lhs ? 1 : 0) - rhs);
        [MethodImpl(Inline)] public static ushort Subtract(bool lhs, ushort rhs) => (ushort) ((lhs ? 1 : 0) - rhs);
        [MethodImpl(Inline)] public static int Subtract(bool lhs, int rhs) => (lhs ? 1 : 0) - rhs;
        [MethodImpl(Inline)] public static uint Subtract(bool lhs, uint rhs) => (lhs ? 1u : 0u) - rhs;
        [MethodImpl(Inline)] public static long Subtract(bool lhs, long rhs) => (lhs ? 1L : 0L) - rhs;
        [MethodImpl(Inline)] public static ulong Subtract(bool lhs, ulong rhs) => (lhs ? 1UL : 0UL) - rhs;
        [MethodImpl(Inline)] public static char Subtract(bool lhs, char rhs) => (char) ((lhs ? 1 : 0) - rhs);
        [MethodImpl(Inline)] public static double Subtract(bool lhs, double rhs) => (lhs ? 1d : 0d) - rhs;
        [MethodImpl(Inline)] public static float Subtract(bool lhs, float rhs) => (lhs ? 1f : 0f) - rhs;
        [MethodImpl(Inline)] public static decimal Subtract(bool lhs, decimal rhs) => (lhs ? 1m : 0m) - rhs;
        [MethodImpl(Inline)] public static byte Mod(bool lhs, byte rhs) => (byte) ((lhs ? 1 : 0) % rhs);
        [MethodImpl(Inline)] public static short Mod(bool lhs, short rhs) => (short) ((lhs ? 1 : 0) % rhs);
        [MethodImpl(Inline)] public static ushort Mod(bool lhs, ushort rhs) => (ushort) ((lhs ? 1 : 0) % rhs);
        [MethodImpl(Inline)] public static int Mod(bool lhs, int rhs) => (lhs ? 1 : 0) % rhs;
        [MethodImpl(Inline)] public static uint Mod(bool lhs, uint rhs) => (lhs ? 1u : 0u) % rhs;
        [MethodImpl(Inline)] public static long Mod(bool lhs, long rhs) => (lhs ? 1L : 0L) % rhs;
        [MethodImpl(Inline)] public static ulong Mod(bool lhs, ulong rhs) => (lhs ? 1UL : 0UL) % rhs;
        [MethodImpl(Inline)] public static char Mod(bool lhs, char rhs) => (char) ((lhs ? 1 : 0) % rhs);
        [MethodImpl(Inline)] public static double Mod(bool lhs, double rhs) => (lhs ? 1d : 0d) % rhs;
        [MethodImpl(Inline)] public static float Mod(bool lhs, float rhs) => (lhs ? 1f : 0f) % rhs;
        [MethodImpl(Inline)] public static decimal Mod(bool lhs, decimal rhs) => (lhs ? 1m : 0m) % rhs;
        [MethodImpl(Inline)] public static byte Multiply(bool lhs, byte rhs) => (byte) ((lhs ? 1 : 0) * rhs);
        [MethodImpl(Inline)] public static short Multiply(bool lhs, short rhs) => (short) ((lhs ? 1 : 0) * rhs);
        [MethodImpl(Inline)] public static ushort Multiply(bool lhs, ushort rhs) => (ushort) ((lhs ? 1 : 0) * rhs);
        [MethodImpl(Inline)] public static int Multiply(bool lhs, int rhs) => (lhs ? 1 : 0) * rhs;
        [MethodImpl(Inline)] public static uint Multiply(bool lhs, uint rhs) => (lhs ? 1u : 0u) * rhs;
        [MethodImpl(Inline)] public static long Multiply(bool lhs, long rhs) => (lhs ? 1L : 0L) * rhs;
        [MethodImpl(Inline)] public static ulong Multiply(bool lhs, ulong rhs) => (lhs ? 1UL : 0UL) * rhs;
        [MethodImpl(Inline)] public static char Multiply(bool lhs, char rhs) => (char) ((lhs ? 1 : 0) * rhs);
        [MethodImpl(Inline)] public static double Multiply(bool lhs, double rhs) => (lhs ? 1d : 0d) * rhs;
        [MethodImpl(Inline)] public static float Multiply(bool lhs, float rhs) => (lhs ? 1f : 0f) * rhs;
        [MethodImpl(Inline)] public static decimal Multiply(bool lhs, decimal rhs) => (lhs ? 1m : 0m) * rhs;
        [MethodImpl(Inline)] public static byte Divide(bool lhs, byte rhs) => (byte) ((lhs ? 1 : 0) / rhs);
        [MethodImpl(Inline)] public static short Divide(bool lhs, short rhs) => (short) ((lhs ? 1 : 0) / rhs);
        [MethodImpl(Inline)] public static ushort Divide(bool lhs, ushort rhs) => (ushort) ((lhs ? 1 : 0) / rhs);
        [MethodImpl(Inline)] public static int Divide(bool lhs, int rhs) => (lhs ? 1 : 0) / rhs;
        [MethodImpl(Inline)] public static uint Divide(bool lhs, uint rhs) => (lhs ? 1u : 0u) / rhs;
        [MethodImpl(Inline)] public static long Divide(bool lhs, long rhs) => (lhs ? 1L : 0L) / rhs;
        [MethodImpl(Inline)] public static ulong Divide(bool lhs, ulong rhs) => (lhs ? 1UL : 0UL) / rhs;
        [MethodImpl(Inline)] public static char Divide(bool lhs, char rhs) => (char) ((lhs ? 1 : 0) / rhs);
        [MethodImpl(Inline)] public static double Divide(bool lhs, double rhs) => (lhs ? 1d : 0d) / rhs;
        [MethodImpl(Inline)] public static float Divide(bool lhs, float rhs) => (lhs ? 1f : 0f) / rhs;
        [MethodImpl(Inline)] public static decimal Divide(bool lhs, decimal rhs) => (lhs ? 1m : 0m) / rhs;

        //bool is rhs
        [MethodImpl(Inline)] public static byte Add(byte lhs, bool rhs) => (byte) (lhs + (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static short Add(short lhs, bool rhs) => (short) (lhs + (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static ushort Add(ushort lhs, bool rhs) => (ushort) (lhs + (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static int Add(int lhs, bool rhs) => lhs + (rhs ? 1 : 0);
        [MethodImpl(Inline)] public static uint Add(uint lhs, bool rhs) => lhs + (rhs ? 1u : 0u);
        [MethodImpl(Inline)] public static long Add(long lhs, bool rhs) => lhs + (rhs ? 1L : 0L);
        [MethodImpl(Inline)] public static ulong Add(ulong lhs, bool rhs) => lhs + (rhs ? 1UL : 0UL);
        [MethodImpl(Inline)] public static char Add(char lhs, bool rhs) => (char) (lhs + (rhs ? 1 : '\0'));
        [MethodImpl(Inline)] public static double Add(double lhs, bool rhs) => lhs + (rhs ? 1d : 0d);
        [MethodImpl(Inline)] public static float Add(float lhs, bool rhs) => lhs + (rhs ? 1f : 0f);
        [MethodImpl(Inline)] public static decimal Add(decimal lhs, bool rhs) => lhs + (rhs ? 1m : 0m);
        [MethodImpl(Inline)] public static byte Subtract(byte lhs, bool rhs) => (byte) (lhs - (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static short Subtract(short lhs, bool rhs) => (short) (lhs - (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static ushort Subtract(ushort lhs, bool rhs) => (ushort) (lhs - (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static int Subtract(int lhs, bool rhs) => lhs - (rhs ? 1 : 0);
        [MethodImpl(Inline)] public static uint Subtract(uint lhs, bool rhs) => lhs - (rhs ? 1u : 0u);
        [MethodImpl(Inline)] public static long Subtract(long lhs, bool rhs) => lhs - (rhs ? 1L : 0L);
        [MethodImpl(Inline)] public static ulong Subtract(ulong lhs, bool rhs) => lhs - (rhs ? 1UL : 0UL);
        [MethodImpl(Inline)] public static char Subtract(char lhs, bool rhs) => (char) (lhs - (rhs ? 1 : '\0'));
        [MethodImpl(Inline)] public static double Subtract(double lhs, bool rhs) => lhs - (rhs ? 1d : 0d);
        [MethodImpl(Inline)] public static float Subtract(float lhs, bool rhs) => lhs - (rhs ? 1f : 0f);
        [MethodImpl(Inline)] public static decimal Subtract(decimal lhs, bool rhs) => lhs - (rhs ? 1m : 0m);
        [MethodImpl(Inline)] public static byte Mod(byte lhs, bool rhs) => (byte) (lhs % (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static short Mod(short lhs, bool rhs) => (short) (lhs % (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static ushort Mod(ushort lhs, bool rhs) => (ushort) (lhs % (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static int Mod(int lhs, bool rhs) => lhs % (rhs ? 1 : 0);
        [MethodImpl(Inline)] public static uint Mod(uint lhs, bool rhs) => lhs % (rhs ? 1u : 0u);
        [MethodImpl(Inline)] public static long Mod(long lhs, bool rhs) => lhs % (rhs ? 1L : 0L);
        [MethodImpl(Inline)] public static ulong Mod(ulong lhs, bool rhs) => lhs % (rhs ? 1UL : 0UL);
        [MethodImpl(Inline)] public static char Mod(char lhs, bool rhs) => (char) (lhs % (rhs ? 1 : '\0'));
        [MethodImpl(Inline)] public static double Mod(double lhs, bool rhs) => lhs % (rhs ? 1d : 0d);
        [MethodImpl(Inline)] public static float Mod(float lhs, bool rhs) => lhs % (rhs ? 1f : 0f);
        [MethodImpl(Inline)] public static decimal Mod(decimal lhs, bool rhs) => lhs % (rhs ? 1m : 0m);
        [MethodImpl(Inline)] public static byte Multiply(byte lhs, bool rhs) => (byte) (lhs * (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static short Multiply(short lhs, bool rhs) => (short) (lhs * (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static ushort Multiply(ushort lhs, bool rhs) => (ushort) (lhs * (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static int Multiply(int lhs, bool rhs) => lhs * (rhs ? 1 : 0);
        [MethodImpl(Inline)] public static uint Multiply(uint lhs, bool rhs) => lhs * (rhs ? 1u : 0u);
        [MethodImpl(Inline)] public static long Multiply(long lhs, bool rhs) => lhs * (rhs ? 1L : 0L);
        [MethodImpl(Inline)] public static ulong Multiply(ulong lhs, bool rhs) => lhs * (rhs ? 1UL : 0UL);
        [MethodImpl(Inline)] public static char Multiply(char lhs, bool rhs) => (char) (lhs * (rhs ? 1 : '\0'));
        [MethodImpl(Inline)] public static double Multiply(double lhs, bool rhs) => lhs * (rhs ? 1d : 0d);
        [MethodImpl(Inline)] public static float Multiply(float lhs, bool rhs) => lhs * (rhs ? 1f : 0f);
        [MethodImpl(Inline)] public static decimal Multiply(decimal lhs, bool rhs) => lhs * (rhs ? 1m : 0m);
        [MethodImpl(Inline)] public static byte Divide(byte lhs, bool rhs) => (byte) (lhs / (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static short Divide(short lhs, bool rhs) => (short) (lhs / (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static ushort Divide(ushort lhs, bool rhs) => (ushort) (lhs / (rhs ? 1 : 0));
        [MethodImpl(Inline)] public static int Divide(int lhs, bool rhs) => lhs / (rhs ? 1 : 0);
        [MethodImpl(Inline)] public static uint Divide(uint lhs, bool rhs) => lhs / (rhs ? 1u : 0u);
        [MethodImpl(Inline)] public static long Divide(long lhs, bool rhs) => lhs / (rhs ? 1L : 0L);
        [MethodImpl(Inline)] public static ulong Divide(ulong lhs, bool rhs) => lhs / (rhs ? 1UL : 0UL);
        [MethodImpl(Inline)] public static char Divide(char lhs, bool rhs) => (char) (lhs / (rhs ? 1 : '\0'));
