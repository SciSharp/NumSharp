...
namespace System
{
    // This is a separate class instead of 'partial UnmanagedSpanHelpers' to hide the private helpers
    // included in this file which are specific to the packed implementation.
    internal static partial class PackedUnmanagedSpanHelpers
    {
        ...
        public static int IndexOfAnyIgnoreCase(ref char searchSpace, char value, int length)
        {
            ...
            return IndexOf<UnmanagedSpanHelpers.DontNegate<short>, Or20Transform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value, length);
        }
        ...
        public static int IndexOfAnyExceptIgnoreCase(ref char searchSpace, char value, int length)
        {
            ...
            return IndexOf<UnmanagedSpanHelpers.Negate<short>, Or20Transform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value, length);
        }
        ...
        public static int IndexOfAnyIgnoreCase(ref char searchSpace, char value0, char value1, int length)
        {
            ...
            return IndexOfAny<UnmanagedSpanHelpers.DontNegate<short>, Or20Transform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value0, (short)value1, length);
        }
        ...
        public static int IndexOfAnyExceptIgnoreCase(ref char searchSpace, char value0, char value1, int length)
        {
            ...
            return IndexOfAny<UnmanagedSpanHelpers.Negate<short>, Or20Transform>(ref Unsafe.As<char, short>(ref searchSpace), (short)value0, (short)value1, length);
        }
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibConditionParsing
        ...
        private static bool NegateIfNeeded<TNegator>(bool result)
            where TNegator : struct, UnmanagedSpanHelpers.INegator<short> =>
            typeof(TNegator) == typeof(UnmanagedSpanHelpers.DontNegate<short>) ? result : !result;
        ...
        private static bool HasMatch<TNegator>(Vector512<byte> left, Vector512<byte> right)
            where TNegator : struct, UnmanagedSpanHelpers.INegator<short>
        {
            return (typeof(TNegator) == typeof(UnmanagedSpanHelpers.DontNegate<short>))
