...
namespace System.Runtime.InteropServices
{
    public static unsafe partial class NativeMemory
    {
        ...
        {
            UnmanagedSpanHelpers.ClearWithoutReferences(ref *(byte*)ptr, byteCount);
        }
        ...
        {
            UnmanagedSpanHelpers.Memmove(ref *(byte*)destination, ref *(byte*)source, byteCount);
        }
        ...
        {
            UnmanagedSpanHelpers.Fill(ref *(byte*)ptr, byteCount, value);
        }
