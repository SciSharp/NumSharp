...
namespace System
{
    public static partial class MemoryExtensions
    {
        ...
        /// <param name="span">The source span from which the element is removed.</param>
        /// <param name="trimElement">The specified element to look for and remove.</param>
        public static UnmanagedSpan<T> TrimStart<T>(this UnmanagedSpan<T> span, T trimElement) where T : IEquatable<T>?
        ...
        /// <param name="span">The source span from which the element is removed.</param>
        /// <param name="trimElement">The specified element to look for and remove.</param>
        public static UnmanagedSpan<T> TrimEnd<T>(this UnmanagedSpan<T> span, T trimElement) where T : IEquatable<T>?
        ...
        /// <param name="span">The source span from which the element is removed.</param>
        /// <param name="trimElement">The specified element to look for and remove.</param>
        public static ReadOnlyUnmanagedSpan<T> TrimStart<T>(this ReadOnlyUnmanagedSpan<T> span, T trimElement) where T : IEquatable<T>?
            => span.Slice(ClampStart(span, trimElement));
        ...
        /// <param name="span">The source span from which the element is removed.</param>
        /// <param name="trimElement">The specified element to look for and remove.</param>
        public static ReadOnlyUnmanagedSpan<T> TrimEnd<T>(this ReadOnlyUnmanagedSpan<T> span, T trimElement) where T : IEquatable<T>?
            => span.Slice(0, ClampEnd(span, 0, trimElement));
        ...
        public static Memory<T> Trim<T>(this Memory<T> memory, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the memory is returned unaltered.</remarks>
        public static Memory<T> TrimStart<T>(this Memory<T> memory, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the memory is returned unaltered.</remarks>
        public static Memory<T> TrimEnd<T>(this Memory<T> memory, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the memory is returned unaltered.</remarks>
        public static ReadOnlyMemory<T> Trim<T>(this ReadOnlyMemory<T> memory, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
                ReadOnlyUnmanagedSpan<T> span = memory.Span;
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the memory is returned unaltered.</remarks>
        public static ReadOnlyMemory<T> TrimStart<T>(this ReadOnlyMemory<T> memory, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
                return memory.Slice(ClampStart(memory.Span, trimElements));
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the memory is returned unaltered.</remarks>
        public static ReadOnlyMemory<T> TrimEnd<T>(this ReadOnlyMemory<T> memory, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
                return memory.Slice(0, ClampEnd(memory.Span, 0, trimElements));
        ...
        public static UnmanagedSpan<T> Trim<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
                int start = ClampStart(span, trimElements);
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the span is returned unaltered.</remarks>
        public static UnmanagedSpan<T> TrimStart<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the span is returned unaltered.</remarks>
        public static UnmanagedSpan<T> TrimEnd<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the span is returned unaltered.</remarks>
        public static ReadOnlyUnmanagedSpan<T> Trim<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
                int start = ClampStart(span, trimElements);
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the span is returned unaltered.</remarks>
        public static ReadOnlyUnmanagedSpan<T> TrimStart<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
                return span.Slice(ClampStart(span, trimElements));
        ...
        /// <param name="trimElements">The span which contains the set of elements to remove.</param>
        /// <remarks>If <paramref name="trimElements"/> is empty, the span is returned unaltered.</remarks>
        public static ReadOnlyUnmanagedSpan<T> TrimEnd<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> trimElements) where T : IEquatable<T>?
        {
            if (trimElements.Length > 1)
            {
                return span.Slice(0, ClampEnd(span, 0, trimElements));
        ...
        public static ReadOnlyUnmanagedSpan<char> Trim(this ReadOnlyUnmanagedSpan<char> span)
        {
        ...
        /// </summary>
        /// <param name="span">The source span from which the characters are removed.</param>
        public static ReadOnlyUnmanagedSpan<char> TrimEnd(this ReadOnlyUnmanagedSpan<char> span)
        {
            int end = span.Length - 1;
            for (; end >= 0; end--)
            {
        ...
        /// <param name="span">The source span from which the character is removed.</param>
        /// <param name="trimChar">The specified character to look for and remove.</param>
        public static ReadOnlyUnmanagedSpan<char> TrimEnd(this ReadOnlyUnmanagedSpan<char> span, char trimChar)
        {
            int end = span.Length - 1;
            for (; end >= 0; end--)
            {
        ...
        public static ReadOnlyUnmanagedSpan<char> Trim(this ReadOnlyUnmanagedSpan<char> span, ReadOnlyUnmanagedSpan<char> trimChars)
        ...
        /// <param name="trimChars">The span which contains the set of characters to remove.</param>
        /// <remarks>If <paramref name="trimChars"/> is empty, white-space characters are removed instead.</remarks>
        public static ReadOnlyUnmanagedSpan<char> TrimStart(this ReadOnlyUnmanagedSpan<char> span, ReadOnlyUnmanagedSpan<char> trimChars)
        {
        ...
        /// <param name="trimChars">The span which contains the set of characters to remove.</param>
        /// <remarks>If <paramref name="trimChars"/> is empty, white-space characters are removed instead.</remarks>
        public static ReadOnlyUnmanagedSpan<char> TrimEnd(this ReadOnlyUnmanagedSpan<char> span, ReadOnlyUnmanagedSpan<char> trimChars)
        {
            if (trimChars.IsEmpty)
            {
                return span.TrimEnd();
        ...
        /// <param name="span">The source span from which the characters are removed.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnmanagedSpan<char> Trim(this UnmanagedSpan<char> span)
        {
            // Assume that in most cases input doesn't need trimming
            if (span.Length == 0 ||
                (!char.IsWhiteSpace(span[0]) && !char.IsWhiteSpace(span[^1])))
        ...
        /// </summary>
        /// <param name="span">The source span from which the characters are removed.</param>
        public static UnmanagedSpan<char> TrimStart(this UnmanagedSpan<char> span)
        ...
        /// </summary>
        /// <param name="span">The source span from which the characters are removed.</param>
        public static UnmanagedSpan<char> TrimEnd(this UnmanagedSpan<char> span)
