...
namespace System.Buffers
{
    public ref partial struct SequenceReader<T> where T : unmanaged, IEquatable<T>
    {
        ...
        public SequenceReader(ReadOnlySequence<T> sequence)
        {
            ...
            sequence.GetFirstSpan(out ReadOnlyUnmanagedSpan<T> first, out _nextPosition);
            CurrentSpan = first;
        ...
        /// </summary>
        public ReadOnlyUnmanagedSpan<T> CurrentSpan { get; private set; }
        ...
        /// </summary>
        public readonly ReadOnlyUnmanagedSpan<T> UnreadSpan
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// the reader. To look ahead for a specific stream of data <see cref="IsNext(ReadOnlyUnmanagedSpan{T}, bool)"/> can be used.
        /// </remarks>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool TryCopyTo(UnmanagedSpan<T> destination)
        {
            ...
            ReadOnlyUnmanagedSpan<T> firstSpan = UnreadSpan;
        ...
        internal readonly bool TryCopyMultisegment(UnmanagedSpan<T> destination)
        {
            ...
            while (Sequence.TryGet(ref next, out ReadOnlyMemory<T> nextSegment, true))
            {
                ...
                {
                    ReadOnlyUnmanagedSpan<T> nextSpan = nextSegment.Span;
