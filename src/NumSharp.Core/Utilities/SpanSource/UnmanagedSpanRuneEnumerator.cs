...
namespace System.Text
{
    ...
    public ref struct UnmanagedSpanRuneEnumerator : IEnumerator<Rune>
    {
        private ReadOnlyUnmanagedSpan<char> _remaining;
        private Rune _current;

        internal UnmanagedSpanRuneEnumerator(ReadOnlyUnmanagedSpan<char> buffer)
        {
            _remaining = buffer;
            _current = default;
        }
        ...
        public UnmanagedSpanRuneEnumerator GetEnumerator() => this;
