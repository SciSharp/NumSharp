...
namespace System
{
    public static partial class UnmanagedSpanExtensions
    {
        ...
        internal static bool StartsWithUtf8(this ReadOnlyUnmanagedSpan<byte> span, ReadOnlyUnmanagedSpan<byte> value, StringComparison comparisonType)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool StartsWithOrdinalIgnoreCaseUtf8(this ReadOnlyUnmanagedSpan<byte> span, ReadOnlyUnmanagedSpan<byte> value)
        {
            // For UTF-8 ist is possible for two spans of different byte length
            // to compare as equal under an OrdinalIgnoreCase comparison.
