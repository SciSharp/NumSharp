...
namespace System.Runtime.InteropServices
{
    ...
    /// <see cref="Span{T}"/>, and <see cref="ReadOnlyUnmanagedSpan{T}"/>.
    /// </summary>
    public static partial class MemoryMarshal
    {
        ...
        public static unsafe UnmanagedSpan<byte> AsBytes<T>(UnmanagedSpan<T> span)
            where T : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
                ThrowHelper.ThrowArgument_TypeContainsReferences(typeof(T));

            return new UnmanagedSpan<byte>(
                ref Unsafe.As<T, byte>(ref GetReference(span)),
                checked(span.Length * sizeof(T)));
        }

        /// <summary>
        /// Casts a ReadOnlyUnmanagedSpan of one primitive type <typeparamref name="T"/> to ReadOnlyUnmanagedSpan of bytes.
        /// That type may not contain pointers or references. This is checked at runtime in order to preserve type safety.
        /// </summary>
        /// <param name="span">The source slice, of type <typeparamref name="T"/>.</param>
        /// <exception cref="ArgumentException">
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe ReadOnlyUnmanagedSpan<byte> AsBytes<T>(ReadOnlyUnmanagedSpan<T> span)
            where T : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
                ThrowHelper.ThrowArgument_TypeContainsReferences(typeof(T));

            return new ReadOnlyUnmanagedSpan<byte>(
                ref Unsafe.As<T, byte>(ref GetReference(span)),
                checked(span.Length * sizeof(T)));
        }
        ...
        /// </summary>
        public static ref T GetReference<T>(UnmanagedSpan<T> span) => ref span._reference;

        /// <summary>
        /// Returns a reference to the 0th element of the ReadOnlyUnmanagedSpan. If the ReadOnlyUnmanagedSpan is empty, returns a reference to the location where the 0th element
        /// would have been stored. Such a reference may or may not be null. It can be used for pinning but must never be dereferenced.
        /// </summary>
        public static ref T GetReference<T>(ReadOnlyUnmanagedSpan<T> span) => ref span._reference;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe ref T GetNonNullPinnableReference<T>(UnmanagedSpan<T> span) => ref (span.Length != 0) ? ref Unsafe.AsRef(in span._reference) : ref Unsafe.AsRef<T>((void*)1);

        /// <summary>
        /// Returns a reference to the 0th element of the ReadOnlyUnmanagedSpan. If the ReadOnlyUnmanagedSpan is empty, returns a reference to fake non-null pointer. Such a reference
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe ref T GetNonNullPinnableReference<T>(ReadOnlyUnmanagedSpan<T> span) => ref (span.Length != 0) ? ref Unsafe.AsRef(in span._reference) : ref Unsafe.AsRef<T>((void*)1);
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe UnmanagedSpan<TTo> Cast<TFrom, TTo>(UnmanagedSpan<TFrom> span)
            where TFrom : struct
            where TTo : struct
        {
            ...
            return new UnmanagedSpan<TTo>(
                ref Unsafe.As<TFrom, TTo>(ref span._reference),
                toLength);
        }

        /// <summary>
        /// Casts a ReadOnlyUnmanagedSpan of one primitive type <typeparamref name="TFrom"/> to another primitive type <typeparamref name="TTo"/>.
        /// These types may not contain pointers or references. This is checked at runtime in order to preserve type safety.
        /// </summary>
        /// <remarks>
        /// Supported only for platforms that support misaligned memory access or when the memory block is aligned by other means.
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe ReadOnlyUnmanagedSpan<TTo> Cast<TFrom, TTo>(ReadOnlyUnmanagedSpan<TFrom> span)
            where TFrom : struct
            where TTo : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<TFrom>())
            ...
            return new ReadOnlyUnmanagedSpan<TTo>(
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnmanagedSpan<T> CreateUnmanagedSpan<T>(scoped ref T reference, int length) =>
            new UnmanagedSpan<T>(ref Unsafe.AsRef(in reference), length);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReadOnlyUnmanagedSpan<T> CreateReadOnlyUnmanagedSpan<T>(scoped ref readonly T reference, int length) =>
            new ReadOnlyUnmanagedSpan<T>(ref Unsafe.AsRef(in reference), length);
        ...
        [CLSCompliant(false)]
        [RequiresUnsafe]
        public static unsafe ReadOnlyUnmanagedSpan<char> CreateReadOnlySpanFromNullTerminated(char* value) =>
            value != null ? new ReadOnlyUnmanagedSpan<char>(value, string.wcslen(value)) :
            default;
        ...
        [CLSCompliant(false)]
        [RequiresUnsafe]
        public static unsafe ReadOnlyUnmanagedSpan<byte> CreateReadOnlySpanFromNullTerminated(byte* value) =>
            value != null ? new ReadOnlyUnmanagedSpan<byte>(value, string.strlen(value)) :
            default;
...
#pragma warning restore 8762
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe T Read<T>(ReadOnlyUnmanagedSpan<byte> source)
            where T : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool TryRead<T>(ReadOnlyUnmanagedSpan<byte> source, out T value)
            where T : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
            {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void Write<T>(UnmanagedSpan<byte> destination, in T value)
            where T : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
            {
        ...
        /// <returns>If the span is too small to contain the type T, return false.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool TryWrite<T>(UnmanagedSpan<byte> destination, in T value)
            where T : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
            {
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(1)] // Prioritize this overload over the ReadOnlyUnmanagedSpan overload so types convertible to both resolve to this mutable version.
        public static unsafe ref T AsRef<T>(UnmanagedSpan<byte> span)
            where T : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
            {
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe ref readonly T AsRef<T>(ReadOnlyUnmanagedSpan<byte> span)
            where T : struct
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
            {
