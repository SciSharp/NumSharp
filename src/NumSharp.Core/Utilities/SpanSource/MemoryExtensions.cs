...
namespace System
{
    ...
    public static partial class MemoryExtensions
    {
        ...
        public static UnmanagedSpan<T> AsUnmanagedSpan<T>(this T[]? array, int start)
        {
            ...
            return new UnmanagedSpan<T>(ref Unsafe.Add(ref MemoryMarshal.GetArrayDataReference(array), (nint)(uint)start /* force zero-extension */), array.Length - start);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnmanagedSpan<T> AsUnmanagedSpan<T>(this T[]? array, Index startIndex)
        {
            if (array == null)
            {
            ...
            return new UnmanagedSpan<T>(ref Unsafe.Add(ref MemoryMarshal.GetArrayDataReference(array), (nint)(uint)actualIndex /* force zero-extension */), array.Length - actualIndex);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnmanagedSpan<T> AsUnmanagedSpan<T>(this T[]? array, Range range)
        {
            if (array == null)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReadOnlyUnmanagedSpan<char> AsUnmanagedSpan(this string? text)
        {
            if (text == null)
                return default;

            return new ReadOnlyUnmanagedSpan<char>(ref text.GetRawStringData(), text.Length);
        }
        ...
        public static ReadOnlyUnmanagedSpan<char> AsUnmanagedSpan(this string? text, int start)
        {
            ...
            return new ReadOnlyUnmanagedSpan<char>(ref Unsafe.Add(ref text.GetRawStringData(), (nint)(uint)start /* force zero-extension */), text.Length - start);
        }

        /// <summary>Creates a new <see cref="ReadOnlyUnmanagedSpan{Char}"/> over a portion of the target string from a specified position to the end of the string.</summary>
        /// <param name="text">The target string.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReadOnlyUnmanagedSpan<char> AsUnmanagedSpan(this string? text, Index startIndex)
        {
            if (text is null)
            {
                if (!startIndex.Equals(Index.Start))
            ...
            return new ReadOnlyUnmanagedSpan<char>(ref Unsafe.Add(ref text.GetRawStringData(), (nint)(uint)actualIndex /* force zero-extension */), text.Length - actualIndex);
        }

        /// <summary>Creates a new <see cref="ReadOnlyUnmanagedSpan{Char}"/> over a portion of a target string using the range start and end indexes.</summary>
        /// <param name="text">The target string.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReadOnlyUnmanagedSpan<char> AsUnmanagedSpan(this string? text, Range range)
        {
            if (text is null)
            {
                Index startIndex = range.Start;
        ...
        /// <inheritdoc cref="Contains{T}(ReadOnlyUnmanagedSpan{T}, T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool Contains<T>(this UnmanagedSpan<T> span, T value) where T : IEquatable<T>? =>
            Contains((ReadOnlyUnmanagedSpan<T>)span, value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool Contains<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    return UnmanagedSpanHelpers.ContainsValueType(
            ...
            return UnmanagedSpanHelpers.Contains(ref MemoryMarshal.GetReference(span), value, span.Length);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Contains<T>(this ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer = null) =>
            IndexOf(span, value, comparer) >= 0;

        /// <inheritdoc cref="ContainsAny{T}(ReadOnlyUnmanagedSpan{T}, T, T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAny<T>(this UnmanagedSpan<T> span, T value0, T value1) where T : IEquatable<T>? =>
            ContainsAny((ReadOnlyUnmanagedSpan<T>)span, value0, value1);

        /// <inheritdoc cref="ContainsAny{T}(ReadOnlyUnmanagedSpan{T}, T, T, T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAny<T>(this UnmanagedSpan<T> span, T value0, T value1, T value2) where T : IEquatable<T>? =>
            ContainsAny((ReadOnlyUnmanagedSpan<T>)span, value0, value1, value2);

        /// <inheritdoc cref="ContainsAny{T}(ReadOnlyUnmanagedSpan{T}, ReadOnlyUnmanagedSpan{T})"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAny<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> values) where T : IEquatable<T>? =>
            ContainsAny((ReadOnlyUnmanagedSpan<T>)span, values);

        /// <inheritdoc cref="ContainsAny{T}(ReadOnlyUnmanagedSpan{T}, SearchValues{T})"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAny<T>(this UnmanagedSpan<T> span, SearchValues<T> values) where T : IEquatable<T>? =>
            ContainsAny((ReadOnlyUnmanagedSpan<T>)span, values);

        /// <inheritdoc cref="ContainsAny(ReadOnlyUnmanagedSpan{char}, SearchValues{string})"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAny(this UnmanagedSpan<char> span, SearchValues<string> values) =>
            ContainsAny((ReadOnlyUnmanagedSpan<char>)span, values);

        /// <inheritdoc cref="ContainsAnyExcept{T}(ReadOnlyUnmanagedSpan{T}, T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAnyExcept<T>(this UnmanagedSpan<T> span, T value) where T : IEquatable<T>? =>
            ContainsAnyExcept((ReadOnlyUnmanagedSpan<T>)span, value);

        /// <inheritdoc cref="ContainsAnyExcept{T}(ReadOnlyUnmanagedSpan{T}, T, T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAnyExcept<T>(this UnmanagedSpan<T> span, T value0, T value1) where T : IEquatable<T>? =>
            ContainsAnyExcept((ReadOnlyUnmanagedSpan<T>)span, value0, value1);

        /// <inheritdoc cref="ContainsAnyExcept{T}(ReadOnlyUnmanagedSpan{T}, T, T, T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAnyExcept<T>(this UnmanagedSpan<T> span, T value0, T value1, T value2) where T : IEquatable<T>? =>
            ContainsAnyExcept((ReadOnlyUnmanagedSpan<T>)span, value0, value1, value2);

        /// <inheritdoc cref="ContainsAnyExcept{T}(ReadOnlyUnmanagedSpan{T}, ReadOnlyUnmanagedSpan{T})"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAnyExcept<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> values) where T : IEquatable<T>? =>
            ContainsAnyExcept((ReadOnlyUnmanagedSpan<T>)span, values);

        /// <inheritdoc cref="ContainsAnyExcept{T}(ReadOnlyUnmanagedSpan{T}, SearchValues{T})"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAnyExcept<T>(this UnmanagedSpan<T> span, SearchValues<T> values) where T : IEquatable<T>? =>
            ContainsAnyExcept((ReadOnlyUnmanagedSpan<T>)span, values);

        /// <inheritdoc cref="ContainsAnyInRange{T}(ReadOnlyUnmanagedSpan{T}, T, T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAnyInRange<T>(this UnmanagedSpan<T> span, T lowInclusive, T highInclusive) where T : IComparable<T> =>
            ContainsAnyInRange((ReadOnlyUnmanagedSpan<T>)span, lowInclusive, highInclusive);

        /// <inheritdoc cref="ContainsAnyExceptInRange{T}(ReadOnlyUnmanagedSpan{T}, T, T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool ContainsAnyExceptInRange<T>(this UnmanagedSpan<T> span, T lowInclusive, T highInclusive) where T : IComparable<T> =>
            ContainsAnyExceptInRange((ReadOnlyUnmanagedSpan<T>)span, lowInclusive, highInclusive);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1) where T : IEquatable<T>? =>
        ...
        /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing elements, or <see langword="null"/> to use the default <see cref="IEqualityComparer{T}"/> for the type of an element.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, IEqualityComparer<T>? comparer = null) =>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2) where T : IEquatable<T>? =>
        ...
        /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing elements, or <see langword="null"/> to use the default <see cref="IEqualityComparer{T}"/> for the type of an element.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2, IEqualityComparer<T>? comparer = null) =>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> values) where T : IEquatable<T>? =>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> values, IEqualityComparer<T>? comparer = null) =>
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this ReadOnlyUnmanagedSpan<T> span, SearchValues<T> values) where T : IEquatable<T>?
        {
            if (values is null)
            {
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny(this ReadOnlyUnmanagedSpan<char> span, SearchValues<string> values) =>
            IndexOfAny(span, values) >= 0;
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>? =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer = null) =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1) where T : IEquatable<T>? =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, IEqualityComparer<T>? comparer = null) =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2) where T : IEquatable<T>? =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2, IEqualityComparer<T>? comparer = null) =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> values) where T : IEquatable<T>? =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> values, IEqualityComparer<T>? comparer = null) =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, SearchValues<T> values) where T : IEquatable<T>?
        {
            if (values is null)
            {
                ThrowHelper.ThrowArgumentNullException(ExceptionArgument.values);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyInRange<T>(this ReadOnlyUnmanagedSpan<T> span, T lowInclusive, T highInclusive) where T : IComparable<T> =>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExceptInRange<T>(this ReadOnlyUnmanagedSpan<T> span, T lowInclusive, T highInclusive) where T : IComparable<T> =>
        ...
        public static unsafe int IndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    return UnmanagedSpanHelpers.IndexOfAnyExceptValueType(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(value),
                        span.Length);
                }
            ...
            return UnmanagedSpanHelpers.IndexOfAnyExcept(ref MemoryMarshal.GetReference(span), value, span.Length);
        }
        ...
        public static unsafe int IndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer = null)
        {
            ...
            else
            {
                ...
                static int IndexOfAnyExceptComparer(ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer)
                {
        ...
        public static unsafe int IndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1) where T : IEquatable<T>?
        {
            ...
            return UnmanagedSpanHelpers.IndexOfAnyExcept(ref MemoryMarshal.GetReference(span), value0, value1, span.Length);
        }
        ...
        public static unsafe int IndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, IEqualityComparer<T>? comparer = null)
        {
            ...
            else
            {
                ...
                static int IndexOfAnyExceptComparer(ReadOnlyUnmanagedSpan<T> span, T value0, T value1, IEqualityComparer<T>? comparer)
                {
                    comparer ??= EqualityComparer<T>.Default;
        ...
        public static unsafe int IndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2) where T : IEquatable<T>?
        {
            ...
            return UnmanagedSpanHelpers.IndexOfAnyExcept(ref MemoryMarshal.GetReference(span), value0, value1, value2, span.Length);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe int IndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2, T value3) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
            ...
            return UnmanagedSpanHelpers.IndexOfAnyExcept(ref MemoryMarshal.GetReference(span), value0, value1, value2, value3, span.Length);
        }
        ...
        public static unsafe int LastIndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    return UnmanagedSpanHelpers.LastIndexOfAnyExceptValueType(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(value),
                        span.Length);
                }
            ...
            return UnmanagedSpanHelpers.LastIndexOfAnyExcept(ref MemoryMarshal.GetReference(span), value, span.Length);
        }
        ...
        public static unsafe int LastIndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer = null)
        {
            ...
            else
            {
                ...
                static int LastIndexOfAnyExceptComparer(ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer)
                {
                    comparer ??= EqualityComparer<T>.Default;
        ...
        public static unsafe int LastIndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1) where T : IEquatable<T>?
        {
            ...
            return UnmanagedSpanHelpers.LastIndexOfAnyExcept(ref MemoryMarshal.GetReference(span), value0, value1, span.Length);
        }
        ...
        public static unsafe int LastIndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, IEqualityComparer<T>? comparer = null)
        {
            ...
            else
            {
                ...
                static int LastIndexOfAnyExceptComparer(ReadOnlyUnmanagedSpan<T> span, T value0, T value1, IEqualityComparer<T>? comparer)
                {
                    comparer ??= EqualityComparer<T>.Default;
        ...
        public static unsafe int LastIndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2) where T : IEquatable<T>?
        {
            ...
            return UnmanagedSpanHelpers.LastIndexOfAnyExcept(ref MemoryMarshal.GetReference(span), value0, value1, value2, span.Length);
        }
        ...
        public static unsafe int LastIndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2, IEqualityComparer<T>? comparer = null)
        {
            ...
            else
            {
                ...
                static int LastIndexOfAnyExceptComparer(ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2, IEqualityComparer<T>? comparer)
                {
                    comparer ??= EqualityComparer<T>.Default;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe int LastIndexOfAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2, T value3) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
            ...
            return UnmanagedSpanHelpers.LastIndexOfAnyExcept(ref MemoryMarshal.GetReference(span), value0, value1, value2, value3, span.Length);
        }
        ...
        public static int IndexOfAnyInRange<T>(this ReadOnlyUnmanagedSpan<T> span, T lowInclusive, T highInclusive) where T : IComparable<T>
        {
            ...
            if (Vector128.IsHardwareAccelerated)
            {
                ...
                {
                    return UnmanagedSpanHelpers.IndexOfAnyInRangeUnsignedNumber(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
            ...
            return UnmanagedSpanHelpers.IndexOfAnyInRange(ref MemoryMarshal.GetReference(span), lowInclusive, highInclusive, span.Length);
        }
        ...
        public static int IndexOfAnyExceptInRange<T>(this ReadOnlyUnmanagedSpan<T> span, T lowInclusive, T highInclusive) where T : IComparable<T>
        {
            ...
            if (Vector128.IsHardwareAccelerated)
            {
                if (lowInclusive is byte or sbyte)
                {
                    return UnmanagedSpanHelpers.IndexOfAnyExceptInRangeUnsignedNumber(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(lowInclusive),
                        Unsafe.BitCast<T, byte>(highInclusive),
                        span.Length);
            ...
            return UnmanagedSpanHelpers.IndexOfAnyExceptInRange(ref MemoryMarshal.GetReference(span), lowInclusive, highInclusive, span.Length);
        }
        ...
        public static int LastIndexOfAnyInRange<T>(this ReadOnlyUnmanagedSpan<T> span, T lowInclusive, T highInclusive) where T : IComparable<T>
        {
            ...
            if (Vector128.IsHardwareAccelerated)
            {
                if (lowInclusive is byte or sbyte)
                {
                    return UnmanagedSpanHelpers.LastIndexOfAnyInRangeUnsignedNumber(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(lowInclusive),
                        Unsafe.BitCast<T, byte>(highInclusive),
                        span.Length);
            ...
            return UnmanagedSpanHelpers.LastIndexOfAnyInRange(ref MemoryMarshal.GetReference(span), lowInclusive, highInclusive, span.Length);
        }
        ...
        public static int LastIndexOfAnyExceptInRange<T>(this ReadOnlyUnmanagedSpan<T> span, T lowInclusive, T highInclusive) where T : IComparable<T>
        {
            ...
            if (Vector128.IsHardwareAccelerated)
            {
                if (lowInclusive is byte or sbyte)
                {
                    return UnmanagedSpanHelpers.LastIndexOfAnyExceptInRangeUnsignedNumber(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(lowInclusive),
                        Unsafe.BitCast<T, byte>(highInclusive),
                        span.Length);
            ...
            return UnmanagedSpanHelpers.LastIndexOfAnyExceptInRange(ref MemoryMarshal.GetReference(span), lowInclusive, highInclusive, span.Length);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool SequenceEqual<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other) where T : IEquatable<T>? =>
            SequenceEqual((ReadOnlyUnmanagedSpan<T>)span, other);
        ...
        public static unsafe int IndexOf<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>?
        {
            ...
            {
                if (sizeof(T) == sizeof(byte))
                    return UnmanagedSpanHelpers.IndexOfValueType(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(value),
                        span.Length);
            ...
            return UnmanagedSpanHelpers.IndexOf(ref MemoryMarshal.GetReference(span), value, span.Length);
        }
        ...
        public static unsafe int IndexOf<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value) where T : IEquatable<T>?
        {
            ...
            {
                if (sizeof(T) == sizeof(byte))
                    return UnmanagedSpanHelpers.IndexOf(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        span.Length,
        ...
        public static unsafe int IndexOf<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value, IEqualityComparer<T>? comparer = null)
        {
            ...
            return IndexOfComparer(span, value, comparer);
            static int IndexOfComparer(ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value, IEqualityComparer<T>? comparer)
            {
                if (value.Length == 0)
                {
                    return 0;
        ...
        public static unsafe int LastIndexOf<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    return UnmanagedSpanHelpers.LastIndexOfValueType(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(value),
                        span.Length);
                }
            ...
            return UnmanagedSpanHelpers.LastIndexOf(ref MemoryMarshal.GetReference(span), value, span.Length);
        }
        ...
        public static unsafe int LastIndexOf<T>(this ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer = null)
        {
            ...
            else
            {
                ...
                static int LastIndexOfComparer(ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer)
                {
                    comparer ??= EqualityComparer<T>.Default;
        ...
        public static unsafe int LastIndexOf<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value) where T : IEquatable<T>?
        {
            ...
            return UnmanagedSpanHelpers.LastIndexOf(ref MemoryMarshal.GetReference(span), span.Length, ref MemoryMarshal.GetReference(value), value.Length);
        }
        ...
        public static unsafe int LastIndexOf<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value, IEqualityComparer<T>? comparer = null)
        {
            ...
            return LastIndexOfComparer(span, value, comparer);
            static int LastIndexOfComparer(ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value, IEqualityComparer<T>? comparer)
            {
                if (value.Length == 0)
                {
                    return span.Length;
        ...
        public static unsafe int IndexOfAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    return UnmanagedSpanHelpers.IndexOfAnyValueType(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(value0),
                        Unsafe.BitCast<T, byte>(value1),
                        span.Length);
            ...
            return UnmanagedSpanHelpers.IndexOfAny(ref MemoryMarshal.GetReference(span), value0, value1, span.Length);
        }
        ...
        public static unsafe int IndexOfAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2) where T : IEquatable<T>?
        {
            ...
            return UnmanagedSpanHelpers.IndexOfAny(ref MemoryMarshal.GetReference(span), value0, value1, value2, span.Length);
        }
        ...
        public static unsafe int IndexOfAny<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> values) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    ...
                    switch (values.Length)
                    {
                        ...
                        case 1:
                            return UnmanagedSpanHelpers.IndexOfValueType(ref spanRef, valueRef, span.Length);
                ...
                if (sizeof(T) == sizeof(short))
                {
                    ...
                    {
                        0 => -1,
                        1 => UnmanagedSpanHelpers.IndexOfValueType(ref spanRef, valueRef, span.Length),
                        2 => UnmanagedSpanHelpers.IndexOfAnyValueType(
                                ref spanRef,
                                valueRef,
                                Unsafe.Add(ref valueRef, 1),
                                span.Length),
                        3 => UnmanagedSpanHelpers.IndexOfAnyValueType(
                                 ref spanRef,
                                 valueRef,
                                 Unsafe.Add(ref valueRef, 1),
                                 Unsafe.Add(ref valueRef, 2),
                                 span.Length),
                        4 => UnmanagedSpanHelpers.IndexOfAnyValueType(
                                 ref spanRef,
                                 valueRef,
                                 Unsafe.Add(ref valueRef, 1),
                                 Unsafe.Add(ref valueRef, 2),
                                 Unsafe.Add(ref valueRef, 3),
                                 span.Length),
                        5 => UnmanagedSpanHelpers.IndexOfAnyValueType(
                                 ref spanRef,
                                 valueRef,
                                 Unsafe.Add(ref valueRef, 1),
                                 Unsafe.Add(ref valueRef, 2),
            ...
            return UnmanagedSpanHelpers.IndexOfAny(ref MemoryMarshal.GetReference(span), span.Length, ref MemoryMarshal.GetReference(values), values.Length);
        }
        ...
        public static unsafe int LastIndexOfAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    return UnmanagedSpanHelpers.LastIndexOfAnyValueType(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(value0),
                        Unsafe.BitCast<T, byte>(value1),
                        span.Length);
            ...
            return UnmanagedSpanHelpers.LastIndexOfAny(ref MemoryMarshal.GetReference(span), value0, value1, span.Length);
        }
        ...
        public static unsafe int LastIndexOfAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, IEqualityComparer<T>? comparer = null)
        {
            ...
            else
            {
                ...
                static int LastIndexOfAnyComparer(ReadOnlyUnmanagedSpan<T> span, T value0, T value1, IEqualityComparer<T>? comparer)
                {
                    comparer ??= EqualityComparer<T>.Default;
        ...
        public static unsafe int LastIndexOfAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2) where T : IEquatable<T>?
        {
            ...
            return UnmanagedSpanHelpers.LastIndexOfAny(ref MemoryMarshal.GetReference(span), value0, value1, value2, span.Length);
        }
        ...
        public static unsafe int LastIndexOfAny<T>(this ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2, IEqualityComparer<T>? comparer = null)
        {
            ...
            else
            {
                ...
                static int LastIndexOfAnyComparer(ReadOnlyUnmanagedSpan<T> span, T value0, T value1, T value2, IEqualityComparer<T>? comparer)
                {
                    comparer ??= EqualityComparer<T>.Default;
        ...
        public static unsafe int LastIndexOfAny<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> values) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    ...
                    switch (values.Length)
                    {
                        ...
                        case 1:
                            return UnmanagedSpanHelpers.LastIndexOfValueType(ref spanRef, valueRef, span.Length);
                ...
                if (sizeof(T) == sizeof(short))
                {
                    ...
                    {
                        0 => -1,
                        1 => UnmanagedSpanHelpers.LastIndexOfValueType(ref spanRef, valueRef, span.Length),
                        2 => UnmanagedSpanHelpers.LastIndexOfAnyValueType(
                                 ref spanRef,
                                 valueRef,
                                 Unsafe.Add(ref valueRef, 1),
                                 span.Length),
                        3 => UnmanagedSpanHelpers.LastIndexOfAnyValueType(
                                 ref spanRef,
                                 valueRef,
                                 Unsafe.Add(ref valueRef, 1),
                                 Unsafe.Add(ref valueRef, 2),
                                 span.Length),
                        4 => UnmanagedSpanHelpers.LastIndexOfAnyValueType(
                                 ref spanRef,
                                 valueRef,
                                 Unsafe.Add(ref valueRef, 1),
                                 Unsafe.Add(ref valueRef, 2),
                                 Unsafe.Add(ref valueRef, 3),
                                 span.Length),
                        5 => UnmanagedSpanHelpers.LastIndexOfAnyValueType(
                                 ref spanRef,
                                 valueRef,
                                 Unsafe.Add(ref valueRef, 1),
                                 Unsafe.Add(ref valueRef, 2),
            ...
            return UnmanagedSpanHelpers.LastIndexOfAny(ref MemoryMarshal.GetReference(span), span.Length, ref MemoryMarshal.GetReference(values), values.Length);
        }
        ...
        public static unsafe bool SequenceEqual<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other) where T : IEquatable<T>?
        {
            ...
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                return length == otherLength &&
                    UnmanagedSpanHelpers.SequenceEqual(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
            ...
            return length == otherLength && UnmanagedSpanHelpers.SequenceEqual(ref MemoryMarshal.GetReference(span), ref MemoryMarshal.GetReference(other), length);
        }
        ...
        [OverloadResolutionPriority(-1)]
        public static bool SequenceEqual<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other, IEqualityComparer<T>? comparer = null) =>
            SequenceEqual((ReadOnlyUnmanagedSpan<T>)span, other, comparer);
        ...
        /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing elements, or <see langword="null"/> to use the default <see cref="IEqualityComparer{T}"/> for the type of an element.</param>
        /// <returns>true if the two sequences are equal; otherwise, false.</returns>
        public static unsafe bool SequenceEqual<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other, IEqualityComparer<T>? comparer = null)
        {
            ...
            if (typeof(T).IsValueType)
            {
                if (comparer is null || comparer == EqualityComparer<T>.Default)
                {
                    ...
                    if (RuntimeHelpers.IsBitwiseEquatable<T>())
                    {
                        return UnmanagedSpanHelpers.SequenceEqual(
                            ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                            ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(other)),
        ...
        public static int SequenceCompareTo<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other) where T : IComparable<T>?
        {
            ...
            if (typeof(T) == typeof(byte))
                return UnmanagedSpanHelpers.SequenceCompareTo(
                    ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                    span.Length,
                    ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(other)),
                    other.Length);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool StartsWith<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value) where T : IEquatable<T>? =>
            StartsWith((ReadOnlyUnmanagedSpan<T>)span, value);
        ...
        [Intrinsic] // Unrolled and vectorized for half-constant input
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool StartsWith<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value) where T : IEquatable<T>?
        {
            ...
            return valueLength <= span.Length && UnmanagedSpanHelpers.SequenceEqual(ref MemoryMarshal.GetReference(span), ref MemoryMarshal.GetReference(value), valueLength);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool StartsWith<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value, IEqualityComparer<T>? comparer = null) =>
        ...
        [Intrinsic] // Unrolled and vectorized for half-constant input
        [OverloadResolutionPriority(-1)]
        public static bool EndsWith<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value) where T : IEquatable<T>? =>
            EndsWith((ReadOnlyUnmanagedSpan<T>)span, value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [Intrinsic] // Unrolled and vectorized for half-constant input
        public static unsafe bool EndsWith<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value) where T : IEquatable<T>?
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool EndsWith<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> value, IEqualityComparer<T>? comparer = null) =>
            value.Length <= span.Length &&
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool StartsWith<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>? =>
        ...
        /// <returns><see langword="true" /> if <paramref name="value" /> matches the beginning of <paramref name="span" />; otherwise, <see langword="false" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool StartsWith<T>(this ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer = null) =>
            span.Length != 0 &&
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool EndsWith<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>? =>
        ...
        /// <returns><see langword="true" /> if <paramref name="value" /> matches the end of <paramref name="span" />; otherwise, <see langword="false" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool EndsWith<T>(this ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer = null) =>
            span.Length != 0 &&
        ...
        /// </summary>
        public static void Reverse<T>(this UnmanagedSpan<T> span)
        {
            if (span.Length > 1)
            {
                UnmanagedSpanHelpers.Reverse(ref MemoryMarshal.GetReference(span), (nuint)span.Length);
            }
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnmanagedSpan<T> AsUnmanagedSpan<T>(this T[]? array)
        {
            return new UnmanagedSpan<T>(array);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnmanagedSpan<T> AsUnmanagedSpan<T>(this ArraySegment<T> segment)
        {
            return new UnmanagedSpan<T>(segment.Array, segment.Offset, segment.Count);
        }
        ...
        public static UnmanagedSpan<T> AsUnmanagedSpan<T>(this ArraySegment<T> segment, int start)
        {
            ...
            return new UnmanagedSpan<T>(segment.Array, segment.Offset + start, segment.Count - start);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnmanagedSpan<T> AsUnmanagedSpan<T>(this ArraySegment<T> segment, Index startIndex)
        {
            int actualIndex = startIndex.GetOffset(segment.Count);
            return AsUnmanagedSpan(segment, actualIndex);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void CopyTo<T>(this T[]? source, UnmanagedSpan<T> destination)
        {
            new ReadOnlyUnmanagedSpan<T>(source).CopyTo(destination);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool Overlaps<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other) =>
            Overlaps((ReadOnlyUnmanagedSpan<T>)span, other);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [OverloadResolutionPriority(-1)]
        public static bool Overlaps<T>(this UnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other, out int elementOffset) =>
            Overlaps((ReadOnlyUnmanagedSpan<T>)span, other, out elementOffset);

        /// <summary>
        /// Determines whether two sequences overlap in memory.
        /// </summary>
        public static unsafe bool Overlaps<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other)
        {
        ...
        /// Determines whether two sequences overlap in memory and outputs the element offset.
        /// </summary>
        public static unsafe bool Overlaps<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other, out int elementOffset)
        {
            if (span.IsEmpty || other.IsEmpty)
            {
                elementOffset = 0;
        ...
        /// <summary>
        /// Searches an entire sorted <see cref="ReadOnlyUnmanagedSpan{T}"/> for a value
        /// using the specified <see cref="IComparable{T}"/> generic interface.
        /// </summary>
        /// <typeparam name="T">The element type of the span.</typeparam>
        /// <param name="span">The sorted <see cref="ReadOnlyUnmanagedSpan{T}"/> to search.</param>
        /// <param name="comparable">The <see cref="IComparable{T}"/> to use when comparing.</param>
        /// <returns>
        /// The zero-based index of <paramref name="comparable"/> in the sorted <paramref name="span"/>,
        /// if <paramref name="comparable"/> is found; otherwise, a negative number that is the bitwise complement
        /// of the index of the next element that is larger than <paramref name="comparable"/> or, if there is
        /// no larger element, the bitwise complement of <see cref="ReadOnlyUnmanagedSpan{T}.Length"/>.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name = "comparable" /> is <see langword="null"/> .
        /// </exception>
        ...
        public static int BinarySearch<T, TComparable>(
            ...
            where TComparable : IComparable<T>, allows ref struct
        {
            return UnmanagedSpanHelpers.BinarySearch(span, comparable);
        }

        /// <summary>
        /// Searches an entire sorted <see cref="ReadOnlyUnmanagedSpan{T}"/> for the specified <paramref name="value"/>
        /// using the specified <typeparamref name="TComparer"/> generic type.
        /// </summary>
        /// <typeparam name="T">The element type of the span.</typeparam>
        /// <typeparam name="TComparer">The specific type of <see cref="IComparer{T}"/>.</typeparam>
            ...
            where TComparer : IComparer<T>, allows ref struct
        {
            ...
            var comparable = new UnmanagedSpanHelpers.ComparerComparable<T, TComparer>(
                value, comparer);
        ...
        /// </exception>
        public static void Sort<T>(this UnmanagedSpan<T> span) =>
        ...
        /// </exception>
        public static void Sort<T, TComparer>(this UnmanagedSpan<T> span, TComparer comparer) where TComparer : IComparer<T>?
        {
            if (span.Length > 1)
            {
        ...
        public static void Sort<T>(this UnmanagedSpan<T> span, Comparison<T> comparison)
        {
            if (comparison == null)
        ...
        /// implement the <see cref="IComparable{T}" /> interface.
        /// </exception>
        public static void Sort<TKey, TValue, TComparer>(this UnmanagedSpan<TKey> keys, UnmanagedSpan<TValue> items, TComparer comparer) where TComparer : IComparer<TKey>?
        {
        ...
        /// The length of <paramref name="keys"/> isn't equal to the length of <paramref name="items"/>.
        /// </exception>
        public static void Sort<TKey, TValue>(this UnmanagedSpan<TKey> keys, UnmanagedSpan<TValue> items, Comparison<TKey> comparison)
        {
            if (comparison == null)
                ThrowHelper.ThrowArgumentNullException(ExceptionArgument.comparison);
            if (keys.Length != items.Length)
        ...
        public static unsafe void Replace<T>(this UnmanagedSpan<T> span, T oldValue, T newValue) where T : IEquatable<T>?
        {
            ...
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    ...
                    UnmanagedSpanHelpers.ReplaceValueType(
                        ref src,
                        ref src,
            ...
            UnmanagedSpanHelpers.Replace(ref src2, ref src2, oldValue, newValue, length);
        }
        ...
        /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing elements, or <see langword="null"/> to use the default <see cref="IEqualityComparer{T}"/> for the type of an element.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void Replace<T>(this UnmanagedSpan<T> span, T oldValue, T newValue, IEqualityComparer<T>? comparer = null)
        {
            if (typeof(T).IsValueType && (comparer is null || comparer == EqualityComparer<T>.Default))
            {
                if (RuntimeHelpers.IsBitwiseEquatable<T>())
        ...
        public static unsafe void Replace<T>(this ReadOnlyUnmanagedSpan<T> source, UnmanagedSpan<T> destination, T oldValue, T newValue) where T : IEquatable<T>?
        {
            ...
            UnmanagedSpanHelpers.Replace(ref src, ref dst, oldValue, newValue, length);
        }
        ...
        public static unsafe void Replace<T>(this ReadOnlyUnmanagedSpan<T> source, UnmanagedSpan<T> destination, T oldValue, T newValue, IEqualityComparer<T>? comparer = null)
        {
            ...
            if (typeof(T).IsValueType && (comparer is null || comparer == EqualityComparer<T>.Default))
            {
                ...
                static void ReplaceDefaultComparer(ReadOnlyUnmanagedSpan<T> source, UnmanagedSpan<T> destination, T oldValue, T newValue)
                {
            ...
            else
            {
                ...
                static void ReplaceComparer(ReadOnlyUnmanagedSpan<T> source, UnmanagedSpan<T> destination, T oldValue, T newValue, IEqualityComparer<T>? comparer)
                {
                    destination = destination.Slice(0, source.Length);
                    comparer ??= EqualityComparer<T>.Default;
        ...
        public static void ReplaceAny<T>(this ReadOnlyUnmanagedSpan<T> source, UnmanagedSpan<T> destination, SearchValues<T> values, T newValue) where T : IEquatable<T>?
        {
        ...
        /// <param name="newValue">The value to replace all occurrences of any of the elements in <paramref name="values"/>.</param>
        /// <exception cref="ArgumentNullException"><paramref name="values"/> is <see langword="null"/>.</exception>
        public static void ReplaceAny<T>(this UnmanagedSpan<T> span, SearchValues<T> values, T newValue) where T : IEquatable<T>?
        {
            int pos;
        ...
        /// </exception>
        /// <exception cref="ArgumentNullException"><paramref name="values"/> is <see langword="null"/>.</exception>
        public static void ReplaceAnyExcept<T>(this ReadOnlyUnmanagedSpan<T> source, UnmanagedSpan<T> destination, SearchValues<T> values, T newValue) where T : IEquatable<T>?
        {
            if (source.Length > destination.Length)
            {
                ThrowHelper.ThrowArgumentException_DestinationTooShort();
        ...
        /// <param name="newValue">The value to replace all occurrences of any elements other than those in <paramref name="values"/>.</param>
        /// <exception cref="ArgumentNullException"><paramref name="values"/> is <see langword="null"/>.</exception>
        public static void ReplaceAnyExcept<T>(this UnmanagedSpan<T> span, SearchValues<T> values, T newValue) where T : IEquatable<T>?
        {
            int pos;
        ...
        /// <param name="other">The second sequence to compare.</param>
        /// <returns>The length of the common prefix shared by the two spans.  If there's no shared prefix, 0 is returned.</returns>
        public static unsafe int CommonPrefixLength<T>(this ReadOnlyUnmanagedSpan<T> span, ReadOnlyUnmanagedSpan<T> other)
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void SliceLongerSpanToMatchShorterLength<T>(ref ReadOnlyUnmanagedSpan<T> span, ref ReadOnlyUnmanagedSpan<T> other)
        {
        ...
        public static SpanSplitEnumerator<T> Split<T>(this ReadOnlyUnmanagedSpan<T> source, T separator) where T : IEquatable<T> =>
        ...
        /// <returns>Returns a <see cref="SpanSplitEnumerator{T}"/>.</returns>
        public static SpanSplitEnumerator<T> Split<T>(this ReadOnlyUnmanagedSpan<T> source, ReadOnlyUnmanagedSpan<T> separator) where T : IEquatable<T> =>
        ...
        /// or when <see cref="SplitAny(ReadOnlyUnmanagedSpan{char}, Span{Range}, ReadOnlyUnmanagedSpan{char}, StringSplitOptions)"/>
        /// is used with an empty separator span.
        /// </remarks>
        public static SpanSplitEnumerator<T> SplitAny<T>(this ReadOnlyUnmanagedSpan<T> source, [UnscopedRef] params ReadOnlyUnmanagedSpan<T> separators) where T : IEquatable<T> =>
        ...
        /// <returns>Returns a <see cref="SpanSplitEnumerator{T}"/>.</returns>
        /// <remarks>
        /// Unlike <see cref="SplitAny{T}(ReadOnlyUnmanagedSpan{T}, ReadOnlyUnmanagedSpan{T})"/>, the <paramref name="separators"/> is not checked for being empty.
        /// An empty <paramref name="separators"/> will result in no separators being found, regardless of the type of <typeparamref name="T"/>,
        /// whereas <see cref="SplitAny{T}(ReadOnlyUnmanagedSpan{T}, ReadOnlyUnmanagedSpan{T})"/> will use all Unicode whitespace characters as separators if <paramref name="separators"/> is
        /// empty and <typeparamref name="T"/> is <see cref="char"/>.
        /// </remarks>
        public static SpanSplitEnumerator<T> SplitAny<T>(this ReadOnlyUnmanagedSpan<T> source, SearchValues<T> separators) where T : IEquatable<T> =>
            new SpanSplitEnumerator<T>(source, separators);

        /// <summary>
        /// Parses the source <see cref="ReadOnlyUnmanagedSpan{Char}"/> for the specified <paramref name="separator"/>, populating the <paramref name="destination"/> span
        ...
        /// </para>
        /// </remarks>
        public static int Split(this ReadOnlyUnmanagedSpan<char> source, UnmanagedSpan<Range> destination, char separator, StringSplitOptions options = StringSplitOptions.None)
        {
            string.CheckStringSplitOptions(options);

            return SplitCore(source, destination, new ReadOnlyUnmanagedSpan<char>(in separator), default, isAny: true, options);
        }
        ...
        /// </para>
        /// </remarks>
        public static int Split(this ReadOnlyUnmanagedSpan<char> source, UnmanagedSpan<Range> destination, ReadOnlyUnmanagedSpan<char> separator, StringSplitOptions options = StringSplitOptions.None)
        {
            string.CheckStringSplitOptions(options);
        ...
        /// <summary>
        /// Parses the source <see cref="ReadOnlyUnmanagedSpan{Char}"/> for one of the specified <paramref name="separators"/>, populating the <paramref name="destination"/> span
        /// with <see cref="Range"/> instances representing the regions between the separators.
        /// </summary>
        /// <param name="source">The source span to parse.</param>
        /// <param name="destination">The destination span into which the resulting ranges are written.</param>
        ...
        /// </para>
        /// </remarks>
        public static int SplitAny(this ReadOnlyUnmanagedSpan<char> source, UnmanagedSpan<Range> destination, ReadOnlyUnmanagedSpan<char> separators, StringSplitOptions options = StringSplitOptions.None)
        {
            string.CheckStringSplitOptions(options);
        ...
        /// </para>
        /// </remarks>
        public static int SplitAny(this ReadOnlyUnmanagedSpan<char> source, UnmanagedSpan<Range> destination, ReadOnlyUnmanagedSpan<string> separators, StringSplitOptions options = StringSplitOptions.None)
        {
            string.CheckStringSplitOptions(options);
        ...
        private static int SplitCore(
            ReadOnlyUnmanagedSpan<char> source, UnmanagedSpan<Range> destination,
            ReadOnlyUnmanagedSpan<char> separatorOrSeparators, ReadOnlyUnmanagedSpan<string?> stringSeparators, bool isAny,
            StringSplitOptions options)
        {
            ...
            UnmanagedSpan<Range> destinationMinusOne = destination.Slice(0, destination.Length - 1);
        ...
        private static (int StartInclusive, int EndExclusive) TrimSplitEntry(ReadOnlyUnmanagedSpan<char> source, int startInclusive, int endExclusive)
        {
        ...
        /// <returns>The number of times <paramref name="value"/> was found in the <paramref name="span"/>.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int Count<T>(this ReadOnlyUnmanagedSpan<T> span, T value) where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    return UnmanagedSpanHelpers.CountValueType(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        Unsafe.BitCast<T, byte>(value),
                        span.Length);
                }
            ...
            return UnmanagedSpanHelpers.Count(
                ref MemoryMarshal.GetReference(span),
                value,
                span.Length);
        }
        ...
        /// <returns>The number of times <paramref name="value"/> was found in the <paramref name="span"/>.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int Count<T>(this ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer = null)
        {
            if (typeof(T).IsValueType && (comparer is null || comparer == EqualityComparer<T>.Default))
            {
                if (RuntimeHelpers.IsBitwiseEquatable<T>())
            ...
            else
            {
                ...
                static int CountComparer(ReadOnlyUnmanagedSpan<T> span, T value, IEqualityComparer<T>? comparer)
                {
                    comparer ??= EqualityComparer<T>.Default;
        ...
        public static bool TryWrite(this UnmanagedSpan<char> destination, [InterpolatedStringHandlerArgument(nameof(destination))] ref TryWriteInterpolatedStringHandler handler, out int charsWritten)
        {
        ...
        /// <param name="charsWritten">The number of characters written to the span.</param>
        /// <returns>true if the entire interpolated string could be formatted successfully; otherwise, false.</returns>
        public static bool TryWrite(this UnmanagedSpan<char> destination, IFormatProvider? provider, [InterpolatedStringHandlerArgument(nameof(destination), nameof(provider))] ref TryWriteInterpolatedStringHandler handler, out int charsWritten) =>
        ...
        public static bool TryWrite<TArg0>(this UnmanagedSpan<char> destination, IFormatProvider? provider, CompositeFormat format, out int charsWritten, TArg0 arg0)
        {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="format"/> is null.</exception>
        /// <exception cref="FormatException">The index of a format item is greater than or equal to the number of supplied arguments.</exception>
        public static bool TryWrite<TArg0, TArg1>(this UnmanagedSpan<char> destination, IFormatProvider? provider, CompositeFormat format, out int charsWritten, TArg0 arg0, TArg1 arg1)
        {
            ArgumentNullException.ThrowIfNull(format);
        ...
        /// <exception cref="ArgumentNullException"><paramref name="format"/> is null.</exception>
        /// <exception cref="FormatException">The index of a format item is greater than or equal to the number of supplied arguments.</exception>
        public static bool TryWrite<TArg0, TArg1, TArg2>(this UnmanagedSpan<char> destination, IFormatProvider? provider, CompositeFormat format, out int charsWritten, TArg0 arg0, TArg1 arg1, TArg2 arg2)
        {
            ArgumentNullException.ThrowIfNull(format);
        ...
        /// <exception cref="FormatException">The index of a format item is greater than or equal to the number of supplied arguments.</exception>
        public static bool TryWrite(this UnmanagedSpan<char> destination, IFormatProvider? provider, CompositeFormat format, out int charsWritten, params object?[] args)
        {
            ArgumentNullException.ThrowIfNull(format);
            ArgumentNullException.ThrowIfNull(args);
            return TryWrite(destination, provider, format, out charsWritten, (ReadOnlyUnmanagedSpan<object?>)args);
        }
        ...
        /// <exception cref="ArgumentNullException"><paramref name="format"/> is null.</exception>
        /// <exception cref="FormatException">The index of a format item is greater than or equal to the number of supplied arguments.</exception>
        public static bool TryWrite(this UnmanagedSpan<char> destination, IFormatProvider? provider, CompositeFormat format, out int charsWritten, params ReadOnlyUnmanagedSpan<object?> args)
        {
            ArgumentNullException.ThrowIfNull(format);
        ...
        private static bool TryWrite<TArg0, TArg1, TArg2>(UnmanagedSpan<char> destination, IFormatProvider? provider, CompositeFormat format, out int charsWritten, TArg0 arg0, TArg1 arg1, TArg2 arg2, ReadOnlyUnmanagedSpan<object?> args)
        {
        ...
        /// <summary>
        /// Enables enumerating each split within a <see cref="ReadOnlyUnmanagedSpan{T}"/> that has been divided using one or more separators.
        /// </summary>
        ...
        public ref struct SpanSplitEnumerator<T> : IEnumerator<Range> where T : IEquatable<T>
        {
            ...
            private readonly ReadOnlyUnmanagedSpan<T> _source;
            ...
            /// </summary>
            private readonly ReadOnlyUnmanagedSpan<T> _separatorBuffer;
            ...
            /// <returns>Returns the <see cref="ReadOnlyUnmanagedSpan{T}"/> that was provided when creating this enumerator.</returns>
            public readonly ReadOnlyUnmanagedSpan<T> Source => _source;
            ...
            internal SpanSplitEnumerator(ReadOnlyUnmanagedSpan<T> source, SearchValues<T> searchValues)
            {
                _source = source;
            ...
            /// </remarks>
            internal SpanSplitEnumerator(ReadOnlyUnmanagedSpan<T> source, ReadOnlyUnmanagedSpan<T> separators)
            {
                _source = source;
            ...
            internal SpanSplitEnumerator(ReadOnlyUnmanagedSpan<T> source, ReadOnlyUnmanagedSpan<T> separator, bool treatAsSingleSeparator)
            {
            ...
            internal SpanSplitEnumerator(ReadOnlyUnmanagedSpan<T> source, T separator)
            {
                _source = source;
        ...
        private enum SpanSplitEnumeratorMode
        {
            ...
            /// instance instead of in a <see cref="ReadOnlyUnmanagedSpan{Char}"/>.
            /// </summary>
            SearchValues
        }
        ...
        public ref struct TryWriteInterpolatedStringHandler
        {
            ...
            private readonly UnmanagedSpan<char> _destination;
            ...
            public TryWriteInterpolatedStringHandler(int literalLength, int formattedCount, UnmanagedSpan<char> destination, out bool shouldAppend)
            {
            ...
            /// <param name="shouldAppend">Upon return, true if the destination may be long enough to support the formatting, or false if it won't be.</param>
            /// <remarks>This is intended to be called only by compiler-generated code. Arguments are not validated as they'd otherwise be for members intended to be used directly.</remarks>
            public TryWriteInterpolatedStringHandler(int literalLength, int formattedCount, UnmanagedSpan<char> destination, IFormatProvider? provider, out bool shouldAppend)
            {
                _destination = destination;
                _provider = provider;
                _pos = 0;
            ...
            #region AppendFormatted ReadOnlyUnmanagedSpan<char>
            /// <summary>Writes the specified character span to the handler.</summary>
            /// <param name="value">The span to write.</param>
            public bool AppendFormatted(scoped ReadOnlyUnmanagedSpan<char> value)
            {
            ...
            /// <param name="alignment">Minimum number of characters that should be written for this value.  If the value is negative, it indicates left-aligned and the required minimum is the absolute value.</param>
            /// <param name="format">The format string.</param>
            public bool AppendFormatted(scoped ReadOnlyUnmanagedSpan<char> value, int alignment = 0, string? format = null)
            {
