...
namespace System
{
    internal static partial class UnmanagedSpanHelpers // .T
    {
        ...
        internal static bool ContainsValueType<T>(ref T searchSpace, T value, long length) where T : struct, INumber<T>
        {
            ...
            {
                return PackedUnmanagedSpanHelpers.Contains(ref Unsafe.As<T, short>(ref searchSpace), Unsafe.BitCast<T, short>(value), length);
            }
        ...
        {
            if (PackedUnmanagedSpanHelpers.PackedIndexOfIsSupported && typeof(TValue) == typeof(short) && PackedUnmanagedSpanHelpers.CanUsePackedIndexOf(value))
            {
                return typeof(TNegator) == typeof(DontNegate<short>)
                    ? PackedUnmanagedSpanHelpers.IndexOf(ref Unsafe.As<TValue, char>(ref searchSpace), Unsafe.BitCast<TValue, char>(value), length)
                    : PackedUnmanagedSpanHelpers.IndexOfAnyExcept(ref Unsafe.As<TValue, char>(ref searchSpace), Unsafe.BitCast<TValue, char>(value), length);
            }
        ...
        private static long IndexOfAnyValueType<TValue, TNegator>(ref TValue searchSpace, TValue value0, TValue value1, long length)
            ...
            where TNegator : struct, INegator<TValue>
        {
            if (PackedUnmanagedSpanHelpers.PackedIndexOfIsSupported && typeof(TValue) == typeof(short) && PackedUnmanagedSpanHelpers.CanUsePackedIndexOf(value0) && PackedUnmanagedSpanHelpers.CanUsePackedIndexOf(value1))
            {
                ...
                if (RuntimeHelpers.IsKnownConstant(value0) && RuntimeHelpers.IsKnownConstant(value1))
                {
                    ...
                    if ((char0 ^ char1) == 0x20)
                    {
                        ...
                        return typeof(TNegator) == typeof(DontNegate<short>)
                            ? PackedUnmanagedSpanHelpers.IndexOfAnyIgnoreCase(ref Unsafe.As<TValue, char>(ref searchSpace), lowerCase, length)
                            : PackedUnmanagedSpanHelpers.IndexOfAnyExceptIgnoreCase(ref Unsafe.As<TValue, char>(ref searchSpace), lowerCase, length);
                    }
                }

                return typeof(TNegator) == typeof(DontNegate<short>)
                    ? PackedUnmanagedSpanHelpers.IndexOfAny(ref Unsafe.As<TValue, char>(ref searchSpace), char0, char1, length)
                    : PackedUnmanagedSpanHelpers.IndexOfAnyExcept(ref Unsafe.As<TValue, char>(ref searchSpace), char0, char1, length);
            }
        ...
        private static long IndexOfAnyValueType<TValue, TNegator>(ref TValue searchSpace, TValue value0, TValue value1, TValue value2, long length)
            ...
            where TNegator : struct, INegator<TValue>
        {
            if (PackedUnmanagedSpanHelpers.PackedIndexOfIsSupported && typeof(TValue) == typeof(short) && PackedUnmanagedSpanHelpers.CanUsePackedIndexOf(value0) && PackedUnmanagedSpanHelpers.CanUsePackedIndexOf(value1) && PackedUnmanagedSpanHelpers.CanUsePackedIndexOf(value2))
            {
                return typeof(TNegator) == typeof(DontNegate<short>)
                    ? PackedUnmanagedSpanHelpers.IndexOfAny(ref Unsafe.As<TValue, char>(ref searchSpace), Unsafe.BitCast<TValue, char>(value0), Unsafe.BitCast<TValue, char>(value1), Unsafe.BitCast<TValue, char>(value2), length)
                    : PackedUnmanagedSpanHelpers.IndexOfAnyExcept(ref Unsafe.As<TValue, char>(ref searchSpace), Unsafe.BitCast<TValue, char>(value0), Unsafe.BitCast<TValue, char>(value1), Unsafe.BitCast<TValue, char>(value2), length);
            }
        ...
        {
            if (PackedUnmanagedSpanHelpers.PackedIndexOfIsSupported && typeof(T) == typeof(ushort) && PackedUnmanagedSpanHelpers.CanUsePackedIndexOf(lowInclusive) && PackedUnmanagedSpanHelpers.CanUsePackedIndexOf(highInclusive) && highInclusive >= lowInclusive)
            {
                ...
                return typeof(TNegator) == typeof(DontNegate<ushort>)
                    ? PackedUnmanagedSpanHelpers.IndexOfAnyInRange(ref charSearchSpace, charLowInclusive, charRange, length)
                    : PackedUnmanagedSpanHelpers.IndexOfAnyExceptInRange(ref charSearchSpace, charLowInclusive, charRange, length);
            }
