...
namespace System.Runtime.CompilerServices
{
    public static partial class RuntimeHelpers
    {
        ...
        public static T[] GetSubArray<T>(T[] array, Range range)
        {
            ...
            // original incoming array. It's safe for us to UnmanagedSpanHelpers.Memmove the contents
        ...
        internal static bool CanPrimitiveWiden(CorElementType srcET, CorElementType dstET)
        {
            ...
            ReadOnlyUnmanagedSpan<short> primitiveWidenTable =
            [
        ...
        /// <summary>Provide a fast way to access constant data stored in a module as a ReadOnlyUnmanagedSpan{T}</summary>
        /// <param name="fldHandle">A field handle that specifies the location of the data to be referred to by the ReadOnlyUnmanagedSpan{T}. The Rva of the field must be aligned on a natural boundary of type T</param>
        /// <returns>A ReadOnlyUnmanagedSpan{T} of the data stored in the field</returns>
        ...
        [Intrinsic]
        public static ReadOnlyUnmanagedSpan<T> CreateUnmanagedSpan<T>(RuntimeFieldHandle fldHandle)
#if NATIVEAOT
...
#else
            => new ReadOnlyUnmanagedSpan<T>(ref Unsafe.As<byte, T>(ref GetSpanDataFrom(fldHandle, typeof(T).TypeHandle, out int length)), length);
#endif
