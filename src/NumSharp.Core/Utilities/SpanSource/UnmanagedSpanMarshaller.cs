...
{
    /// <summary>
    /// Supports marshalling a <see cref="UnmanagedSpan{T}"/> from managed value
    ...
    /// <remarks>
    /// A <see cref="UnmanagedSpan{T}"/> marshalled with this marshaller will match the semantics of <see cref="MemoryMarshal.GetReference{T}(UnmanagedSpan{T})"/>.
    ...
    /// </remarks>
    [CLSCompliant(false)]
    [CustomMarshaller(typeof(UnmanagedSpan<>), MarshalMode.Default, typeof(UnmanagedSpanMarshaller<,>))]
    [CustomMarshaller(typeof(UnmanagedSpan<>), MarshalMode.ManagedToUnmanagedIn, typeof(UnmanagedSpanMarshaller<,>.ManagedToUnmanagedIn))]
    [ContiguousCollectionMarshaller]
    public static unsafe class UnmanagedSpanMarshaller<T, TUnmanagedElement>
        where TUnmanagedElement : unmanaged
    {
        ...
        public static TUnmanagedElement* AllocateContainerForUnmanagedElements(UnmanagedSpan<T> managed, out int numElements)
        {
        ...
        public static ReadOnlyUnmanagedSpan<T> GetManagedValuesSource(UnmanagedSpan<T> managed)
            => managed;
        ...
        [RequiresUnsafe]
        public static UnmanagedSpan<T> AllocateContainerForManagedElements(TUnmanagedElement* unmanaged, int numElements)
        {
        ...
        public static UnmanagedSpan<T> GetManagedValuesDestination(UnmanagedSpan<T> managed)
            => managed;
        ...
        [RequiresUnsafe]
        public static ReadOnlyUnmanagedSpan<TUnmanagedElement> GetUnmanagedValuesSource(TUnmanagedElement* unmanaged, int numElements)
        {
            if (unmanaged == null)
                return [];

            return new ReadOnlyUnmanagedSpan<TUnmanagedElement>(unmanaged, numElements);
        }
        ...
        public ref struct ManagedToUnmanagedIn
        {
            ...
            private UnmanagedSpan<T> _managedArray;
            private TUnmanagedElement* _allocatedMemory;
            private UnmanagedSpan<TUnmanagedElement> _span;

            /// <summary>
            /// Initializes the <see cref="UnmanagedSpanMarshaller{T, TUnmanagedElement}.ManagedToUnmanagedIn"/> marshaller.
            /// </summary>
            ...
            /// </remarks>
            public void FromManaged(UnmanagedSpan<T> managed, UnmanagedSpan<TUnmanagedElement> buffer)
            {
            ...
            public static ref T GetPinnableReference(UnmanagedSpan<T> managed)
            {
