...
namespace System
{
    ...
    public readonly struct Memory<T> : IEquatable<Memory<T>>
    {
        ...
        public UnmanagedSpan<T> Span
        {
            ...
            get
            {
                // This property getter has special support for returning a mutable UnmanagedSpan<char> that wraps
                ...
                return new UnmanagedSpan<T>(ref refToReturn, lengthOfUnderlyingSpan);
            }
        }
