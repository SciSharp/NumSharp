...
{
    /// <summary>
    /// Represents a contiguous region of memory, similar to <see cref="ReadOnlyUnmanagedSpan{T}"/>.
    /// Unlike <see cref="ReadOnlyUnmanagedSpan{T}"/>, it is not a byref-like type.
    /// </summary>
    ...
    public readonly struct ReadOnlyMemory<T> : IEquatable<ReadOnlyMemory<T>>
    {
        ...
        /// </summary>
        public ReadOnlyUnmanagedSpan<T> Span
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                ...
                if (tmpObject != null)
                {
                    ...
                    else if (RuntimeHelpers.ObjectHasComponentSize(tmpObject))
                    {
                        ...
                        // into a Memory<object> or a UnmanagedSpan<object>, but it can be turned into a ROM/ROS<object>.
                    ...
                    else
                    {
                        ...
                        UnmanagedSpan<T> memoryManagerSpan = Unsafe.As<MemoryManager<T>>(tmpObject).GetSpan();
                ...
                return new ReadOnlyUnmanagedSpan<T>(ref refToReturn, lengthOfUnderlyingSpan);
            }
        }
