...
namespace System
{
    ...
    public readonly ref struct UnmanagedSpan<T>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [RequiresUnsafe]
        public unsafe UnmanagedSpan(void* pointer, int length)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal UnmanagedSpan(ref T reference, int length)
        {
        ...
        public unsafe void Clear()
        {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
            {
                UnmanagedSpanHelpers.ClearWithReferences(ref Unsafe.As<T, IntPtr>(ref _reference), (uint)_length * (nuint)(sizeof(T) / sizeof(nuint)));
            }
            else
            {
                UnmanagedSpanHelpers.ClearWithoutReferences(ref Unsafe.As<T, byte>(ref _reference), (uint)_length * (nuint)sizeof(T));
            }
        }
        ...
        {
            UnmanagedSpanHelpers.Fill(ref _reference, (uint)_length, value);
        }
        ...
        public UnmanagedSpan<T> Slice(int start)
        {
            ...
            return new UnmanagedSpan<T>(ref Unsafe.Add(ref _reference, (nint)(uint)start /* force zero-extension */), _length - start);
        }
        ...
        public UnmanagedSpan<T> Slice(int start, int length)
        {
            ...
            return new UnmanagedSpan<T>(ref Unsafe.Add(ref _reference, (nint)(uint)start /* force zero-extension */), length);
        }
