...
namespace System.Buffers
{
    public ref partial struct SequenceReader<T> where T : unmanaged, IEquatable<T>
    {
        ...
        public bool TryReadTo(out ReadOnlyUnmanagedSpan<T> span, T delimiter, bool advancePastDelimiter = true)
        {
            ReadOnlyUnmanagedSpan<T> remaining = UnreadSpan;
        ...
        private bool TryReadToSlow(out ReadOnlyUnmanagedSpan<T> span, T delimiter, bool advancePastDelimiter)
        {
        ...
        /// <param name="advancePastDelimiter">True to move past the <paramref name="delimiter"/> if found.</param>
        /// <returns>True if the <paramref name="delimiter"/> was found.</returns>
        public bool TryReadTo(out ReadOnlyUnmanagedSpan<T> span, T delimiter, T delimiterEscape, bool advancePastDelimiter = true)
        {
            ReadOnlyUnmanagedSpan<T> remaining = UnreadSpan;
            int index = remaining.IndexOf(delimiter);
        ...
        private bool TryReadToSlow(out ReadOnlyUnmanagedSpan<T> span, T delimiter, T delimiterEscape, int index, bool advancePastDelimiter)
        {
        ...
        public bool TryReadToAny(out ReadOnlyUnmanagedSpan<T> span, scoped ReadOnlyUnmanagedSpan<T> delimiters, bool advancePastDelimiter = true)
        {
            ReadOnlyUnmanagedSpan<T> remaining = UnreadSpan;
        ...
        private bool TryReadToAnySlow(out ReadOnlyUnmanagedSpan<T> span, scoped ReadOnlyUnmanagedSpan<T> delimiters, bool advancePastDelimiter)
        {
        ...
        /// <param name="advancePastDelimiter">True to move past the first found instance of any of the given <paramref name="delimiters"/>.</param>
        /// <returns>True if any of the <paramref name="delimiters"/> were found.</returns>
        public bool TryReadToAny(out ReadOnlySequence<T> sequence, scoped ReadOnlyUnmanagedSpan<T> delimiters, bool advancePastDelimiter = true)
        {
            return TryReadToAnyInternal(out sequence, delimiters, advancePastDelimiter);
        }

        private bool TryReadToAnyInternal(out ReadOnlySequence<T> sequence, scoped ReadOnlyUnmanagedSpan<T> delimiters, bool advancePastDelimiter, int skip = 0)
        {
            SequenceReader<T> copy = this;
            if (skip > 0)
                Advance(skip);
        ...
        /// <param name="advancePastDelimiter">True to move past the <paramref name="delimiter"/> if found.</param>
        /// <returns>True if the <paramref name="delimiter"/> was found.</returns>
        public bool TryReadTo(out ReadOnlyUnmanagedSpan<T> span, scoped ReadOnlyUnmanagedSpan<T> delimiter, bool advancePastDelimiter = true)
        {
            ReadOnlyUnmanagedSpan<T> remaining = UnreadSpan;
            int index = remaining.IndexOf(delimiter);
        ...
        private bool TryReadToSlow(out ReadOnlyUnmanagedSpan<T> span, scoped ReadOnlyUnmanagedSpan<T> delimiter, bool advancePastDelimiter)
        {
        ...
        /// <param name="advancePastDelimiter">True to move past the <paramref name="delimiter"/> if found.</param>
        /// <returns>True if the <paramref name="delimiter"/> was found.</returns>
        public bool TryReadTo(out ReadOnlySequence<T> sequence, scoped ReadOnlyUnmanagedSpan<T> delimiter, bool advancePastDelimiter = true)
        {
        ...
        public bool TryAdvanceToAny(scoped ReadOnlyUnmanagedSpan<T> delimiters, bool advancePastDelimiter = true)
        {
            ReadOnlyUnmanagedSpan<T> remaining = UnreadSpan;
        ...
        /// </summary>
        /// <returns>How many positions the reader has been advanced.</returns>
        public long AdvancePastAny(scoped ReadOnlyUnmanagedSpan<T> values)
        {
            long start = Consumed;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool IsNext(scoped ReadOnlyUnmanagedSpan<T> next, bool advancePast = false)
        {
            ReadOnlyUnmanagedSpan<T> unread = UnreadSpan;
        ...
        private bool IsNextSlow(scoped ReadOnlyUnmanagedSpan<T> next, bool advancePast)
        {
            ReadOnlyUnmanagedSpan<T> currentSpan = UnreadSpan;
