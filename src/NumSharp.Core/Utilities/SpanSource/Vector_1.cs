...
namespace System.Numerics
{
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    public readonly unsafe struct Vector<T> : ISimdVector<Vector<T>, T>, IFormattable
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">The length of <paramref name="values" /> is less than <see cref="Vector{T}.Count" />.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector(ReadOnlyUnmanagedSpan<T> values)
        {
            // We explicitly don't check for `null` because historically this has thrown `NullReferenceException` for perf reasons
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector(ReadOnlyUnmanagedSpan<byte> values)
        {
            // We explicitly don't check for `null` because historically this has thrown `NullReferenceException` for perf reasons
        ...
        public Vector(UnmanagedSpan<T> values) : this((ReadOnlyUnmanagedSpan<T>)values)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void CopyTo(UnmanagedSpan<byte> destination)
        {
            ThrowHelper.ThrowForUnsupportedNumericsVectorBaseType<T>();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryCopyTo(UnmanagedSpan<byte> destination)
        {
            ThrowHelper.ThrowForUnsupportedNumericsVectorBaseType<T>();
        ...
        static void ISimdVector<Vector<T>, T>.CopyTo(Vector<T> vector, UnmanagedSpan<T> destination) => vector.CopyTo(destination);
        ...
        /// <inheritdoc cref="ISimdVector{TSelf, T}.Create(ReadOnlyUnmanagedSpan{T})" />
        static Vector<T> ISimdVector<Vector<T>, T>.Create(ReadOnlyUnmanagedSpan<T> values) => Vector.Create(values);
        ...
        static bool ISimdVector<Vector<T>, T>.TryCopyTo(Vector<T> vector, UnmanagedSpan<T> destination) => vector.TryCopyTo(destination);
