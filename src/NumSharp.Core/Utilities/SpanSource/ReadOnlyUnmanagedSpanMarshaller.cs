...
{
    /// <summary>
    /// Supports marshalling a <see cref="ReadOnlyUnmanagedSpan{T}"/> from managed value
    ...
    /// <remarks>
    /// A <see cref="ReadOnlyUnmanagedSpan{T}"/> marshalled with this marshaller will match the semantics of <see cref="MemoryMarshal.GetReference{T}(ReadOnlyUnmanagedSpan{T})"/>.
    ...
    /// </remarks>
    [CLSCompliant(false)]
    [CustomMarshaller(typeof(ReadOnlyUnmanagedSpan<>), MarshalMode.ManagedToUnmanagedIn, typeof(ReadOnlyUnmanagedSpanMarshaller<,>.ManagedToUnmanagedIn))]
    [CustomMarshaller(typeof(ReadOnlyUnmanagedSpan<>), MarshalMode.ManagedToUnmanagedOut, typeof(ReadOnlyUnmanagedSpanMarshaller<,>.ManagedToUnmanagedOut))]
    [CustomMarshaller(typeof(ReadOnlyUnmanagedSpan<>), MarshalMode.UnmanagedToManagedOut, typeof(ReadOnlyUnmanagedSpanMarshaller<,>.UnmanagedToManagedOut))]
    [ContiguousCollectionMarshaller]
    public static unsafe class ReadOnlyUnmanagedSpanMarshaller<T, TUnmanagedElement>
        where TUnmanagedElement : unmanaged
    {
        ...
        public static class UnmanagedToManagedOut
        {
            ...
            [RequiresUnsafe]
            public static TUnmanagedElement* AllocateContainerForUnmanagedElements(ReadOnlyUnmanagedSpan<T> managed, out int numElements)
            {
            ...
            public static ReadOnlyUnmanagedSpan<T> GetManagedValuesSource(ReadOnlyUnmanagedSpan<T> managed)
                => managed;
            ...
            [RequiresUnsafe]
            public static UnmanagedSpan<TUnmanagedElement> GetUnmanagedValuesDestination(TUnmanagedElement* unmanaged, int numElements)
            {
                if (unmanaged == null)
                    return [];

                return new UnmanagedSpan<TUnmanagedElement>(unmanaged, numElements);
            }
        }
        ...
        public ref struct ManagedToUnmanagedIn
        {
            ...
            private ReadOnlyUnmanagedSpan<T> _managedArray;
            private TUnmanagedElement* _allocatedMemory;
            private UnmanagedSpan<TUnmanagedElement> _span;

            /// <summary>
            /// Initializes the <see cref="ReadOnlyUnmanagedSpanMarshaller{T, TUnmanagedElement}.ManagedToUnmanagedIn"/> marshaller.
            /// </summary>
            ...
            /// </remarks>
            public void FromManaged(ReadOnlyUnmanagedSpan<T> managed, UnmanagedSpan<TUnmanagedElement> buffer)
            {
                ...
                else
                {
                    ...
                    _span = new UnmanagedSpan<TUnmanagedElement>(_allocatedMemory, managed.Length);
                }
            }
            ...
            public ReadOnlyUnmanagedSpan<T> GetManagedValuesSource() => _managedArray;
            ...
            public UnmanagedSpan<TUnmanagedElement> GetUnmanagedValuesDestination() => _span;
            ...
            public static ref T GetPinnableReference(ReadOnlyUnmanagedSpan<T> managed)
            {
        ...
        public struct ManagedToUnmanagedOut
        {
            ...
            /// <summary>
            /// Initializes the <see cref="ReadOnlyUnmanagedSpanMarshaller{T, TUnmanagedElement}.ManagedToUnmanagedOut"/> marshaller.
            /// </summary>
            ...
            /// </summary>
            /// <returns>A span over managed values of the array.</returns>
            public ReadOnlyUnmanagedSpan<T> ToManaged()
            {
                return new ReadOnlyUnmanagedSpan<T>(_managedValues!);
            }
            ...
            public ReadOnlyUnmanagedSpan<TUnmanagedElement> GetUnmanagedValuesSource(int numElements)
            {
                if (_unmanagedArray is null)
                    return [];

                return new ReadOnlyUnmanagedSpan<TUnmanagedElement>(_unmanagedArray, numElements);
            }
            ...
            public UnmanagedSpan<T> GetManagedValuesDestination(int numElements)
            {
