...
namespace System
{
    internal static partial class Marvin
    {
        ...
        public static int ComputeHash32(ReadOnlyUnmanagedSpan<byte> data, ulong seed) => ComputeHash32(ref MemoryMarshal.GetReference(data), (uint)data.Length, (uint)seed, (uint)(seed >> 32));
