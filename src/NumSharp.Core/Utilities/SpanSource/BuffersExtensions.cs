...
namespace System.Buffers
{
    ...
    public static class BuffersExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void CopyTo<T>(in this ReadOnlySequence<T> source, UnmanagedSpan<T> destination)
        {
            if (source.IsSingleSegment)
            {
                ReadOnlyUnmanagedSpan<T> span = source.First.Span;
        ...
        private static void CopyToMultiSegment<T>(in ReadOnlySequence<T> sequence, UnmanagedSpan<T> destination)
        {
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Write<T>(this IBufferWriter<T> writer, ReadOnlyUnmanagedSpan<T> value)
        {
            UnmanagedSpan<T> destination = writer.GetSpan();
        ...
        private static void WriteMultiSegment<T>(IBufferWriter<T> writer, in ReadOnlyUnmanagedSpan<T> source, UnmanagedSpan<T> destination)
        {
            ReadOnlyUnmanagedSpan<T> input = source;
            while (true)
            {
