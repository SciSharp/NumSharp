...
namespace NumSharp.Backends.Unmanaged
{
        ...
        %
#else
        public class UnmanagedBooleanStorage : UnmanagedByteStorage<bool> {
            /// <inheritdoc />
            public UnmanagedBooleanStorage(Shape shape) : base(shape) { }
            /// <inheritdoc />
            public UnmanagedBooleanStorage(Shape shape, bool fill) : base(shape, fill) { }
            /// <inheritdoc />
            public UnmanagedBooleanStorage(bool scalar) : base(scalar) { }
            /// <inheritdoc />
            public UnmanagedBooleanStorage(bool[] arr, Shape shape) : base(arr, shape) { }
            /// <inheritdoc />
            public UnmanagedBooleanStorage(ArraySlice<bool> arr, Shape shape) : base(arr, shape) { }
            /// <inheritdoc />
            public UnmanagedBooleanStorage(UnmanagedMemoryBlock<bool> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
            public unsafe UnmanagedBooleanStorage(bool* ptr, int lengthInSizeOfT, Shape shape, Action dispose) : base(ptr, lengthInSizeOfT, shape, dispose) { }
        }
        ...
        public class UnmanagedByteStorage : UnmanagedByteStorage<byte> {
            ...
            /// <inheritdoc />
            public UnmanagedByteStorage(UnmanagedMemoryBlock<byte> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedInt16Storage : UnmanagedByteStorage<short> {
            ...
            /// <inheritdoc />
            public UnmanagedInt16Storage(UnmanagedMemoryBlock<short> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedUInt16Storage : UnmanagedByteStorage<ushort> {
            ...
            /// <inheritdoc />
            public UnmanagedUInt16Storage(UnmanagedMemoryBlock<ushort> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedInt32Storage : UnmanagedByteStorage<int> {
            ...
            /// <inheritdoc />
            public UnmanagedInt32Storage(UnmanagedMemoryBlock<int> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedUInt32Storage : UnmanagedByteStorage<uint> {
            ...
            /// <inheritdoc />
            public UnmanagedUInt32Storage(UnmanagedMemoryBlock<uint> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedInt64Storage : UnmanagedByteStorage<long> {
            ...
            /// <inheritdoc />
            public UnmanagedInt64Storage(UnmanagedMemoryBlock<long> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedUInt64Storage : UnmanagedByteStorage<ulong> {
            ...
            /// <inheritdoc />
            public UnmanagedUInt64Storage(UnmanagedMemoryBlock<ulong> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedCharStorage : UnmanagedByteStorage<char> {
            ...
            /// <inheritdoc />
            public UnmanagedCharStorage(UnmanagedMemoryBlock<char> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedDoubleStorage : UnmanagedByteStorage<double> {
            ...
            /// <inheritdoc />
            public UnmanagedDoubleStorage(UnmanagedMemoryBlock<double> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedSingleStorage : UnmanagedByteStorage<float> {
            ...
            /// <inheritdoc />
            public UnmanagedSingleStorage(UnmanagedMemoryBlock<float> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
        ...
        public class UnmanagedDecimalStorage : UnmanagedByteStorage<decimal> {
            ...
            /// <inheritdoc />
            public UnmanagedDecimalStorage(UnmanagedMemoryBlock<decimal> array, Shape shape) : base(array, shape) { }
            /// <inheritdoc />
