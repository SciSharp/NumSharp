...
namespace NumSharp.Backends.Kernels
{
    ...
    public static class SimdReductionOptimized
    {
        ...
        public static unsafe double SumDouble_Optimized(double* data, int size)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe double SumDouble_Baseline(double* data, int size)
        {
            if (size == 0) return 0.0;
            if (size == 1) return data[0];
        ...
        private static unsafe double SumDouble_Scalar(double* data, int size)
        {
            double sum = 0;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe float SumFloat_Optimized(float* data, int size)
        {
            if (size == 0) return 0f;
            if (size == 1) return data[0];
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe float SumFloat_Baseline(float* data, int size)
        {
            if (size == 0) return 0f;
            if (size == 1) return data[0];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe float SumFloat_Scalar(float* data, int size)
        {
            float sum = 0;
            for (int i = 0; i < size; i++)
                sum += data[i];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe long SumInt64_Optimized(long* data, int size)
        {
            if (size == 0) return 0L;
            if (size == 1) return data[0];
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe long SumInt64_Baseline(long* data, int size)
        {
            if (size == 0) return 0L;
            if (size == 1) return data[0];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe long SumInt64_Scalar(long* data, int size)
        {
            long sum = 0;
            for (int i = 0; i < size; i++)
                sum += data[i];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe double SumDouble_8x(double* data, int size)
        {
            if (size == 0) return 0.0;
            if (size == 1) return data[0];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe double MaxDouble_Optimized(double* data, int size)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe double MaxDouble_Baseline(double* data, int size)
        {
            if (size == 0) return double.NegativeInfinity;
            if (size == 1) return data[0];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe double MaxDouble_Scalar(double* data, int size)
        {
