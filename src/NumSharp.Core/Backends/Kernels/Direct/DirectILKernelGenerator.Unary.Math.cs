...
// =============================================================================
// DirectILKernelGenerator.Unary.Math.cs - Math Function IL Emission
// =============================================================================
//
// RESPONSIBILITY:
        ...
        private static void EmitAbsCall(ILGenerator il, NPTypeCode type)
        {
            switch (type)
            {
                ...
                case NPTypeCode.Complex:
                    ...
                    // since DirectILKernelGenerator unary ops preserve type. The type change should be handled at higher level.
                    {
