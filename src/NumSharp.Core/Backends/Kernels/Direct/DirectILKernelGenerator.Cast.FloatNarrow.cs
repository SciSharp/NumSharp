...
namespace NumSharp.Backends.Kernels
{
    public static partial class DirectILKernelGenerator
    {
        ...
        //   Float/double -> NARROW int (i8/u8/i16/u16/char) contiguous casts.
        //
        ...
        //   strategy (a per-element EmitConvertTo loop), while NumPy vectorizes
        //   with cvtt + pack.
        //
        ...
        //     matches unchecked((narrow)int) exactly, including wrap.
        //
