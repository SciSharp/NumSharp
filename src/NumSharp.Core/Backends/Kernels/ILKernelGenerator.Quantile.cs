...
// =============================================================================
// ILKernelGenerator.Quantile — quantile / percentile / median IL kernel
// =============================================================================
//
// Why this exists:
...
//       1. "No per-dtype switch — emit IL via ILKernelGenerator."
...
//   This mirrors how `ILKernelGenerator.Scan` and `ILKernelGenerator.Reduction
...
namespace NumSharp.Backends.Kernels
{
    public static partial class ILKernelGenerator
    {
        ...
        private static QuantileKernel EmitQuantileKernel(QuantileKey key)
        {
            ...
            var helper = typeof(ILKernelGenerator)
