...
{
    /// <summary>
    /// Type casting utilities for NDIter.
    /// Validates casting rules and performs type conversions.
    /// </summary>
    public static unsafe class NDIterCasting
    {
        /// <summary>
        ...
        {
            NDArrayMethodFlags combinedFlags = NDArrayMethodFlags.None;
            bool anyCast = false;
            ...
            for (int op = 0; op < state.NOp; op++)
            {
                ...
                else
                {
                    ...
                    combinedFlags |= NDArrayMethodFlags.SUPPORTS_UNALIGNED |
                                     NDArrayMethodFlags.NO_FLOATINGPOINT_ERRORS |
                                     NDArrayMethodFlags.IS_REORDERABLE;
                }
            }
            ...
            {
                uint packed = ((uint)combinedFlags & 0xFFu) << NDIterConstants.TRANSFERFLAGS_SHIFT;
                state.ItFlags = (state.ItFlags & ~NDIterConstants.TRANSFERFLAGS_MASK) | packed;
            }
        }

        /// <summary>
        /// Compute the NDArrayMethodFlags that characterize a single cast transfer.
        /// In .NET:
        ...
        /// </summary>
        private static NDArrayMethodFlags ComputeCastTransferFlags(NPTypeCode srcType, NPTypeCode dstType)
        {
            var flags = NDArrayMethodFlags.SUPPORTS_UNALIGNED |
                        NDArrayMethodFlags.NO_FLOATINGPOINT_ERRORS |
                        NDArrayMethodFlags.IS_REORDERABLE;
            return flags;
        }
