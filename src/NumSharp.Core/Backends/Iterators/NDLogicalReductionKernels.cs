...
namespace NumSharp.Backends.Iteration
{
    ...
    //
    // Drives NDIterRef.ExecuteReducing to accumulate a long count of elements
    ...
    public readonly struct CountNonZeroKernel<T> : INDReducingInnerLoop<long>
        where T : unmanaged
    {
    ...
    public interface INDBooleanReductionKernel<T>
        where T : unmanaged
    {
    ...
    public readonly struct NDAllKernel<T> : INDBooleanReductionKernel<T>
        where T : unmanaged
    {
    ...
    public readonly struct NDAnyKernel<T> : INDBooleanReductionKernel<T>
        where T : unmanaged
    {
    ...
    /// Used by NDAxisIter for sum, prod, min, max along an axis.
    /// </summary>
    public unsafe interface INDAxisNumericReductionKernel<T>
        where T : unmanaged
    {
        /// <summary>
    ...
    public readonly struct NDSumAxisKernel<T> : INDAxisNumericReductionKernel<T>
    ...
    public readonly struct NDProdAxisKernel<T> : INDAxisNumericReductionKernel<T>
    ...
    public readonly struct NDMaxAxisKernel<T> : INDAxisNumericReductionKernel<T>
    ...
    public readonly struct NDMinAxisKernel<T> : INDAxisNumericReductionKernel<T>
        where T : unmanaged, IComparisonOperators<T, T, bool>, IMinMaxValue<T>
    {
        public static unsafe T Execute(T* src, long srcStride, long length)
        {
