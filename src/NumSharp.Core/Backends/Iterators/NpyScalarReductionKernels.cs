...
namespace NumSharp.Backends.Iteration
{
    ...
    //
    // These struct kernels implement INpyReducingInnerLoop<TAccum> and drive the
    ...
    //
    // Layout-aware: NpyIter (EXTERNAL_LOOP) hands the kernel per-inner-loop byte
    ...
    //     (the cache-friendly default of NpyIterRef.New). For Complex min/max
    ...
    public readonly struct HalfSumKernel : INpyReducingInnerLoop<double>
    {
    ...
    public readonly struct HalfProdKernel : INpyReducingInnerLoop<double>
    {
    ...
    /// reductions).
    /// </summary>
    public readonly struct ComplexSumKernel : INpyReducingInnerLoop<Complex>
    {
    ...
    /// </summary>
    public readonly struct ComplexProdKernel : INpyReducingInnerLoop<Complex>
    {
    ...
    /// </summary>
    public readonly struct HalfMaxKernel : INpyReducingInnerLoop<HalfMinMaxAccumulator>
    {
    ...
    /// </summary>
    public readonly struct HalfMinKernel : INpyReducingInnerLoop<HalfMinMaxAccumulator>
    {
        public unsafe bool Execute(void** dataptrs, long* strides, long count, ref HalfMinMaxAccumulator a)
        {
            byte* p = (byte*)dataptrs[0];
    ...
    /// </summary>
    public readonly struct ComplexMaxKernel : INpyReducingInnerLoop<ComplexMinMaxAccumulator>
    {
    ...
    public readonly struct ComplexMinKernel : INpyReducingInnerLoop<ComplexMinMaxAccumulator>
    {
        public unsafe bool Execute(void** dataptrs, long* strides, long count, ref ComplexMinMaxAccumulator a)
        {
            byte* p = (byte*)dataptrs[0];
    ...
    public readonly struct HalfArgMaxKernel : INpyReducingInnerLoop<HalfArgAccumulator>
    {
    ...
    public readonly struct HalfArgMinKernel : INpyReducingInnerLoop<HalfArgAccumulator>
    {
        public unsafe bool Execute(void** dataptrs, long* strides, long count, ref HalfArgAccumulator a)
        {
            byte* p = (byte*)dataptrs[0];
    ...
    public readonly struct ComplexArgMaxKernel : INpyReducingInnerLoop<ComplexArgAccumulator>
    {
    ...
    public readonly struct ComplexArgMinKernel : INpyReducingInnerLoop<ComplexArgAccumulator>
    {
        public unsafe bool Execute(void** dataptrs, long* strides, long count, ref ComplexArgAccumulator a)
        {
            byte* p = (byte*)dataptrs[0];
    ...
    public readonly struct HalfAnyKernel : INpyReducingInnerLoop<bool>
    {
    ...
    public readonly struct ComplexAnyKernel : INpyReducingInnerLoop<bool>
    {
        public unsafe bool Execute(void** dataptrs, long* strides, long count, ref bool found)
        {
            byte* p = (byte*)dataptrs[0];
    ...
    public readonly struct HalfAllKernel : INpyReducingInnerLoop<bool>
    {
    ...
    public readonly struct ComplexAllKernel : INpyReducingInnerLoop<bool>
    {
        public unsafe bool Execute(void** dataptrs, long* strides, long count, ref bool allTrue)
        {
            byte* p = (byte*)dataptrs[0];
