...
namespace NumSharp.Backends.Iteration
{
    ...
    public enum NDIterFlags : uint
    {
        ...
        // =========================================================================
        // Legacy flags (bits 0-7, backward compatibility with existing NDIter)
        ...
        // (INDBooleanReductionKernel.ShouldExit / SupportsEarlyExit), not
    ...
    ///
    /// Packed into the top 8 bits of <see cref="NDIterState.ItFlags"/> at offset
    /// <see cref="NDIterConstants.TRANSFERFLAGS_SHIFT"/> (=24). Retrieved via
    /// <see cref="NDIterRef.GetTransferFlags"/> — the preferred way to check whether
    ...
    {
        /// <summary>
        /// Shift amount into <see cref="NDIterState.ItFlags"/> where transfer flags are packed.
        ...
        /// <see cref="NDIterUtils.ReductionAxis(int)"/>.
        /// </summary>
    ...
    public static class NDIterUtils
    {
        ...
        ///
        /// Use in the <c>opAxes</c> parameter of <see cref="NDIterRef.AdvancedNew"/>
        ...
        {
            return axis + NDIterConstants.REDUCTION_AXIS_OFFSET;
        }
        ...
        {
            isReduction = axis >= NDIterConstants.REDUCTION_AXIS_OFFSET - 1;
            if (isReduction)
                return axis - NDIterConstants.REDUCTION_AXIS_OFFSET;
            return axis;
        }
    ...
    /// <summary>
    /// Bit masks that partition the NDIter flag space into global (bits 0-15)
    ...
    {
        /// <summary>Mask covering NDIterGlobalFlags bits. (NPY_ITER_GLOBAL_FLAGS)</summary>
        public const uint NPY_ITER_GLOBAL_FLAGS = 0x0000ffff;

        /// <summary>Mask covering NDIterPerOpFlags bits. (NPY_ITER_PER_OP_FLAGS)</summary>
