...
// =============================================================================
// NDIter.Reduce.cs — reusable 2-operand REDUCE iterator builder
// =============================================================================
//
// RATIONALE
// ---------
...
namespace NumSharp.Backends.Iteration
{
    public unsafe ref partial struct NDIterRef
    {
        ...
        public static NDIterRef NewReduce(
            NDArray input, NDArray output, int axis,
            NDIterGlobalFlags extraFlags = NDIterGlobalFlags.None)
        {
        ...
        /// <summary>
        /// Multi-axis variant of <see cref="NewReduce(NDArray, NDArray, int, NDIterGlobalFlags)"/>.
        ...
        /// </summary>
        private static NDIterRef BuildStrideOrdered(
            NDArray input, NDArray output, int ndim, bool[] reduced, NDIterGlobalFlags extraFlags)
        {
            ...
            return AdvancedNew(
                2,
                new[] { input, output },
                NDIterGlobalFlags.REDUCE_OK | NDIterGlobalFlags.EXTERNAL_LOOP | extraFlags,
