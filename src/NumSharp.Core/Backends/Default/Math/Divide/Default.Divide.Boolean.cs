                    ...
                    switch (ret_type)
                    {
	                    ...
	                    case NPTypeCode.Byte:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToByte(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToByte(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToByte(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Int16:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt16(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt16(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt16(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.UInt16:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt16(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt16(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt16(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Int32:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt32(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt32(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt32(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.UInt32:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt32(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt32(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt32(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Int64:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt64(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt64(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToInt64(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.UInt64:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt64(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt64(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToUInt64(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Char:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToChar(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToChar(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToChar(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Double:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToDouble(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToDouble(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToDouble(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Single:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToSingle(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToSingle(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToSingle(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Decimal:
	                    {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToDecimal(Operator.Divide((*(lhs_address + leftOffset++)), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            } else if (!leftLinear && rightLinear) {
                                int rightOffset = 0;
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToDecimal(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + rightOffset++))));
                                } while (incr.Next() != null);
                            } else {
                                int retOffset = 0;
                                var incr = new NDCoordinatesIncrementor(ref retShape);
                                int[] current = incr.Index;
                                do {
                                    *(ret_address + retOffset++) = Converts.ToDecimal(Operator.Divide((*(lhs_address + BroadcastedLeftShape.GetOffset(current))), (*(rhs_address + BroadcastedRightShape.GetOffset(current)))));
                                } while (incr.Next() != null);
                            }
