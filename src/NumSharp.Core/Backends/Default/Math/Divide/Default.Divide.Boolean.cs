                    ...
                    switch (ret_type) {
	                    ...
	                    case NPTypeCode.Byte: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToByte(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToByte(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToByte(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToByte(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToByte(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToByte(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Int16: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt16(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt16(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt16(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToInt16(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToInt16(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToInt16(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.UInt16: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt16(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt16(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt16(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToUInt16(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToUInt16(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToUInt16(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Int32: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt32(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt32(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt32(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToInt32(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToInt32(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToInt32(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.UInt32: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt32(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt32(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt32(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToUInt32(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToUInt32(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToUInt32(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Int64: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt64(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt64(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToInt64(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToInt64(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToInt64(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToInt64(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.UInt64: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt64(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt64(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToUInt64(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToUInt64(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToUInt64(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToUInt64(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Char: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToChar(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToChar(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToChar(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToChar(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToChar(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToChar(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Double: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToDouble(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToDouble(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToDouble(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToDouble(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToDouble(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToDouble(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Single: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToSingle(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToSingle(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToSingle(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToSingle(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToSingle(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToSingle(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
	                    ...
	                    case NPTypeCode.Decimal: {
                            ...
                            if (leftLinear && rightLinear) {
                                ...
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var rval = *rhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToDecimal(Operator.Divide((lhs_address[i]), rval));
                                } else if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    var lval = *lhs_address;
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToDecimal(Operator.Divide(lval, (rhs_address[i])));
                                } else {
                                    for (int i = 0; i < len; i++) ret_address[i] = Converts.ToDecimal(Operator.Divide((lhs_address[i]), (rhs_address[i])));
                                }
                            ...
                            if (leftLinear) { // && !rightLinear
                                if (rightshape.IsBroadcasted && rightshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToDecimal(Operator.Divide((lhs_address[leftOffset++]), (rhs_address[rightshape.GetOffset(current)])));
                                    } while (incr.Next() != null);
                                }
                            } else if (rightLinear) { // !leftLinear && 
                                if (leftshape.IsBroadcasted && leftshape.BroadcastInfo.OriginalShape.IsScalar) {
                                    ...
                                    int[] current = incr.Index;
                                    do {
                                        ret_address[retOffset++] = Converts.ToDecimal(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightOffset++])));
                                    } while (incr.Next() != null);
                                }
                            } else {
                                int retOffset = 0;
                                ...
                                int[] current = incr.Index;
                                do {
                                    ret_address[retOffset++] = Converts.ToDecimal(Operator.Divide((lhs_address[leftshape.GetOffset(current)]), (rhs_address[rightshape.GetOffset(current)])));
                                } while (incr.Next() != null);
                            }
