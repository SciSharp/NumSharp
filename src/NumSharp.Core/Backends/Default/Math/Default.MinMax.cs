...
namespace NumSharp.Backends
{
    public partial class DefaultEngine
    {
        ...
        public override NDArray Maximum(NDArray lhs, NDArray rhs, Type dtype = null, NDArray @out = null, NDArray where = null)
        {
        ...
        public override NDArray Minimum(NDArray lhs, NDArray rhs, Type dtype = null, NDArray @out = null, NDArray where = null)
        {
        ...
        public override NDArray FMax(NDArray lhs, NDArray rhs, Type dtype = null, NDArray @out = null, NDArray where = null)
        {
        ...
        public override NDArray FMin(NDArray lhs, NDArray rhs, Type dtype = null, NDArray @out = null, NDArray where = null)
        {
