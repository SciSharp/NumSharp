...
namespace NumSharp.Backends
{
    public partial class DefaultEngine
    {
        ...
        // ILKernelGenerator.Clip as a DynamicMethod and cached per
        ...
        public override unsafe NDArray ClipNDArray(NDArray lhs, NDArray min, NDArray max, NPTypeCode? typeCode = null, NDArray @out = null)
        {
            ...
            // ---- Decide bound kinds and route through ILKernelGenerator
            ...
            ILKernelGenerator.ClipMode mode =
                min is null ? ILKernelGenerator.ClipMode.MaxOnly :
                max is null ? ILKernelGenerator.ClipMode.MinOnly :
                              ILKernelGenerator.ClipMode.BothBounds;
            ILKernelGenerator.ClipBoundsKind kind =
                allScalarBounds ? ILKernelGenerator.ClipBoundsKind.Scalar
                                : ILKernelGenerator.ClipBoundsKind.Array;
            ...
            if (kind == ILKernelGenerator.ClipBoundsKind.Scalar)
            {
            ...
            ILKernelGenerator.Clip(outType, mode, kind, srcPtr, dstPtr, dst.size, loPtr, hiPtr);
