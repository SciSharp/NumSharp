...
namespace NumSharp.Backends
{
    public abstract partial class DefaultEngine
    {
       public virtual NDArray Sub(NDArray np1, NDArray np2)
       {
            ...
            Array np1SysArr = np1.Array;
            Array np2SysArr = np2.Array;
                ...
                case System.Int32[] resArr:
                    {
                        ...
                        np1Array = (np1Array == null) ? np1.CloneData<System.Int32>() : np1Array;
                        np2Array = (np2Array == null) ? np2.CloneData<System.Int32>() : np2Array;
                        ...
                        {
                            System.Int32 scalar = np1.CloneData<System.Int32>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = scalar - np2Array[idx];
                        }
                        else if (scalarNo == 2)
                        {
                            System.Int32 scalar = np2.CloneData<System.Int32>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                ...
                case System.Int64[] resArr:
                    {
                        ...
                        np1Array = (np1Array == null) ? np1.CloneData<System.Int64>() : np1Array;
                        np2Array = (np2Array == null) ? np2.CloneData<System.Int64>() : np2Array;
                        ...
                        {
                            System.Int64 scalar = np1.CloneData<System.Int64>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = scalar - np2Array[idx];
                        }
                        else if (scalarNo == 2)
                        {
                            System.Int64 scalar = np2.CloneData<System.Int64>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = np1Array[idx] - scalar;
                        }
                        break;
                ...
                case System.Single[] resArr:
                    {
                        ...
                        np1Array = (np1Array == null) ? np1.CloneData<System.Single>() : np1Array;
                        np2Array = (np2Array == null) ? np2.CloneData<System.Single>() : np2Array;
                        ...
                        {
                            System.Single scalar = np1.CloneData<System.Single>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = scalar - np2Array[idx];
                        }
                        else if (scalarNo == 2)
                        {
                            System.Single scalar = np2.CloneData<System.Single>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = np1Array[idx] - scalar;
                        }
                        break;
                ...
                case System.Double[] resArr:
                    {
                        ...
                        np1Array = (np1Array == null) ? np1.CloneData<System.Double>() : np1Array;
                        np2Array = (np2Array == null) ? np2.CloneData<System.Double>() : np2Array;
                        ...
                        {
                            System.Double scalar = np1.CloneData<System.Double>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = scalar - np2Array[idx];
                        }
                        else if (scalarNo == 2)
                        {
                            System.Double scalar = np2.CloneData<System.Double>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = np1Array[idx] - scalar;
                        }
                        break;
                ...
                case System.Numerics.Complex[] resArr:
                    {
                        ...
                        np1Array = (np1Array == null) ? np1.CloneData<System.Numerics.Complex>() : np1Array;
                        np2Array = (np2Array == null) ? np2.CloneData<System.Numerics.Complex>() : np2Array;
                        ...
                        {
                            System.Numerics.Complex scalar = np1.CloneData<System.Numerics.Complex>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = scalar - np2Array[idx];
                        }
                        else if (scalarNo == 2)
                        {
                            System.Numerics.Complex scalar = np2.CloneData<System.Numerics.Complex>()[0];
                            for (int idx = 0; idx < np3SysArr.Length; idx++)
                                resArr[idx] = np1Array[idx] - scalar;
                        }
                        break;
