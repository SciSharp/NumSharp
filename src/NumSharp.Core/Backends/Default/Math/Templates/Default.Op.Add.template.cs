                ...
                case NPTypeCode.Boolean:
                {
                    ...
                    switch (ret_type)
                    {
	                    case NPTypeCode.Boolean:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetOffset(current)) = (*(lhs_address + BroadcastedLeftShape.GetOffset(current)) != 0) %(op_bool) *(rhs_address + BroadcastedRightShape.GetOffset(current));
