#if _REGEN_TEMPLATE
%template "../Subtract/Default.Subtract.#1.cs" for every except(supported_currently_supported, "Boolean"), except(supported_currently_supported_lowercase, "bool")
#endif
...
namespace NumSharp.Backends
{
    public partial class DefaultEngine
    {
        ...
        public unsafe NDArray Subtract__1__(in NDArray lhs, in NDArray rhs)
        {
            ...
            switch (rhs.GetTypeCode)
            {
                ...
                case NPTypeCode.Boolean:
                {
                    ...
                    switch (ret_type)
                    {
	                    ...
	                    case NPTypeCode.Byte:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToByte(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Int16:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToInt16(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.UInt16:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToUInt16(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Int32:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToInt32(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.UInt32:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToUInt32(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Int64:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToInt64(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.UInt64:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToUInt64(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Char:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToChar(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Double:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToDouble(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Single:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToSingle(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Decimal:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToDecimal(((__2__)*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current))) - (*(rhs_address + BroadcastedRightShape.GetIndexInShape(current)) ? (__2__) 1 : (__2__) 0));
                            } while (incr.Next() != null);
                ...
                case NPTypeCode.Byte:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((byte*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                    ...
                    switch (ret_type)
                    {
	                    case NPTypeCode.Boolean:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = 0 != (*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Byte:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToByte(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Int16:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToInt16(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.UInt16:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToUInt16(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Int32:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToInt32(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.UInt32:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToUInt32(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Int64:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToInt64(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.UInt64:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToUInt64(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Char:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToChar(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Double:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToDouble(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Single:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToSingle(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
	                    ...
	                    case NPTypeCode.Decimal:
	                    {
                            ...
                            do
                            {
                                *(ret_address + retShape.GetIndexInShape(current)) = Convert.ToDecimal(*(lhs_address + BroadcastedLeftShape.GetIndexInShape(current)) - (__2__) *(rhs_address + BroadcastedRightShape.GetIndexInShape(current)));
                            } while (incr.Next() != null);
                ...
                case NPTypeCode.Int16:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((short*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.UInt16:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((ushort*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.Int32:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((int*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.UInt32:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((uint*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.Int64:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((long*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.UInt64:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((ulong*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.Char:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((char*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.Double:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((double*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.Single:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((float*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
                ...
                case NPTypeCode.Decimal:
                {
                    ...
                    if (lhs.Shape.IsScalar && rhs.Shape.IsScalar)
                    {
                        return NDArray.Scalar(Convert.ChangeType(*((__2__*)lhs.Address) - *((decimal*)rhs.Address), (TypeCode)ret_type));
                    }
                    (Shape BroadcastedLeftShape, Shape BroadcastedRightShape) = DefaultEngine.Broadcast(lhs.Shape, rhs.Shape);
                    var lhs_address = (__2__*)lhs.Address;
