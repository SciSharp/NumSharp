...
namespace NumSharp.Shared
{
   ...
   {
        //start 1 
        internal static Quaternion[] MatrixMultiplyQuaternionMatrix(Quaternion[]np1, Quaternion[]np2, int[] dimNp1, int[] dimNp2)
        {
            var result = new Quaternion[dimNp1[0] * dimNp2[1]];
