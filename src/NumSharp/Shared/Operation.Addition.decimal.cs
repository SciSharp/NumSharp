...
namespace NumSharp.Shared
{
   internal static partial class Addition
   {
        ...
        //end 2
        //start 3 
        internal static decimal[][] AdddecimalMatrixTodecimalMatrix(decimal[][] np1, decimal[][]np2)
        {
            return np1.Select((x,idx) => x.Select((y,jdx) => y + np2[idx][jdx] ).ToArray()).ToArray();
        }
        //end 3
        //start 4
        internal static decimal[][] AdddecimalTodecimalMatrix(decimal[][] np1, decimal np2)
        {
