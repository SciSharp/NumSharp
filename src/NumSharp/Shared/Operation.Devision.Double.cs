...
namespace NumSharp.Shared
{
   internal static partial class Devision
   {
        ...
        //end 2
        //start 3 
        internal static double[][] DevideDoubleMatrixWithDoubleMatrix(double[][] np1, double[][]np2)
        {
            return np1.Select((x,idx) => x.Select((y,jdx) => y / np2[idx][jdx] ).ToArray()).ToArray();
        }
        //end 3
        //start 4
        internal static double[][] DevideDoubleWithDoubleMatrix(double[][] np1, double np2)
        {
