...
namespace NumSharp.Shared
{
   ...
   {
        //start 1 
        internal static Int64[][] MatrixMultiplyInt64Matrix(Int64[][] np1, Int64[][]np2)
        {
            ...
            var result = new Int64[numOfLines][];
            result = result.Select(x => new Int64[numOfColumns]).ToArray();
