...
- **`references/CHANGELOG_STYLE.md`** owns the **FORMAT** - the section taxonomy, the one-line
...
- `references/CHANGELOG_STYLE.md` - **the format authority.** Section taxonomy, bullet shape, API
