...
| Reduction iteration | Double-loop with reduce_pos | Not implemented |
| Type casting | Via NPY_cast_info | Not implemented |
| Error handling | Python exceptions | C# exceptions |

---

## 11. Implementation Status (Updated 2026-04-15)
