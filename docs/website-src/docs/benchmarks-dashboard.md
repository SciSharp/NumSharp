...
sorting      █████ ..............   0.50×   199%🕐  (  10 win /  14 lose)  ◄ SLOWER
linearalgebra████ ...............   0.41×   246%🕐  (   2 win /   6 lose)  ◄ SLOWER
...
int64        ██████▏ ............   0.62×   160%🕐  (  30 win /  68 lose)  ◄ SLOWER
bool         ██▊ ................   0.28×   355%🕐  (   0 win /   8 lose)  ◄ SLOWER
...
TOP 12 FASTEST  (NumPy ÷ NumSharp — biggest NumSharp wins)
  ...
  np.nansum(a) (float64)         float64  100K     0.242 →    0.019 ms   12.63×     8%🕐
  np.percentile(a, 50) (float64) float64    1K     0.025 →    0.002 ms   10.65×     9%🕐
  np.percentile(a, 50) (float32) float32    1K     0.025 →    0.002 ms   10.33×    10%🕐
  np.average(a) (float32)        float32   10M     9.598 →    0.937 ms   10.24×    10%🕐
  np.quantile(a, 0.5) (float64)  float64    1K     0.023 →    0.002 ms   10.09×    10%🕐
  np.quantile(a, 0.5) (float32)  float32    1K     0.024 →    0.002 ms   10.00×    10%🕐
  np.nanprod(a) (float32)        float32   10M    18.515 →    1.904 ms    9.72×    10%🕐
  np.nansum(a) (float32)         float32   10M    14.349 →    1.488 ms    9.64×    10%🕐
  np.nanprod(a) (float64)        float64  100K     0.287 →    0.032 ms    8.99×    11%🕐
  np.average(a) (float32)        float32  100K     0.018 →    0.002 ms    8.43×    12%🕐
  np.count_nonzero(a) (float32)  float32  100K     0.038 →    0.005 ms    8.24×    12%🕐
  np.nanstd(a) (float32)         float32    1K     0.020 →    0.003 ms    8.12×    12%🕐
