...
namespace NumSharp.UnitTest.Logic
{
    ...
    public class np_comparison_Test
    {
        ...
        public void equal_ArrayArray()
        {
            ...
            CollectionAssert.AreEqual(new long[] { 3 }, result.shape);
        ...
        public void comparison_Broadcasting2D()
        {
            ...
            CollectionAssert.AreEqual(new long[] { 2, 2 }, result.shape);
        ...
        public void less_Broadcasting()
        {
            ...
            CollectionAssert.AreEqual(new long[] { 3, 3 }, result.shape);
