...
{
    /// <summary>
    /// Battletest suite for NDIter_GetInnerFixedStrideArray (nditer_api.c:1357).
    ///
    /// Semantics:
    /// - Buffered: returns <see cref="NDIterState.BufStrides"/> (per-operand buffer strides).
    /// - Non-buffered: returns the innermost-axis stride per operand.
    ///
    /// Stride values verified against NumPy 2.4.2.
    /// </summary>
    [TestClass]
    public class NDIterInnerFixedStrideArrayTests
    {
        [TestMethod]
