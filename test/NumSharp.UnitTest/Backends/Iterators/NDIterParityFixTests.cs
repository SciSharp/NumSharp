...
namespace NumSharp.UnitTest.Backends.Iterators
{
    ...
    /// </summary>
    [TestClass]
    public class NDIterParityFixTests
    {
        // =====================================================================
        ...
        public void NegStride_1D_Reversed_COrder_IteratesLogical()
        {
            ...
            using var it = NDIterRef.New(arr, order: NPY_ORDER.NPY_CORDER);
        ...
        public void NegStride_1D_Reversed_FOrder_IteratesLogical()
        {
            ...
            using var it = NDIterRef.New(arr, order: NPY_ORDER.NPY_FORTRANORDER);
            var values = new List<int>();
            do { values.Add(it.GetValue<int>(0)); } while (it.Iternext());
        ...
        public void NegStride_1D_Reversed_AOrder_IteratesLogical()
        {
            ...
            using var it = NDIterRef.New(arr, order: NPY_ORDER.NPY_ANYORDER);
            var values = new List<int>();
            do { values.Add(it.GetValue<int>(0)); } while (it.Iternext());
        ...
        public void NegStride_1D_Reversed_KOrder_IteratesMemory()
        {
            ...
            using var it = NDIterRef.New(arr, order: NPY_ORDER.NPY_KEEPORDER);
            var values = new List<int>();
            do { values.Add(it.GetValue<int>(0)); } while (it.Iternext());
        ...
        public void NoBroadcast_ShapeMismatch_Throws()
        {
            ...
            using var it = NDIterRef.MultiNew(
                ...
                new[] {
                    NDIterPerOpFlags.READONLY | NDIterPerOpFlags.NO_BROADCAST,
        ...
        public void FIndex_2D_ReturnsFOrderIndices()
        {
            ...
            using var it = NDIterRef.New(arr, NDIterGlobalFlags.F_INDEX);
        ...
        public void CIndex_2D_ReturnsCOrderIndices()
        {
            ...
            using var it = NDIterRef.New(arr, NDIterGlobalFlags.C_INDEX);
            var indices = new List<long>();
            do { indices.Add(it.GetIndex()); } while (it.Iternext());
        ...
        public void OpAxes_Reduce_Axis0_2D_To_1D()
        {
            ...
            using var it = NDIterRef.AdvancedNew(
                2, ops, NDIterGlobalFlags.REDUCE_OK,
