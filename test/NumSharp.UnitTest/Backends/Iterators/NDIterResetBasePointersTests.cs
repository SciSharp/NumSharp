...
{
    /// <summary>
    /// Battletest suite for NDIter_ResetBasePointers (nditer_api.c:314).
    ///
    ...
    /// </summary>
    [TestClass]
    public class NDIterResetBasePointersTests
    {
        // ================================================================
        ...
        public unsafe void ResetBasePointers_1D_NegStride_PreservesMemoryOrder()
        {
            ...
            using var it = NDIterRef.New(a_rev, order: NPY_ORDER.NPY_KEEPORDER);
            var first = new List<int>();
            do { first.Add(it.GetValue<int>(0)); } while (it.Iternext());
        ...
        public unsafe void ResetBasePointers_MultiOperand_SwapsBoth()
        {
            ...
            using var it = NDIterRef.MultiNew(2, new[] { x1, y1 },
                NDIterGlobalFlags.None, NPY_ORDER.NPY_KEEPORDER, NPY_CASTING.NPY_SAFE_CASTING, opFlags);
            // Write y1[i] = x1[i] * 2
            do
            {
        ...
        public unsafe void ResetBasePointers_RepeatedResets_Work()
        {
            ...
            using var it = NDIterRef.New(arrays[0]);
