...
{
    /// <summary>
    /// Battle tests for NDIter implementation.
    /// Tests edge cases, parity with NumPy, and potential bugs.
    /// </summary>
    [TestClass]
    public class NDIterBattleTests
    {
        // =====================================================================
        ...
        public void Sliced_EveryOther()
        {
            ...
            using var iter = NDIterRef.New(sliced);
        ...
        public void Sliced_Reversed()
        {
            ...
            using var iter = NDIterRef.New(reversed);
        ...
        public void Sliced_Column()
        {
            ...
            using var iter = NDIterRef.New(column);
        ...
        public void Sliced_SubMatrix()
        {
            ...
            using var iter = NDIterRef.New(sub);
        ...
        public void Transposed_2D()
        {
            ...
            using var iter = NDIterRef.New(transposed);
        ...
        public unsafe void InnerStrides_Strided()
        {
            ...
            using var iter = NDIterRef.New(strided);
        ...
        public void MultipleIterators_SameArray()
        {
            ...
            using var iter1 = NDIterRef.New(arr);
            using var iter2 = NDIterRef.New(arr);
            using var iter3 = NDIterRef.New(arr);
        ...
        public void SliceOfSlice()
        {
            ...
            using var iter = NDIterRef.New(slice2);
        ...
        public void NonContiguous_2D_Column()
        {
            ...
            using var iter = NDIterRef.New(col);
        ...
        public void ManyOperands_Works()
        {
            ...
            var opFlags = new NDIterPerOpFlags[10];
            for (int i = 0; i < 10; i++)
                opFlags[i] = NDIterPerOpFlags.READONLY;
        ...
        public void ZeroOperands_Throws()
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() =>
            {
                using var iter = NDIterRef.MultiNew(
                    ...
                    order: NPY_ORDER.NPY_KEEPORDER,
                    casting: NPY_CASTING.NPY_SAFE_CASTING,
                    opFlags: Array.Empty<NDIterPerOpFlags>());
            });
        }
        ...
        public void NullOperand_Throws()
        {
            ...
            {
                using var iter = NDIterRef.New(null!);
            });
        }
        ...
        public unsafe void DataVerification_Reversed_CorrectValues()
        {
            ...
            using var iter = NDIterRef.New(reversed, NDIterGlobalFlags.MULTI_INDEX);
        ...
        public unsafe void DataVerification_Transposed_CorrectValues()
        {
            ...
            using var iter = NDIterRef.New(transposed, NDIterGlobalFlags.MULTI_INDEX);
        ...
        public unsafe void DataVerification_Column_CorrectValues()
        {
            ...
            using var iter = NDIterRef.New(column, NDIterGlobalFlags.MULTI_INDEX);
        ...
        public unsafe void DataVerification_SubMatrix_CorrectValues()
        {
            ...
            using var iter = NDIterRef.New(sub, NDIterGlobalFlags.MULTI_INDEX);
