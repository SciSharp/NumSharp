...
namespace NumSharp.UnitTest.Backends.Iterators
{
    ...
    public class NDIterRefTests
    {
        ...
        public void ZeroSizeArray_HandledCorrectly()
        {
            ...
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.ZEROSIZE_OK);
        ...
        public void UnlimitedOperands_ManyOperands()
        {
            ...
            var opFlags = new NDIterPerOpFlags[16];
            ...
            using var iter = NDIterRef.MultiNew(16, arrays, NDIterGlobalFlags.None,
        ...
        public void UnlimitedOperands_100Operands_IteratesCorrectly()
        {
            ...
            var opFlags = new NDIterPerOpFlags[operandCount];
            ...
            using var iter = NDIterRef.MultiNew(operandCount, arrays, NDIterGlobalFlags.None,
                NPY_ORDER.NPY_KEEPORDER, NPY_CASTING.NPY_NO_CASTING, opFlags);
        ...
        public void Index_ThrowsWithoutFlag()
        {
            ...
            using var iter = NDIterRef.New(arr);  // No C_INDEX/F_INDEX flag
        ...
        public void GrowInner_FlagSetsCorrectly()
        {
            ...
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.GROWINNER);
        ...
        public void GrowInner_WithBuffering()
        {
            ...
            using var iter = NDIterRef.AdvancedNew(
                nop: 1,
                op: new[] { arr },
                flags: NDIterGlobalFlags.BUFFERED | NDIterGlobalFlags.GROWINNER,
                order: NPY_ORDER.NPY_KEEPORDER,
                casting: NPY_CASTING.NPY_SAFE_CASTING,
                opFlags: new[] { NDIterPerOpFlags.READONLY },
                bufferSize: 256);
