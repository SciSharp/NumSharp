    ...
    public unsafe class NDExprExtensiveTests
    {
        ...
        public void Power_Double_IntegerAndFractional()
        {
            RunBinary_f64(
                ...
                NDExpr.Power, Math.Pow, key: "pow_f64_v1");
        }
        ...
        public void ATan2_Quadrants()
        {
            RunBinary_f64(
                ...
                NDExpr.ATan2, Math.Atan2, tol: 1e-9, key: "atan2_f64_v1");
        }
        ...
        public void Min_Double_ReturnsSmaller()
        {
            RunBinary_f64(
                ...
                NDExpr.Min, Math.Min, key: "min_f64_v1");
        }
        ...
        [TestMethod] public void Exp_Double() => RunUnary_f64(
            new double[] { 0, 1, 2, -1, Math.Log(10) }, NDExpr.Exp, Math.Exp, tol: 1e-9, key: "exp_f64_v1");
        ...
        [TestMethod] public void Log_Double_SpecialValues()
        {
            ...
            RunUnary_f64(xs, NDExpr.Log, Math.Log, tol: 1e-9, key: "log_f64_v1");
        }
        ...
        [TestMethod] public void Log2_Double() => RunUnary_f64(
            new double[] { 1, 2, 4, 8, 1024 }, NDExpr.Log2, Math.Log2, tol: 1e-9, key: "log2_f64_v1");

        [TestMethod] public void Log10_Double() => RunUnary_f64(
            new double[] { 1, 10, 100, 1000, 1e-3 }, NDExpr.Log10, Math.Log10, tol: 1e-9, key: "log10_f64_v1");
        ...
        [TestMethod] public void Sin_Double() => RunUnary_f64(
            new double[] { 0, Math.PI / 2, Math.PI, -Math.PI / 2 }, NDExpr.Sin, Math.Sin,
            tol: 1e-9, key: "sin_f64_v1");

        [TestMethod] public void Cos_Double() => RunUnary_f64(
            new double[] { 0, Math.PI / 2, Math.PI, -Math.PI / 2 }, NDExpr.Cos, Math.Cos,
            tol: 1e-9, key: "cos_f64_v1");

        [TestMethod] public void Tan_Double() => RunUnary_f64(
            new double[] { 0, Math.PI / 4, -Math.PI / 4 }, NDExpr.Tan, Math.Tan,
            tol: 1e-9, key: "tan_f64_v1");

        [TestMethod] public void Sinh_Double() => RunUnary_f64(
            new double[] { 0, 1, -1, 2 }, NDExpr.Sinh, Math.Sinh, tol: 1e-9, key: "sinh_f64_v1");

        [TestMethod] public void Cosh_Double() => RunUnary_f64(
            new double[] { 0, 1, -1, 2 }, NDExpr.Cosh, Math.Cosh, tol: 1e-9, key: "cosh_f64_v1");

        [TestMethod] public void Tanh_Double() => RunUnary_f64(
            new double[] { 0, 1, -1, 100, -100 }, NDExpr.Tanh, Math.Tanh, tol: 1e-9, key: "tanh_f64_v1");

        [TestMethod] public void ASin_Double() => RunUnary_f64(
            new double[] { 0, 0.5, 1, -1 }, NDExpr.ASin, Math.Asin, tol: 1e-9, key: "asin_f64_v1");

        [TestMethod] public void ACos_Double() => RunUnary_f64(
            new double[] { 0, 0.5, 1, -1 }, NDExpr.ACos, Math.Acos, tol: 1e-9, key: "acos_f64_v1");

        [TestMethod] public void ATan_Double() => RunUnary_f64(
            new double[] { 0, 1, -1, 1000 }, NDExpr.ATan, Math.Atan, tol: 1e-9, key: "atan_f64_v1");
        ...
        [TestMethod] public void Rad2Deg_Double() => RunUnary_f64(
            new double[] { 0, Math.PI / 2, Math.PI, -Math.PI }, NDExpr.Rad2Deg,
        ...
        [TestMethod] public void Floor_Double() => RunUnary_f64(
            new double[] { 1.7, -1.7, 2.5, -2.5, 0, 1 }, NDExpr.Floor, Math.Floor,
            tol: 0, key: "floor_f64_v1");

        [TestMethod] public void Ceil_Double() => RunUnary_f64(
            new double[] { 1.3, -1.3, 2.5, -2.5, 0, 1 }, NDExpr.Ceil, Math.Ceiling,
        ...
        [TestMethod] public void Truncate_Double() => RunUnary_f64(
            new double[] { 1.7, -1.7, 2.5, -2.5, 0 }, NDExpr.Truncate, Math.Truncate,
        ...
        [TestMethod] public void Sign_Double() => RunUnary_f64(
            new double[] { -5, -1, 0, 1, 5 }, NDExpr.Sign, x => (double)Math.Sign(x),
        ...
        [TestMethod] public void Cbrt_Double() => RunUnary_f64(
            new double[] { 0, 1, 8, 27, -27, -8 }, NDExpr.Cbrt, Math.Cbrt,
