...
namespace NumSharp.UnitTest.Backends.Iterators
{
    ...
    /// </summary>
    [TestClass]
    public class NDIterNumPyParityTests
    {
        // =========================================================================
        ...
        public void Coalescing_Contiguous3D_CoalescesToNDim1()
        {
            ...
            using var iter = NDIterRef.New(arr);
        ...
        public void Coalescing_WithMultiIndex_PreservesNDim()
        {
            ...
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.MULTI_INDEX);
        ...
        public void Coalescing_Transposed_CoalescesToNDim1()
        {
            ...
            using var iter = NDIterRef.New(arr_t);
        ...
        public void Coalescing_NonContiguous2DSlice_PreservesNDim()
        {
            ...
            using var iter = NDIterRef.New(sliced, NDIterGlobalFlags.MULTI_INDEX);
        ...
        public void Coalescing_Scalar_HasNDim0()
        {
            ...
            using var iter = NDIterRef.New(scalar);
        ...
        public void Coalescing_EmptyArray_HasIterSize0()
        {
            ...
            using var iter = NDIterRef.New(empty, NDIterGlobalFlags.ZEROSIZE_OK);
        ...
        public void CIndex_2DArray_MatchesNumPy()
        {
            ...
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.MULTI_INDEX | NDIterGlobalFlags.C_INDEX);
        ...
        public void FIndex_2DArray_MatchesNumPy()
        {
            ...
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.MULTI_INDEX | NDIterGlobalFlags.F_INDEX);
        ...
        public void SlicedArray_IterationOrder_MatchesNumPy()
        {
            ...
            using var iter = NDIterRef.New(sliced, NDIterGlobalFlags.MULTI_INDEX | NDIterGlobalFlags.C_INDEX);
        ...
        public void Broadcast_TwoOperands_MatchesNumPy()
        {
            ...
            using var iter = NDIterRef.MultiNew(
                nop: 2,
                op: new[] { a, b },
                flags: NDIterGlobalFlags.MULTI_INDEX,
                order: NPY_ORDER.NPY_KEEPORDER,
                casting: NPY_CASTING.NPY_SAFE_CASTING,
                opFlags: new[] { NDIterPerOpFlags.READONLY, NDIterPerOpFlags.READONLY });
        ...
        public void Buffered_ChunkSizes_MatchBufferSize()
        {
            ...
            using var iter = NDIterRef.AdvancedNew(
                nop: 1,
                op: new[] { arr },
                flags: NDIterGlobalFlags.BUFFERED | NDIterGlobalFlags.EXTERNAL_LOOP,
                order: NPY_ORDER.NPY_KEEPORDER,
                casting: NPY_CASTING.NPY_SAFE_CASTING,
        ...
        public void Transposed3D_MultiIndex_MatchesNumPy()
        {
            ...
            using var iter = NDIterRef.New(arr3d_t, NDIterGlobalFlags.MULTI_INDEX);
        ...
        public void Reset_RestoresInitialState()
        {
            ...
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.C_INDEX);
        ...
        public void Reversed2D_OneAxis_ValuesMatch()
        {
            ...
            using var iter = NDIterRef.New(rev2d, NDIterGlobalFlags.MULTI_INDEX);
        ...
        public void Shape_ChangesAfterCoalescing()
        {
            ...
            var arr = np.arange(24).reshape(2, 3, 4);
            using var iter = NDIterRef.New(arr);  // No MULTI_INDEX flag
        ...
        public void IterationOrder_FOrder_ColumnMajor()
        {
            ...
            var arr = np.arange(6).reshape(2, 3);
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.MULTI_INDEX, NPY_ORDER.NPY_FORTRANORDER);
        ...
        public void SetValue_WritesCorrectValue()
        {
            ...
            using var iter = NDIterRef.AdvancedNew(
                ...
                order: NPY_ORDER.NPY_KEEPORDER,
                casting: NPY_CASTING.NPY_SAFE_CASTING,
                opFlags: new[] { NDIterPerOpFlags.READWRITE });
        ...
        public void Transposed_OrderK_FollowsMemoryLayout()
        {
            ...
            using var iter = NDIterRef.New(transposed, NDIterGlobalFlags.MULTI_INDEX, NPY_ORDER.NPY_KEEPORDER);
        ...
        public void GotoIndex_CIndex_JumpsToCorrectPosition()
        {
            ...
            var arr = np.arange(12).reshape(3, 4);
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.C_INDEX | NDIterGlobalFlags.MULTI_INDEX);
        ...
        public void GotoIndex_FIndex_JumpsToCorrectPosition()
        {
            ...
            var arr = np.arange(12).reshape(3, 4);
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.F_INDEX | NDIterGlobalFlags.MULTI_INDEX);
        ...
        public void CIndex_FOrderIteration_TracksOriginalArrayIndex()
        {
            ...
            var arr = np.arange(12).reshape(3, 4);
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.C_INDEX | NDIterGlobalFlags.MULTI_INDEX, NPY_ORDER.NPY_FORTRANORDER);
        ...
        public void Copy_CreatesIndependentIterator()
        {
            ...
            var arr = np.arange(12).reshape(3, 4);
            using var it1 = NDIterRef.New(arr, NDIterGlobalFlags.MULTI_INDEX);
        ...
        {
            var arr = np.arange(12).reshape(3, 4);
            using var it1 = NDIterRef.New(arr, NDIterGlobalFlags.MULTI_INDEX | NDIterGlobalFlags.C_INDEX);
        ...
        public void NegativeStride_WithDontNegateStrides_PreservesViewOrder()
        {
            ...
            using var iter = NDIterRef.New(rev,
                NDIterGlobalFlags.MULTI_INDEX | NDIterGlobalFlags.C_INDEX | NDIterGlobalFlags.DONT_NEGATE_STRIDES);
        ...
        public void NegativeStride_WithoutMultiIndex_StillIteratesMemoryOrder()
        {
            ...
            using var iter = NDIterRef.New(rev);  // No flags
        ...
        public void GetIterView_TransposedArray_ReflectsInternalOrder()
        {
            ...
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.None, NPY_ORDER.NPY_KEEPORDER);
        ...
        public void GetIterView_BufferedIterator_ThrowsException()
        {
            ...
            using var iter = NDIterRef.New(arr, NDIterGlobalFlags.BUFFERED);
        ...
        public void Cast_CommonDtype_TwoOperands()
        {
            ...
            using var iter = NDIterRef.MultiNew(
                2,
                new[] { arrInt, arrFloat },
                NDIterGlobalFlags.COMMON_DTYPE | NDIterGlobalFlags.BUFFERED,
                NPY_ORDER.NPY_KEEPORDER,
                NPY_CASTING.NPY_SAFE_CASTING,
                new[] { NDIterPerOpFlags.READONLY, NDIterPerOpFlags.READONLY },
        ...
        public void Cast_RequiresBuffered_ThrowsWithoutBuffer()
        {
            ...
            try
            {
                ...
                using var iter = NDIterRef.New(
                    arr,
                    NDIterGlobalFlags.None,  // No BUFFERED
                    NPY_ORDER.NPY_KEEPORDER,
                    NPY_CASTING.NPY_SAFE_CASTING,
        ...
        public void Reduction_1DToScalar_IteratesCorrectly()
        {
            ...
            using var iter = NDIterRef.AdvancedNew(
                2,
                new[] { a, result },
                NDIterGlobalFlags.REDUCE_OK,
                NPY_ORDER.NPY_KEEPORDER,
                NPY_CASTING.NPY_NO_CASTING,
                new[] { NDIterPerOpFlags.READONLY, NDIterPerOpFlags.READWRITE },
                null,
                1,  // opAxesNDim = 1
        ...
        public void Reduction_WithoutReduceOK_Throws()
        {
            ...
            try
            {
                using var iter = NDIterRef.AdvancedNew(
                    2,
                    new[] { a, result },
                    NDIterGlobalFlags.None,  // No REDUCE_OK
                    NPY_ORDER.NPY_KEEPORDER,
                    NPY_CASTING.NPY_NO_CASTING,
                    new[] { NDIterPerOpFlags.READONLY, NDIterPerOpFlags.READWRITE },
                    null,
        ...
        public void Reduction_ReadOnlyOperand_DoesNotThrow()
        {
            ...
            using var iter = NDIterRef.AdvancedNew(
                2,
                new[] { a, scalar },
                NDIterGlobalFlags.None,  // No REDUCE_OK - should be fine for readonly
                NPY_ORDER.NPY_KEEPORDER,
                NPY_CASTING.NPY_NO_CASTING,
                new[] { NDIterPerOpFlags.READONLY, NDIterPerOpFlags.READONLY },
                null,
        ...
        public void Reduction_WriteOnlyOperand_Throws()
        {
            ...
            try
            {
                using var iter = NDIterRef.AdvancedNew(
                    ...
                    NPY_ORDER.NPY_KEEPORDER,
                    NPY_CASTING.NPY_NO_CASTING,
                    new[] { NDIterPerOpFlags.READONLY, NDIterPerOpFlags.WRITEONLY },  // WRITEONLY instead of READWRITE
                    null,
                    1,
                    new[] { new[] { 0 }, new[] { -1 } });
            }
        ...
        public void BufferedReduction_1DToScalar_ProducesCorrectResult()
        {
            ...
            using var iter = NDIterRef.AdvancedNew(
                2,
                new[] { a, result },
                NDIterGlobalFlags.REDUCE_OK | NDIterGlobalFlags.BUFFERED,
                NPY_ORDER.NPY_KEEPORDER,
                NPY_CASTING.NPY_NO_CASTING,
                new[] { NDIterPerOpFlags.READONLY, NDIterPerOpFlags.READWRITE },
                null,
        ...
        public void BufferedReduction_ExternalLoop_IterCountMatchesNumPy()
        {
            ...
            using var iter1 = NDIterRef.AdvancedNew(
                2,
                new[] { x, y },
                NDIterGlobalFlags.REDUCE_OK | NDIterGlobalFlags.BUFFERED,
                NPY_ORDER.NPY_KEEPORDER,
            ...
            using var iter2 = NDIterRef.AdvancedNew(
                2,
                new[] { x, y },
                NDIterGlobalFlags.REDUCE_OK | NDIterGlobalFlags.BUFFERED | NDIterGlobalFlags.EXTERNAL_LOOP,
                NPY_ORDER.NPY_KEEPORDER,
                NPY_CASTING.NPY_NO_CASTING,
                new[] { NDIterPerOpFlags.READONLY, NDIterPerOpFlags.READWRITE },
                null,
