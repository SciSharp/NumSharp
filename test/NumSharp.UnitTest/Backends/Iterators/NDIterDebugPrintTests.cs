...
{
    /// <summary>
    /// Battletest suite for NDIter_DebugPrint (nditer_api.c:1402).
    ///
    ...
    /// </summary>
    [TestClass]
    public class NDIterDebugPrintTests
    {
        [TestMethod]
        ...
        public void DebugPrint_DecodesMULTIINDEX()
        {
            ...
            using var it = NDIterRef.New(a, flags: NDIterGlobalFlags.MULTI_INDEX);
            string dump = it.DebugPrintToString();
        ...
        public void DebugPrint_DecodesNEGPERM()
        {
            ...
            using var it = NDIterRef.New(a, order: NPY_ORDER.NPY_KEEPORDER);
            string dump = it.DebugPrintToString();
        ...
        {
            var a = np.arange(5).astype(np.int32);
            using var it = NDIterRef.New(a, flags: NDIterGlobalFlags.C_INDEX);
            string dump = it.DebugPrintToString();
        ...
        public void DebugPrint_NoCrashOnReducedIterator()
        {
            ...
            using var it = NDIterRef.AdvancedNew(
                nop: 2,
                op: new[] { x, y },
                flags: NDIterGlobalFlags.BUFFERED | NDIterGlobalFlags.REDUCE_OK,
                order: NPY_ORDER.NPY_KEEPORDER,
                casting: NPY_CASTING.NPY_SAFE_CASTING,
