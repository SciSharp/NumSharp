...
namespace NumSharp.UnitTest.Backends.Unmanaged.Math
{
    ...
    public class np_divide_tests
    {
...
#if _REGEN
        %a = except(supported_currently_supported, "NDArray", "Boolean")
        %foreach a
        ...
        [TestMethod]
        public void Divide_Boolean_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Boolean) + 3;
        ...
        [TestMethod]
        public void Divide_Byte_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Byte) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Char) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Int16_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Int16) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Char) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_UInt16_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.UInt16) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Char) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Int32_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Int32) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Char) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_UInt32_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.UInt32) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Char) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Int64_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Int64) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Char) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_UInt64_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.UInt64) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Char) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_Boolean()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Boolean) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_Byte()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Byte) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_Int16()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Int16) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_UInt16()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.UInt16) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_Int32()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Int32) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_UInt32()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.UInt32) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_Int64()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Int64) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_UInt64()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.UInt64) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_Double()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Double) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_Single()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Single) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Char_To_Decimal()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Char) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Decimal) + 1;
            var ret = left / right;
        ...
        [TestMethod]
        public void Divide_Double_To_Char()
        {
            var left = np.ones(new Shape(5, 5), NPTypeCode.Double) + 3;
            var right = np.ones(new Shape(5, 5), NPTypeCode.Char) + 1;
            var ret = left / right;
