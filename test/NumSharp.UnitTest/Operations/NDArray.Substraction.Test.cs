...
namespace NumSharp.UnitTest.Operations
{
    ...
    public class NDArraySubstractionTest
    {
        ...
        {
            var np1 = new NumPy<double>().array(new double[] { 3, 5, 7 });
            var np2 = new NumPy<double>().array(new double[] { 1, 3, 4 });
        ...
        {
            var np1 = new NumPy<Complex>().array(new Complex[] { new Complex(6, 8), new Complex(10, 12) });
