...
namespace NumSharp.UnitTest.ToString
{
    ...
    public class NdArrayToStringTest : TestClass
    {
        ...
        public void ArraySmall1Dim()
        {
            ...
            Assert.AreEqual("[1, 2, 1, ..., 2, 3, 2]", nd.ToString());
        }
        ...
        public void ArrayLarge1Dim()
        {
            ...
            Assert.AreEqual("[0, 1, 2, ..., 9997, 9998, 9999]", nd.ToString());
        }
        ...
        public void ArrayLarge2Dim()
        {
            ...
            Assert.AreEqual(7, Regex.Matches(nd.ToString(), @"\.\.\.").Count);
        }
        ...
        public void ArrayLarge3Dim()
        {
            ...
            Assert.AreEqual(43, Regex.Matches(nd.ToString(), @"\.\.\.").Count);
        }
    }
}
