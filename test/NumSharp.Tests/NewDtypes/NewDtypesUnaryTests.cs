...
namespace NumSharp.Tests.NewDtypes
{
    /// <summary>
    ...
    public class NewDtypesUnaryTests
    {
        ...
        public void Half_Sin()
        {
            ...
            var h = np.array(new Half[] { (Half)0.0, (Half)(System.Math.PI / 6), (Half)(System.Math.PI / 4), (Half)(System.Math.PI / 2) });
            var result = np.sin(h);
        ...
        public void Complex_Exp()
        {
            ...
            var r1 = result.GetAtIndex<Complex>(1);
            r1.Real.Should().BeApproximately(System.Math.E, 0.0001);
        ...
        public void Complex_Log()
        {
            ...
            r1.Imaginary.Should().BeApproximately(System.Math.PI / 2, 0.0001);

            var r2 = result.GetAtIndex<Complex>(2);
            r2.Real.Should().BeApproximately(0.3465736, 0.0001);
            r2.Imaginary.Should().BeApproximately(System.Math.PI / 4, 0.0001);
        }
        ...
        public void Complex_InverseTrig_BranchCuts()
        {
            ...
            AssertComplex(asinPos, System.Math.PI / 2, 1.3169578969248166);
            var asinNeg = np.arcsin(np.array(new Complex[] { new(2, -0.0) })).GetAtIndex<Complex>(0);
            AssertComplex(asinNeg, System.Math.PI / 2, -1.3169578969248166);
            ...
            AssertComplex(atan, System.Math.PI / 2, 0.5493061443340549);
        }
        ...
        public void Complex_HyperbolicInverse_SpecialValues()
        {
            ...
            asin.Real.Should().BeApproximately(System.Math.PI / 2, 1e-12);
            ...
            AssertComplex(atan, System.Math.PI / 2, 0.0);

            var acos = np.arccos(np.array(new Complex[] { new(0.0, double.NaN) })).GetAtIndex<Complex>(0);
            acos.Real.Should().BeApproximately(System.Math.PI / 2, 1e-12);
        ...
        public void Complex_Arctan_TinyAndLarge()
        {
            ...
            big.Real.Should().BeApproximately(System.Math.PI / 2, 1e-15);
