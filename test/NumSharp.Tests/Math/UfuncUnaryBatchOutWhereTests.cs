...
namespace NumSharp.Tests.Math
{
    ...
    public class UfuncUnaryBatchOutWhereTests
    {
        ...
        public void ArcTan2_Out_Values_And0d()
        {
            ...
            Assert.AreEqual(System.Math.PI / 4, o0.GetDouble(), 1e-12);
        }
        ...
        public void Where_WithOut_MaskedOffKeepPrior_PerFamily()
        {
            ...
            Assert.AreEqual(-System.Math.PI / 2, at2.GetDouble(2), 1e-12);
            ...
            np.sinh(F8(), sh, Mask4());
            Assert.AreEqual((float)System.Math.Sinh(0), sh.GetSingle(0), 1e-6f);
            Assert.AreEqual(-1.0f, sh.GetSingle(1));
            Assert.AreEqual((float)System.Math.Sinh(2), sh.GetSingle(2), 1e-5f);
        ...
        public void Empty_And0d_WithOut()
        {
            ...
            Assert.IsTrue(ReferenceEquals(r0, o0));
            Assert.AreEqual(System.Math.Sinh(1.0), o0.GetDouble(), 1e-12);
        }
