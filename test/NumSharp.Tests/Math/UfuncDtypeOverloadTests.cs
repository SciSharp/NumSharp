...
namespace NumSharp.Tests.Math
{
    ...
    public class UfuncDtypeOverloadTests
    {
        ...
        public void UnaryFamily_WhereAndDtype_ReachableWithoutOut()
        {
            ...
            Assert.AreEqual(System.Math.E, np.exp(x, where: t).GetDouble(0), 1e-12);
        ...
        public void Sqrt_DtypeWithOut_LoopComputesInDtype()
        {
            ...
            Assert.AreNotEqual(System.Math.Sqrt(2.0), o.GetDouble(0), "must be the f32 loop value, not the f64 loop value");
        }
