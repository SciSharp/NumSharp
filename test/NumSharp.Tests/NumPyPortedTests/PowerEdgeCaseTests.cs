...
namespace NumSharp.Tests.NumPyPortedTests
{
    ...
    public class PowerEdgeCaseTests
    {
        ...
        public void Power_Float_NegativeOneExponent_ReturnsReciprocals()
        {
            ...
            Assert.IsTrue(System.Math.Abs(data[0] - 1.0) < 1e-10);
            Assert.IsTrue(System.Math.Abs(data[1] - 0.5) < 1e-10);
            Assert.IsTrue(System.Math.Abs(data[2] - (1.0 / 3.0)) < 1e-10);
        }
        ...
        public void Power_Float_HalfExponent_ReturnsSqrt()
        {
            ...
            var data = result.GetData<double>();
            Assert.IsTrue(System.Math.Abs(data[0] - 1.0) < 1e-10);
            Assert.IsTrue(System.Math.Abs(data[1] - System.Math.Sqrt(2.0)) < 1e-10);
            Assert.IsTrue(System.Math.Abs(data[2] - System.Math.Sqrt(3.0)) < 1e-10);
        }
        ...
        public void Power_CubeRoot()
        {
            ...
            Assert.IsTrue(System.Math.Abs(data[0] - 1.0) < 1e-10);
            Assert.IsTrue(System.Math.Abs(data[1] - 2.0) < 1e-10);
            Assert.IsTrue(System.Math.Abs(data[2] - 3.0) < 1e-10);
            Assert.IsTrue(System.Math.Abs(data[3] - 4.0) < 1e-10);
        }
