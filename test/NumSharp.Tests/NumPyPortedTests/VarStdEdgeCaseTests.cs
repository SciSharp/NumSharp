...
namespace NumSharp.Tests.NumPyPortedTests
{
    /// <summary>
    ...
    public class VarStdEdgeCaseTests
    {
        ...
        public void Std_2DArray_Global()
        {
            ...
            Assert.IsTrue(System.Math.Abs(value - 1.707825127659933) <1e-10);
        }
        ...
        public void Std_2DArray_Axis0()
        {
            ...
            Assert.IsTrue(System.Math.Abs(data[0] - 1.5) <1e-10);
            Assert.IsTrue(System.Math.Abs(data[1] - 1.5) <1e-10);
            Assert.IsTrue(System.Math.Abs(data[2] - 1.5) <1e-10);
        }
        ...
        public void Std_2DArray_Axis1()
        {
            ...
            var data = result.GetData<double>();
            Assert.IsTrue(System.Math.Abs(data[0] - 0.81649658) <1e-6);
            Assert.IsTrue(System.Math.Abs(data[1] - 0.81649658) <1e-6);
        }
        ...
        public void Var_2DArray_Global()
        {
            ...
            var result = np.var(A);
            var value = (double)result;
            Assert.IsTrue(System.Math.Abs(value - 2.9166666666666665) <1e-10);
        }
        ...
        public void Var_2DArray_Axis0()
        {
            ...
            result.Should().BeShaped(3);
            var data = result.GetData<double>();
            Assert.IsTrue(System.Math.Abs(data[0] - 2.25) <1e-10);
            Assert.IsTrue(System.Math.Abs(data[1] - 2.25) <1e-10);
            Assert.IsTrue(System.Math.Abs(data[2] - 2.25) <1e-10);
        }
        ...
        public void Var_2DArray_Axis1()
        {
            ...
            result.Should().BeShaped(2);
            var data = result.GetData<double>();
            Assert.IsTrue(System.Math.Abs(data[0] - 0.66666667) <1e-6);
            Assert.IsTrue(System.Math.Abs(data[1] - 0.66666667) <1e-6);
        }
        ...
        public void Std_Ddof0_PopulationStd()
        {
            ...
            var value = (double)result;
            Assert.IsTrue(System.Math.Abs(value - 1.4142135623730951) <1e-10);
        }
        ...
        public void Std_Ddof1_SampleStd()
        {
            ...
            var value = (double)result;
            Assert.IsTrue(System.Math.Abs(value - 1.5811388300841898) <1e-10);
        }
        ...
        public void Std_NegativeAxis()
        {
            ...
            Assert.IsTrue(System.Math.Abs(data1[0] - data2[0]) <1e-10);
            Assert.IsTrue(System.Math.Abs(data1[1] - data2[1]) <1e-10);
        }
        ...
        public void Std_LargeArray()
        {
            ...
            var expected = System.Math.Sqrt((10000.0 * 10000.0 - 1.0) / 12.0);
            Assert.IsTrue(System.Math.Abs((double)result - expected) <1.0);
        }
