...
namespace NumSharp.Tests.NumPyPortedTests
{
    ...
    public class ModfEdgeCaseTests
    {
        ...
        public void Modf_PositiveValues()
        {
            ...
            Assert.IsTrue(System.Math.Abs(fracData[0] - 0.5) <1e-10);
            Assert.IsTrue(System.Math.Abs(fracData[1] - 0.7) <1e-10);
        ...
        public void Modf_NegativeValues()
        {
            ...
            Assert.IsTrue(System.Math.Abs(fracData[0] - (-0.2)) < 1e-10);
        ...
        public void Modf_MixedValues()
        {
            ...
            Assert.IsTrue(System.Math.Abs(fracData[0] - 0.5) < 1e-10);
            Assert.IsTrue(System.Math.Abs(fracData[1] - 0.7) < 1e-10);
            Assert.IsTrue(System.Math.Abs(fracData[2] - (-0.2)) < 1e-10);
        ...
        public void Modf_LargeValues()
        {
            ...
            Assert.IsTrue(System.Math.Abs(fracData[0] - 0.5) < 1e-5);
            Assert.IsTrue(System.Math.Abs(fracData[1] - (-0.5)) < 1e-5);
        ...
        public void Modf_2DArray()
        {
            ...
            Assert.IsTrue(System.Math.Abs(fracData[0] - 0.5) <1e-10);
            Assert.IsTrue(System.Math.Abs(fracData[1] - 0.7) <1e-10);
            Assert.IsTrue(System.Math.Abs(fracData[2] - 0.1) <1e-10);
            Assert.IsTrue(System.Math.Abs(fracData[3] - 0.9) <1e-10);
        ...
        public void Modf_SingleElement()
        {
            ...
            Assert.IsTrue(System.Math.Abs(frac.GetData<double>()[0] - 0.14159) < 1e-5);
