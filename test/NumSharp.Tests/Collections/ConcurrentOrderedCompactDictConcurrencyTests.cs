// MIRROR of ConcurrentOrderedDictConcurrencyTests.cs for ConcurrentOrderedCompactDict — the two types share one public surface and one
...
{
    /// <summary>
    ///     Heavy-load concurrency stress for <see cref="ConcurrentOrderedCompactDict{TKey,TValue}" />, built around a
    ...
    ///     <see cref="ConcurrentOrderedCompactDict{TKey,TValue}.AddRange" /> visibility, and full cross-path consistency
    ...
    /// </remarks>
    [TestClass]
    public class ConcurrentOrderedCompactDictConcurrencyTests
    {
