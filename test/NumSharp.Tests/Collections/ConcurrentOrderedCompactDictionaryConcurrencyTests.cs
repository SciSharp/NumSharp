// MIRROR of ConcurrentOrderedDictionaryConcurrencyTests.cs for ConcurrentOrderedCompactDictionary — the two types share one public surface and one
...
{
    /// <summary>
    ///     Heavy-load concurrency stress for <see cref="ConcurrentOrderedCompactDictionary{TKey,TValue}" />, built around a
    ...
    ///     <see cref="ConcurrentOrderedCompactDictionary{TKey,TValue}.AddRange" /> visibility, and full cross-path consistency
    ...
    /// </remarks>
    [TestClass]
    public class ConcurrentOrderedCompactDictionaryConcurrencyTests
    {
