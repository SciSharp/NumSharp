// MIRROR of ConcurrentOrderedDictMemoryTests.cs for ConcurrentOrderedCompactDict — the two types share one public surface and one
...
{
    /// <summary>
    ///     Memory-contract pins for <see cref="ConcurrentOrderedCompactDict{TKey,TValue}" /> — the allocation and
    ...
    ///     and the framework dictionary live in <c>ConcurrentOrderedDict.COMPACT.md § Memory analysis</c>; these tests
    ///     pin only the collection's OWN contracts, which hold on any 64-bit runtime and in both Debug and Release.
    /// </summary>
    [TestClass]
    public class ConcurrentOrderedCompactDictMemoryTests
    {
        /// <summary>
        ...
        {
            var d = new ConcurrentOrderedCompactDict<int, int>(4_096);
        ...
        public void AtomicValueReplace_IsAllocationFree()
        {
            ...
            var d = new ConcurrentOrderedCompactDict<int, long>(1_024);
        ...
        public void PresizedAppend_AllocatesOnlyTheHashNode()
        {
            ...
            var d = new ConcurrentOrderedCompactDict<int, int>(200_000);
            int next = 0;
            Action adds = () =>
            {
                for (int i = 0; i < 1_000; i++)
        ...
        public void TailPop_And_SwapBack_AllocateOnlyOneSnapshotHolder()
        {
            ...
            var d = new ConcurrentOrderedCompactDict<int, int>(64_000);
        ...
        public void InteriorRemove_PaysCapacitySizedArrays_TailPopDoesNot()
        {
            ...
            var d = new ConcurrentOrderedCompactDict<int, int>(Capacity);
        ...
        public void NonAtomicReplace_AddRangeBatchesManyClonesIntoOne()
        {
            ...
            var d = new ConcurrentOrderedCompactDict<int, decimal>(Capacity);
            for (int i = 0; i < Capacity; i++)
            {
                d.Add(i, i);
            }
        ...
        private static WeakReference AddThenTailPop(ConcurrentOrderedCompactDict<int, object> d)
        {
        ...
        {
            var d = new ConcurrentOrderedCompactDict<int, object>();
            d.Add(0, new object());
            d.Add(1, new object());
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static WeakReference AddThenInteriorRemove(ConcurrentOrderedCompactDict<int, object> d)
        {
            var value = new object();
            d.Add(10, value);
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static WeakReference AddThenClear(ConcurrentOrderedCompactDict<int, object> d)
        {
            var value = new object();
            d.Add(0, value);
            var wr = new WeakReference(value);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static WeakReference HoldEnumeratorCheckPinnedThenDrop(ConcurrentOrderedCompactDict<int, object> d)
        {
            var value = new object();
            d.Add(0, value);
            var wr = new WeakReference(value);
