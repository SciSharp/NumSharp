// MIRROR of ConcurrentOrderedDictionaryTests.cs for ConcurrentOrderedCompactDictionary — the two types share one public surface and one
...
{
    /// <summary>
    ///     Functional pins for <see cref="ConcurrentOrderedCompactDictionary{TKey,TValue}" />: the dual key/index paths, ordering,
    ...
    ///     The multi-threaded guarantees are pinned separately in <see cref="ConcurrentOrderedCompactDictionaryConcurrencyTests" />.
    /// </summary>
    [TestClass]
    public class ConcurrentOrderedCompactDictionaryTests
    {
        ...
        {
            var d = new ConcurrentOrderedCompactDictionary<string, int>();
        ...
        public void Ctor_NegativeCapacity_Throws()
            => Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => _ = new ConcurrentOrderedCompactDictionary<int, int>(-1));
        ...
        public void IntKey_IndexerBindsToIndex_NotKey()
        {
            ...
            var d = new ConcurrentOrderedCompactDictionary<int, string>();
            d.Add(10, "ten");
            d.Add(20, "twenty");
        ...
        public void TryRemoveSwapBack_NonAtomicTypes_TakesCopyPath_SameSemantics()
        {
            ...
            var d = new ConcurrentOrderedCompactDictionary<decimal, decimal>();
            d.Add(1m, 10m);
            d.Add(2m, 20m);
            d.Add(3m, 30m);
        ...
        {
            var d = new ConcurrentOrderedCompactDictionary<string, int>(new[]
            {
                new KeyValuePair<string, int>("a", 1),
                new KeyValuePair<string, int>("b", 2),
        ...
        public void Snapshot_View_IndexesAndSpans_AndIsFixedInShape()
        {
            ...
            ConcurrentOrderedCompactDictionary<string, int>.ValuesView empty = default;
        ...
        public void NonAtomicValues_Decimal_ReplaceAndRemove_StayCorrect()
        {
            ...
            var d = new ConcurrentOrderedCompactDictionary<string, decimal>();
            d.Add("a", 1.5m);
            d.Add("b", 2.5m);
        ...
        {
            var d = new ConcurrentOrderedCompactDictionary<string, int>(StringComparer.OrdinalIgnoreCase);
            d.Add("Key", 1);
        ...
        {
            foreach (var d in new[] { new ConcurrentOrderedCompactDictionary<int, int>(), new ConcurrentOrderedCompactDictionary<int, int>(3) })
            {
