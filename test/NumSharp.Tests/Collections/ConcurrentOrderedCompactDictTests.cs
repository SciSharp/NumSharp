// MIRROR of ConcurrentOrderedDictTests.cs for ConcurrentOrderedCompactDict — the two types share one public surface and one
...
{
    /// <summary>
    ///     Functional pins for <see cref="ConcurrentOrderedCompactDict{TKey,TValue}" />: the dual key/index paths, ordering,
    ...
    ///     The multi-threaded guarantees are pinned separately in <see cref="ConcurrentOrderedCompactDictConcurrencyTests" />.
    /// </summary>
    [TestClass]
    public class ConcurrentOrderedCompactDictTests
    {
        ...
        {
            var d = new ConcurrentOrderedCompactDict<string, int>();
        ...
        public void Ctor_NegativeCapacity_Throws()
            => Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => _ = new ConcurrentOrderedCompactDict<int, int>(-1));
        ...
        public void IntKey_IndexerBindsToIndex_NotKey()
        {
            ...
            var d = new ConcurrentOrderedCompactDict<int, string>();
            d.Add(10, "ten");
            d.Add(20, "twenty");
        ...
        public void TryRemoveSwapBack_NonAtomicTypes_TakesCopyPath_SameSemantics()
        {
            ...
            var d = new ConcurrentOrderedCompactDict<decimal, decimal>();
            d.Add(1m, 10m);
            d.Add(2m, 20m);
            d.Add(3m, 30m);
        ...
        {
            var d = new ConcurrentOrderedCompactDict<string, int>(new[]
            {
                new KeyValuePair<string, int>("a", 1),
                new KeyValuePair<string, int>("b", 2),
        ...
        public void Snapshot_View_IndexesAndSpans_AndIsFixedInShape()
        {
            ...
            ConcurrentOrderedCompactDict<string, int>.ValuesView empty = default;
        ...
        public void NonAtomicValues_Decimal_ReplaceAndRemove_StayCorrect()
        {
            ...
            var d = new ConcurrentOrderedCompactDict<string, decimal>();
            d.Add("a", 1.5m);
            d.Add("b", 2.5m);
        ...
        {
            var d = new ConcurrentOrderedCompactDict<string, int>(StringComparer.OrdinalIgnoreCase);
            d.Add("Key", 1);
        ...
        {
            foreach (var d in new[] { new ConcurrentOrderedCompactDict<int, int>(), new ConcurrentOrderedCompactDict<int, int>(3) })
            {
