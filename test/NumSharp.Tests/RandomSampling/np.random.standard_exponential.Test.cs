...
namespace NumSharp.Tests.RandomSampling
{
    ...
    public class NpRandomStandardExponentialTests : TestClass
    {
        ...
        public void StandardExponential_HasCorrectMean()
        {
            ...
            Assert.IsTrue(System.Math.Abs(mean - 1.0) < 0.05, $"Mean should be near 1.0, got {mean}");
        }
        ...
        public void StandardExponential_HasCorrectVariance()
        {
            ...
            Assert.IsTrue(System.Math.Abs(variance - 1.0) < 0.1, $"Variance should be near 1.0, got {variance}");
        }
