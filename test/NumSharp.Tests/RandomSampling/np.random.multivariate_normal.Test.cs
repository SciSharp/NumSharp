...
namespace NumSharp.Tests.RandomSampling
{
    ...
    public class NpRandomMultivariateNormalTests : TestClass
    {
        ...
        public void MultivariateNormal_Samples_HaveCorrectMean()
        {
            ...
            Assert.IsTrue(System.Math.Abs(sampleMean0 - 5) < 0.1, $"Mean[0] should be ~5, got {sampleMean0}");
            Assert.IsTrue(System.Math.Abs(sampleMean1 - (-3)) < 0.1, $"Mean[1] should be ~-3, got {sampleMean1}");
        }
        ...
        public void MultivariateNormal_DiagonalCovariance_HasCorrectVariances()
        {
            ...
            Assert.IsTrue(System.Math.Abs(var0 - 1) < 0.15, $"Variance[0] should be ~1, got {var0}");
            Assert.IsTrue(System.Math.Abs(var1 - 4) < 0.3, $"Variance[1] should be ~4, got {var1}");
        }
        ...
        public void MultivariateNormal_CorrelatedVariables_HaveCorrectCovariance()
        {
            ...
            Assert.IsTrue(System.Math.Abs(cov01 - 0.5) < 0.1, $"Covariance should be ~0.5, got {cov01}");
        }
        ...
        public void MultivariateNormal_OneDimensional_Works()
        {
            ...
            Assert.IsTrue(System.Math.Abs(sampleMean - 5) < 0.1, $"Mean should be ~5, got {sampleMean}");
            ...
            var_ /= 9999;
            Assert.IsTrue(System.Math.Abs(var_ - 4) < 0.3, $"Variance should be ~4, got {var_}");
        }
        ...
        public void MultivariateNormal_IdentityCovariance_ProducesUncorrelatedSamples()
        {
            ...
            double correlation = cov01 / System.Math.Sqrt(var0 * var1);

            // Correlation should be close to 0
            Assert.IsTrue(System.Math.Abs(correlation) < 0.05, $"Correlation should be ~0, got {correlation}");
        }
