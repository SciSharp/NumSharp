...
namespace NumSharp.Tests.RandomSampling
{
    ...
    public class WaldTests
    {
        ...
        public void Wald_HasExpectedMean()
        {
            ...
            System.Math.Abs(mean - 1.0).Should().BeLessThan(0.05);
        }
        ...
        public void Wald_HasExpectedVariance()
        {
            ...
            System.Math.Abs(variance - 1.0).Should().BeLessThan(0.1);
        }
        ...
        public void Wald_DifferentMean_HasExpectedMean()
        {
            ...
            System.Math.Abs(mean - 3.0).Should().BeLessThan(0.1);
        }
        ...
        public void Wald_DifferentParams_HasExpectedVariance()
        {
            ...
            System.Math.Abs(variance - 13.5).Should().BeLessThan(1.0);
        }
