...
public class RandomHypergeometricTests : TestClass
{
    ...
    public void Hypergeometric_ScalarCall_Returns0dArray()
    {
        ...
        var result = rng.hypergeometric(15, 15, 10);
    ...
    {
        var rng = np.random.RandomState(42);
        var result = rng.hypergeometric(15, 15, 10, 5L);
    ...
    {
        var rng = np.random.RandomState(42);
        var result = rng.hypergeometric(15, 15, 10, new Shape(2, 3));
    ...
    {
        var rng = np.random.RandomState(42);
        var result = rng.hypergeometric(15, 15, 10, new Shape(3, 4));
    ...
    public void Hypergeometric_AllValuesInRange()
    {
        ...
        var samples = rng.hypergeometric(15, 15, 10, 10000L);
    ...
    public void Hypergeometric_MeanConvergesToExpected()
    {
        ...
        var rng = np.random.RandomState(12345);
        var samples = rng.hypergeometric(15, 15, 10, 100000L);
        ...
        Assert.IsTrue(System.Math.Abs(mean - 5.0) < 0.05,
    ...
    public void Hypergeometric_AllGood_ReturnsNsample()
    {
        ...
        var rng = np.random.RandomState(42);
        var samples = rng.hypergeometric(20, 0, 10, 10L);
    ...
    public void Hypergeometric_AllBad_ReturnsZero()
    {
        ...
        var rng = np.random.RandomState(42);
        var samples = rng.hypergeometric(0, 20, 10, 10L);
    ...
    public void Hypergeometric_TakeAll_ReturnsNgood()
    {
        ...
        var rng = np.random.RandomState(42);
        var samples = rng.hypergeometric(5, 5, 10, 10L);
    ...
    public void Hypergeometric_MostlyGood()
    {
        ...
        var rng = np.random.RandomState(42);
        var samples = rng.hypergeometric(100, 2, 10, 1000L);
    ...
    public void Hypergeometric_MostlyBad()
    {
        ...
        var rng = np.random.RandomState(42);
        var samples = rng.hypergeometric(2, 100, 10, 1000L);
    ...
    public void Hypergeometric_Reproducibility()
    {
        ...
        var result1 = rng1.hypergeometric(15, 15, 10, 5L);

        var rng2 = np.random.RandomState(42);
        var result2 = rng2.hypergeometric(15, 15, 10, 5L);
    ...
    public void Hypergeometric_NsampleOne()
    {
        ...
        var rng = np.random.RandomState(42);
        var samples = rng.hypergeometric(10, 10, 1, 100L);
