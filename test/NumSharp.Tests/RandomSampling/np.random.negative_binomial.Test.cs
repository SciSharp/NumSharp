...
namespace NumSharp.Tests.RandomSampling
{
    ...
    public class NpRandomNegativeBinomialTests : TestClass
    {
        ...
        public void NegativeBinomial_HasCorrectMean()
        {
            ...
            Assert.IsTrue(System.Math.Abs(mean - expectedMean) < 0.5, $"Mean should be near {expectedMean}, got {mean}");
        }
        ...
        public void NegativeBinomial_HasCorrectVariance()
        {
            ...
            Assert.IsTrue(System.Math.Abs(variance - expectedVar) < 2.0, $"Variance should be near {expectedVar}, got {variance}");
        }
