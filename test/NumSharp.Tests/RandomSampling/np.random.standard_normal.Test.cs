...
namespace NumSharp.Tests.RandomSampling
{
    ...
    public class NpRandomStandardNormalTest : TestClass
    {
        ...
        public void StandardNormal_MeanIsZero()
        {
            ...
            Assert.IsTrue(System.Math.Abs(mean) < 0.02, $"Mean {mean} should be close to 0");
        }
        ...
        public void StandardNormal_StdIsOne()
        {
            ...
            Assert.IsTrue(System.Math.Abs(std - 1.0) < 0.02, $"Std {std} should be close to 1");
        }
        ...
        public void StandardNormal_VarianceIsOne()
        {
            ...
            Assert.IsTrue(System.Math.Abs(variance - 1.0) < 0.02, $"Variance {variance} should be close to 1");
        }
        ...
        public void StandardNormal_MatchesRandn()
        {
            ...
            Assert.IsTrue(System.Math.Abs(randn_mean) < 0.1, $"randn mean {randn_mean} should be near 0");
            Assert.IsTrue(System.Math.Abs(sn_mean) < 0.1, $"standard_normal mean {sn_mean} should be near 0");
            Assert.IsTrue(System.Math.Abs(randn_std - 1.0) < 0.1, $"randn std {randn_std} should be near 1");
            Assert.IsTrue(System.Math.Abs(sn_std - 1.0) < 0.1, $"standard_normal std {sn_std} should be near 1");
        }
