...
namespace NumSharp.Tests.RandomSampling
{
    ...
    public class NpRandomWeibullTest : TestClass
    {
        ...
        public void Weibull_A1_IsExponential()
        {
            ...
            Assert.IsTrue(System.Math.Abs(mean - 1.0) < 0.05, $"Mean {mean} should be close to 1.0");
        }
        ...
        public void Weibull_A2_StatisticalProperties()
        {
            ...
            Assert.IsTrue(System.Math.Abs(mean - 0.886) < 0.02, $"Mean {mean} should be close to 0.886");
        }
        ...
        public void Weibull_LargeA_ProducesConcentratedValues()
        {
            ...
            Assert.IsTrue(System.Math.Abs(mean - 0.95) < 0.1, $"Mean {mean} should be near 0.95");
