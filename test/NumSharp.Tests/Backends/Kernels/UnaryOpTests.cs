...
public class UnaryOpTests
{
    ...
    public void Sin_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 0.5) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.7071067811865476) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4)) < Tolerance); // sin(π) ≈ 0
    }
    ...
    public void Cos_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 0.8660254037844387) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.7071067811865476) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3)) < Tolerance); // cos(π/2) ≈ 0
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - (-1.0)) < Tolerance);
    }
    ...
    public void Tan_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - (-1.0)) < Tolerance);
    }
    ...
    public void ASin_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - (-Pi / 2)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - (-0.5235987755982989)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 0.5235987755982989) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - (Pi / 2)) < Tolerance);
    }
    ...
    public void ACos_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - Pi) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 2.0943951023931957) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - (Pi / 2)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 1.0471975511965979) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 0.0) < Tolerance);
    }
    ...
    public void ATan_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - (-Pi / 4)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - (-0.4636476090008061)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 0.4636476090008061) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - (Pi / 4)) < Tolerance);
    }
    ...
    public void Sinh_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - (-3.6268604078470186)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - (-1.1752011936438014)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 1.1752011936438014) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 3.6268604078470186) < Tolerance);
    }
    ...
    public void Cosh_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 3.7621956910836314) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 1.5430806348152437) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 1.5430806348152437) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 3.7621956910836314) < Tolerance);
    }
    ...
    public void Tanh_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - (-0.9640275800758169)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - (-0.7615941559557649)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 0.7615941559557649) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 0.9640275800758169) < Tolerance);
    }
    ...
    public void Log_Float64()
    {
        ...
        var input = np.array(new double[] { 0.001, 0.5, 1, System.Math.E, 10, 100 });
        var result = np.log(input);

        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - (-6.907755278982137)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - (-0.6931471805599453)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 2.302585092994046) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(5) - 4.605170185988092) < Tolerance);
    }
    ...
    public void Log2_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - (-1.0)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 2.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 3.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(5) - 10.0) < Tolerance);
    }
    ...
    public void Log10_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - (-3.0)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - (-1.0)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 2.0) < Tolerance);
    }
    ...
    public void Log1p_Float64()
    {
        ...
        var input = np.array(new double[] { 0, 0.5, 1, System.Math.E - 1, 9, 99 });
        var result = np.log1p(input);

        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 0.4054651081081644) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.6931471805599453) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 2.302585092994046) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(5) - 4.605170185988092) < Tolerance);
    }
    ...
    public void Exp_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 1.6487212707001282) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - System.Math.E) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 7.38905609893065) < Tolerance);
    }
    ...
    public void Exp2_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 2.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 4.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 8.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 1024.0) < Tolerance);
    }
    ...
    public void Expm1_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 0.6487212707001282) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - (System.Math.E - 1)) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 6.38905609893065) < Tolerance);
    }
    ...
    public void Sqrt_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 1.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 2.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - 3.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(4) - 10.0) < Tolerance);
    }
    ...
    public void Sin_Float32()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetSingle(0) - 0f) < 1e-6f);
        Assert.IsTrue(System.Math.Abs(result.GetSingle(1) - 0.4794255495071411f) < 1e-6f);
        Assert.IsTrue(System.Math.Abs(result.GetSingle(2) - 0.8414710164070129f) < 1e-6f);
    }
    ...
    public void Cos_Float32()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetSingle(0) - 1f) < 1e-6f);
        Assert.IsTrue(System.Math.Abs(result.GetSingle(1) - 0.8775825500488281f) < 1e-6f);
        Assert.IsTrue(System.Math.Abs(result.GetSingle(2) - 0.5403022766113281f) < 1e-6f);
    }
    ...
    public void Exp_Float32()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetSingle(0) - 1f) < 1e-5f);
        Assert.IsTrue(System.Math.Abs(result.GetSingle(1) - 1.6487212181091309f) < 1e-5f);
        Assert.IsTrue(System.Math.Abs(result.GetSingle(2) - 2.7182819843292236f) < 1e-5f);
    }
    ...
    public void Sin_SlicedArray()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - 0.0) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 0.7071067811865476) < Tolerance);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 1.0) < Tolerance);
    }
