...
public class SlicedArrayOpTests
{
    ...
    {
        var d = np.array(new[] { 0.0, System.Math.PI / 2, System.Math.PI, System.Math.PI * 1.5, System.Math.PI * 2 });
        // d[::2] = [0, π, 2π]
        // cos: [1, -1, 1]
    ...
    public void Exp_SlicedArray()
    {
        ...
        Assert.AreEqual(1.0, result.GetDouble(0), 1e-10);
        Assert.AreEqual(System.Math.Exp(2.0), result.GetDouble(1), 1e-10);
    }

    [TestMethod]
    public void Log_SlicedArray()
    {
        var d = np.array(new[] { 1.0, 2.0, System.Math.E, 4.0, System.Math.E * System.Math.E });
        // d[::2] = [1, e, e^2]
        // log: [0, 1, 2]
