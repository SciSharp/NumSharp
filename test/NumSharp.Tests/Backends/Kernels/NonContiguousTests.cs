...
public class NonContiguousTests
{
    ...
    public void ATan2_SlicedArrays()
    {
        ...
        Assert.AreEqual(System.Math.PI / 2, result.GetDouble(1), 1e-10);
        Assert.AreEqual(System.Math.PI, result.GetDouble(2), 1e-10);
    }
    ...
    public void ATan2_TransposedArrays()
    {
        ...
        Assert.AreEqual(System.Math.PI / 2, result.GetDouble(0, 1), 1e-10);
        Assert.AreEqual(System.Math.PI / 2, result.GetDouble(1, 0), 1e-10);
        Assert.AreEqual(System.Math.PI, result.GetDouble(1, 1), 1e-10);
    }
