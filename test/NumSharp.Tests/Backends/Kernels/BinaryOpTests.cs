...
public class BinaryOpTests
{
    ...
    public void Divide_ScalarDividedByArray_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - 0.6666666666666666) < 1e-10);
    ...
    public void ATan2_Float64()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - System.Math.PI / 4) < 1e-10);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - 3 * System.Math.PI / 4) < 1e-10);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) - (-System.Math.PI / 4)) < 1e-10);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(3) - (-3 * System.Math.PI / 4)) < 1e-10);
    }
    ...
    public void ATan2_Float32()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetSingle(0) - (float)(System.Math.PI / 2)) < 1e-6f);
        Assert.IsTrue(System.Math.Abs(result.GetSingle(1) - 0.0f) < 1e-6f);
        Assert.IsTrue(System.Math.Abs(result.GetSingle(2) - (float)(-System.Math.PI / 2)) < 1e-6f);
    }
    ...
    public void ATan2_Int32()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - System.Math.PI / 2) < 1e-10);  // atan2(1000, 0) = π/2
        Assert.AreEqual(0.0, result.GetDouble(1));                           // atan2(0, 1000) = 0
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) + System.Math.PI / 2) < 1e-10);  // atan2(-1000, 0) = -π/2
    }
    ...
    public void ATan2_Int64()
    {
        ...
        // arctan2 always returns float64, even for integer inputs
        Assert.AreEqual(typeof(double), result.dtype);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0) - System.Math.PI / 2) < 1e-10);  // atan2(1M, 0) = π/2
        Assert.AreEqual(0.0, result.GetDouble(1));                           // atan2(0, 1M) = 0
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2) + System.Math.PI / 2) < 1e-10);  // atan2(-1M, 0) = -π/2
    }
    ...
    public void ATan2_SpecialValues()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1) - System.Math.PI / 2) < 1e-10);
    ...
    public void ATan2_Broadcast2D()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0, 0) - System.Math.PI / 4) < 1e-10);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(0, 1) - 3 * System.Math.PI / 4) < 1e-10);

        // Row 1: arctan2(0, 1) = 0, arctan2(0, -1) = π
        Assert.AreEqual(0.0, result.GetDouble(1, 0));
        Assert.IsTrue(System.Math.Abs(result.GetDouble(1, 1) - System.Math.PI) < 1e-10);

        // Row 2: arctan2(-1, 1) = -π/4, arctan2(-1, -1) = -3π/4
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2, 0) - (-System.Math.PI / 4)) < 1e-10);
        Assert.IsTrue(System.Math.Abs(result.GetDouble(2, 1) - (-3 * System.Math.PI / 4)) < 1e-10);
    }
    ...
    public void ATan2_Float16_ReturnsHalf()
    {
        ...
        Assert.IsTrue(System.Math.Abs((double)result.GetHalf(0) - System.Math.PI / 4) < 2e-3);
        Assert.IsTrue(System.Math.Abs((double)result.GetHalf(1) - System.Math.PI / 2) < 2e-3);
        Assert.IsTrue(System.Math.Abs((double)result.GetHalf(2) - (-System.Math.PI / 4)) < 2e-3);
    }
    ...
    public void ATan2_Int16_ReturnsFloat32()
    {
        ...
        Assert.IsTrue(System.Math.Abs(result.GetSingle(0) - (float)(System.Math.PI / 4)) < 1e-6f);
    }
