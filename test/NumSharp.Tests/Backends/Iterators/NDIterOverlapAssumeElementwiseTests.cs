...
namespace NumSharp.Tests.Backends.Iterators
{
    ...
    /// </summary>
    [TestClass]
    public class NDIterOverlapAssumeElementwiseTests
    {
        [TestMethod]
        public void OverlapAssumeElementwise_PerOpFlag_Value()
        {
            Assert.AreEqual(0x40000000u,
                (uint)NDIterPerOpFlags.OVERLAP_ASSUME_ELEMENTWISE_PER_OP);
        }
        ...
        public void OverlapAssumeElementwise_With_COPY_IF_OVERLAP_Global()
        {
            ...
            using var it = NDIterRef.MultiNew(
                1, new[] { arr },
                NDIterGlobalFlags.COPY_IF_OVERLAP,
        ...
        public void OverlapAssumeElementwise_PerOpFlag_IsHighBit()
        {
            ...
            uint raw = (uint)NDIterPerOpFlags.OVERLAP_ASSUME_ELEMENTWISE_PER_OP;
            Assert.AreEqual(30, (int)System.Math.Log2(raw));
        }
    }
}
