...
namespace NumSharp.Tests.Backends.Iterators
{
    ...
    public unsafe class NDExprCallTests
    {
        ...
        public void Call_MethodGroup_UnaryMathSqrt_NoCast()
        {
            ...
            var expr = NDExpr.Call(System.Math.Sqrt, NDExpr.Input(0));
            it.ExecuteExpression(expr, new[] { NPTypeCode.Double }, NPTypeCode.Double,
                cacheKey: "call_mg_sqrt_v1");

            for (int i = 0; i < 5; i++)
                Assert.AreEqual(System.Math.Sqrt(input.GetDouble(i)), output.GetDouble(i), 1e-9);
        }
        ...
        public void Call_MethodGroup_BinaryMathPow_NoCast()
        {
            ...
            var expr = NDExpr.Call(System.Math.Pow, NDExpr.Input(0), NDExpr.Input(1));
        ...
        public void Call_FuncExplicit_BinaryPow_WithGenericArgs()
        {
            ...
            var expr = NDExpr.Call<double, double, double>(System.Math.Pow, NDExpr.Input(0), NDExpr.Input(1));
            it.ExecuteExpression(expr, new[] { NPTypeCode.Double, NPTypeCode.Double }, NPTypeCode.Double,
        ...
        public void Call_MathAbs_DoubleOverload_CastDisambig()
        {
            ...
            var expr = NDExpr.Call((Func<double, double>)System.Math.Abs, NDExpr.Input(0));
            it.ExecuteExpression(expr, new[] { NPTypeCode.Double }, NPTypeCode.Double,
        ...
        public void Call_MethodInfo_StaticMath_NoTarget()
        {
            ...
            var mi = typeof(System.Math).GetMethod("Tanh", new[] { typeof(double) })!;
            var expr = NDExpr.Call(mi, NDExpr.Input(0));
            it.ExecuteExpression(expr, new[] { NPTypeCode.Double }, NPTypeCode.Double,
                cacheKey: "call_mi_tanh_v1");

            Assert.AreEqual(System.Math.Tanh(0.5), r.GetDouble(0), 1e-9);
            Assert.AreEqual(System.Math.Tanh(1.0), r.GetDouble(1), 1e-9);
            Assert.AreEqual(System.Math.Tanh(2.0), r.GetDouble(2), 1e-9);
        }
        ...
        public void Call_DoubleTreeOutput_IntegerReturningMethod_AutoConvertsResult()
        {
            ...
            Func<double, int> floorInt = x => (int)System.Math.Floor(x);
        ...
        public void Call_ComposedWithOperators()
        {
            ...
            var expr = (NDExpr.Call(System.Math.Sqrt, NDExpr.Input(0)) + NDExpr.Const(1.0)) * NDExpr.Const(2.0);
            it.ExecuteExpression(expr, new[] { NPTypeCode.Double }, NPTypeCode.Double,
        ...
        public void Call_UsedInsideWhere()
        {
            ...
            var expr = NDExpr.Where(
                ...
                NDExpr.Call(System.Math.Sqrt, x),        // positive → sqrt
                NDExpr.Call(System.Math.Exp, x));        // non-positive → exp

            it.ExecuteExpression(expr, new[] { NPTypeCode.Double }, NPTypeCode.Double,
                cacheKey: "call_where_v1");

            // expected: exp(-2), exp(-1), exp(0), sqrt(1), sqrt(2)
            Assert.AreEqual(System.Math.Exp(-2), r.GetDouble(0), 1e-9);
            Assert.AreEqual(System.Math.Exp(-1), r.GetDouble(1), 1e-9);
            Assert.AreEqual(System.Math.Exp(0), r.GetDouble(2), 1e-9);
            Assert.AreEqual(System.Math.Sqrt(1), r.GetDouble(3), 1e-9);
            Assert.AreEqual(System.Math.Sqrt(2), r.GetDouble(4), 1e-9);
        }
        ...
        public void Call_SameStaticMethodReusesKernel()
        {
            ...
            using (var it = Iter(a, r))
                it.ExecuteExpression(NDExpr.Call(System.Math.Sqrt, NDExpr.Input(0)),
        ...
        public void Call_DifferentMethodsProduceDistinctKernels()
        {
            ...
            using (var it = Iter(a, r))
                it.ExecuteExpression(NDExpr.Call(System.Math.Cbrt, NDExpr.Input(0)),
                    new[] { NPTypeCode.Double }, NPTypeCode.Double);
        ...
        {
            _ = NDExpr.Call(System.Math.Sqrt, (NDExpr)null!);
        }
        ...
        {
            var mi = typeof(System.Math).GetMethod("Sqrt", new[] { typeof(double) })!;
        ...
        public void Call_ArgCountMismatch_Throws()
        {
            ...
            _ = NDExpr.Call(System.Math.Pow, NDExpr.Input(0));
        }
        ...
        public void Call_StridedInput_WorksViaScalarFallback()
        {
            ...
            for (int i = 0; i < 10; i++)
                Assert.AreEqual(System.Math.Sqrt(2.0 * i), r.GetDouble(i), 1e-9);
        }
        ...
        public void Call_AcrossSizes(int size)
        {
            ...
            Func<double, double> f = x => System.Math.Sin(x) * System.Math.Cos(x);
            ...
            for (int i = 0; i < size; i++)
                Assert.AreEqual(System.Math.Sin(xs[i]) * System.Math.Cos(xs[i]), r.GetDouble(i), 1e-9);
        }
