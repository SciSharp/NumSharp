namespace NumSharp.Tests.NpApiOverloads;
...
public class NpApiOverloadTests_UnaryMath
{
    ...
    public void Exp_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(1.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.E, result.GetDouble(1), Tolerance);
        Assert.AreEqual(System.Math.E * System.Math.E, result.GetDouble(2), Tolerance);
    }
    ...
    public void Expm1_NoParams_Compiles()
    {
        ...
        Assert.AreEqual(System.Math.E - 1, result.GetDouble(1), Tolerance);
    }
    ...
    public void Arcsin_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(0.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.PI / 2, result.GetDouble(2), Tolerance);
    }
    ...
    public void Arctan_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(0.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.PI / 4, result.GetDouble(1), Tolerance);
    }
    ...
    public void Arcsinh_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(0.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.Asinh(1.0), result.GetDouble(1), Tolerance);
    }
    ...
    public void Asinh_Alias_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(System.Math.Asinh(3.0), result.GetDouble(2), Tolerance);
    }
    ...
    public void Arccosh_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(0.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.Acosh(2.0), result.GetDouble(1), Tolerance);
    }
    ...
    public void Acosh_Alias_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(System.Math.Acosh(4.0), result.GetDouble(1), Tolerance);
    }
    ...
    public void Arctanh_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(0.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.Atanh(0.5), result.GetDouble(1), Tolerance);
    }
    ...
    public void Atanh_Alias_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(System.Math.Atanh(0.25), result.GetDouble(2), Tolerance);
    }
    ...
    public void Sinh_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(0.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.Sinh(1.0), result.GetDouble(1), Tolerance);
    }
    ...
    public void Cosh_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(1.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.Cosh(1.0), result.GetDouble(1), Tolerance);
    }
    ...
    public void Tanh_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(0.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.Tanh(1.0), result.GetDouble(1), Tolerance);
    }
    ...
    public void Deg2Rad_NoParams_Compiles()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual(0.0, result.GetDouble(0), Tolerance);
        Assert.AreEqual(System.Math.PI / 2, result.GetDouble(1), Tolerance);
        Assert.AreEqual(System.Math.PI, result.GetDouble(2), Tolerance);
    }
