...
namespace NumSharp.Tests.Logic
{
    ...
    public class np_isnan_Test
    {
        ...
        {
            var np1 = new NDArray(new[] {1.0, System.Math.PI, System.Math.E, 42, double.MaxValue, double.MinValue, double.NaN});
            var np2 = new NDArray(new[] {double.NegativeInfinity, double.PositiveInfinity, System.Math.PI, System.Math.E, 42, double.MaxValue, double.MinValue, double.NaN});
        ...
        {
            var np1 = new NDArray(new[] {System.Math.PI, System.Math.E, 42, double.MaxValue, double.MinValue, double.NaN}, new Shape(2, 3));
            var np2 = new NDArray(typeof(double), new Shape(39, 17));
            var np3 = new NDArray(new[] {double.NegativeInfinity, double.PositiveInfinity, System.Math.PI, System.Math.E, 42, double.MaxValue, double.MinValue, double.NaN}, new Shape(2, 4));
