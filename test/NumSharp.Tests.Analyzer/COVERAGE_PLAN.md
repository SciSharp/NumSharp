...
A plan to harden and broaden `NumSharp.Tests.Analyzer` so the **NDW012 leak analyzer**
...
> §8. New scenarios go into `NumSharp.Analyzer.Fixtures/` (tagged `// [NDWxxx]`) and are asserted by
